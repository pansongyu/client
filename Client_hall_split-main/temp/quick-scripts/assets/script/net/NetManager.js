(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/net/NetManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '56caa1jc8hMkaJ5KCorkeFw', 'NetManager', __filename);
// script/net/NetManager.js
...
var NetManager = app.BaseClass.extend({
	...
	InitHttpPack: function InitHttpPack() {
		...
		var ClientHttpPackDict = app.HttpPack().ClientHttpPackDict;
  ...
  */
	...
	SendPack: function SendPack(eventName, sendPack) {
		...
		var errorCallback = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function (data) {
	...
	//取消所有封包注册
	UnRegAllNetPack: function UnRegAllNetPack() {
	...
	OnCodeError: function OnCodeError(eventName, code, resultInfo) {
		...
		// }
				...
				//房卡不足
				var cityId = resultInfo["Msg"];
				var selectCityConfig = app.SysDataManager().GetTableDict("selectCity");
				var cityName = selectCityConfig[cityId]["Name"];
