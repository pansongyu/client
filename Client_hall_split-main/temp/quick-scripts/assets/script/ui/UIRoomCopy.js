(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/UIRoomCopy.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'db3f1Sw9sNAWrCHm8CTzK2Y', 'UIRoomCopy', __filename);
// script/ui/UIRoomCopy.js
...
cc.Class({
    ...
    OnEvt_MWShare: function OnEvt_MWShare(event) {
        //"ErrCode": 0, //安卓返回值 0成功 -2取消  -4发送失败  -5没有安装 iOS返回值：0成功 1用户取消 3发送错误  4未知错误
        /*if(0 == event.detail.ErrCode){
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIRoomCopy.js.map
