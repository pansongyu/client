(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xyhcmj/xyhcmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2b7e0K6hb1CcorwMnWlKXh6', 'xyhcmj_winlost_child', __filename);
// script/ui/uiGame/xyhcmj/xyhcmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		var isTing = posResultList[index]["isBaoTing"] || false;
   ...
   */
	...
	IsShowNum: function IsShowNum(huType) {
		var multi2 = ["ZiMo", "BaoTing", "DuanMen", "DuYing", "MenQing", "PaoHu", "ZhongFaBai1", "ZhongFaBai2", "ZhongFaBai3", "ZhongFaBai4", "Kan1", "Kan2", "Kan3", "Kan4", "Que19", "GangKai", "GangDian", "QiangGang", "SanPeng", "SiGeTou1", "SiGeTou2", "SiGeTou3"];
		var isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
	//倍数
	IsShowMulti2: function IsShowMulti2(huType) {
		var multi2 = ["TianHu", "DiHu", "YiTiaoLong", "MenQingYiTiaoLong", "HunYiSe", "MenQingHunYiSe", "JiaHun", "MenQingJiaHun", "QingYiSe", "PengPengHu", "MenQingPengPengHu", "QingYiSePengPengHu", "DaDiaoChe", "QiDui", "HaoHuaQiDui", "ChaoHaoHuaQiDui", "QingYiSeQiDui", "QingYiSeYiTiaoLong"]; // 显示倍数胡类型
		var isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xyhcmj_winlost_child.js.map
