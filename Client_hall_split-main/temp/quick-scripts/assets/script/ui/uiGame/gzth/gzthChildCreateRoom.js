(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gzth/gzthChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '9eec2N8yqlIOZ43NYiBzP1D', 'gzthChildCreateRoom', __filename);
// script/ui/uiGame/gzth/gzthChildCreateRoom.js
...
var gzthChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var wannengpai = this.GetIdxByKey('wannengpai');
        var yingpaibeishu = this.GetIdxByKey('yingpaibeishu');
        var yingpaihuafen = this.GetIdxByKey('yingpaihuafen');
        var suanfen = this.GetIdxByKey('suanfen');
        var kexuanwanfa = this.GetIdxsByKey('kexuanwanfa');
        var fangjian = this.GetIdxsByKey('fangjian');
        var xianShi = this.GetIdxByKey('xianShi');
        var jiesan = this.GetIdxByKey('jiesan');
        var jiesanshezhi = this.GetIdxByKey('jiesanshezhi');
        var gaoji = this.GetIdxsByKey('gaoji');

        sendPack = {
            "sudu": sudu,
            "yongpai": yongpai,
            "wannengpai": wannengpai,
            "yingpaibeishu": yingpaibeishu,
            "yingpaihuafen": yingpaihuafen,
            "suanfen": suanfen,
            "kexuanwanfa": kexuanwanfa,
            "fangjian": fangjian,
            "xianShi": xianShi,
            "jiesan": jiesan,
            "jiesanshezhi": jiesanshezhi,
            "gaoji": gaoji,
    ...
    AdjustSendPack: function AdjustSendPack(sendPack) {
        ...
        if (sendPack.playerNum != 4) {
            ...
            this.RemoveRadioSelect(sendPack, "suanfen");
        }
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        ...
        if (this.Toggles["yongpai"]) {
            if (this.Toggles["renshu"][0].getChildByName("checkmark").active) {
                if (this.Toggles["yongpai"][0].getChildByName("checkmark").active) {
                    var toggles = this.Toggles["yongpai"][0].parent;
                    var key = toggles.name.substring('Toggles_'.length, toggles.name.length);
                    this.ClearToggleCheck(this.Toggles["yongpai"], [1]);
            ...
            if (this.Toggles["renshu"][1].getChildByName("checkmark").active) {
                if (this.Toggles["yongpai"][2].getChildByName("checkmark").active) {
                    ...
                    this.Toggles["yongpai"][2].active = false;
                } else {
                    this.Toggles["yongpai"][2].active = false;
                }
            } else {
                this.Toggles["yongpai"][2].active = true;
            }
        }
        // 仅4人场可选，2、3人场隐藏；
        if (this.Toggles["suanfen"]) {
        ...
        if (this.Toggles["jiesanshichang"]) {
            if (this.Toggles["jiesanshezhi"][0].getChildByName("checkmark").active) {
                this.Toggles["jiesanshichang"][0].parent.active = false;
            } else {
                this.Toggles["jiesanshichang"][0].parent.active = true;
            }
        }
    },
...
module.exports = gzthChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gzthChildCreateRoom.js.map
