(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/kfmj/kfmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cd4adS/SC5NQqtl2OWK29O4', 'kfmjChildCreateRoom', __filename);
// script/ui/uiGame/kfmj/kfmjChildCreateRoom.js
...
var wxmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var xiapao = this.GetIdxsByKey('xiapao');
        var jiafen = this.GetIdxsByKey('jiafen');
        var jiabei = this.GetIdxsByKey('jiabei');
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key || 'piaoHua' == key) {
            ...
            if (toggleIndex == 2 || toggleIndex == 4) {
                var mark = needClearList[toggleIndex].getChildByName('checkmark').active;
                if (!mark && this.Toggles['hufa'][1].getChildByName('checkmark').active) {
                    app[app.subGameName + "_SysNotifyManager"]().ShowSysMsg('硬抠胡法下不能勾选一炮多响和258将');
                    this.Toggles['kexuanwanfa'][toggleIndex].getChildByName('checkmark').active = false;
                    return;
                }
            }
            if (toggleIndex == 2 || toggleIndex == 7) {
                var _mark = needClearList[toggleIndex].getChildByName('checkmark').active;
                if (!_mark && this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active) {
                    app[app.subGameName + "_SysNotifyManager"]().ShowSysMsg('带混玩法下不能勾选风杠和258将');
                    this.Toggles['kexuanwanfa'][toggleIndex].getChildByName('checkmark').active = false;
                    return;
                }
            }
            ...
            if (toggleIndex == 1) {
                var _mark2 = needClearList[toggleIndex].getChildByName('checkmark').active;
                if (!_mark2) {
                    this.Toggles['xiapao'][0].getChildByName('checkmark').active = true;
                }
            } else if (toggleIndex == 0) {
                var _mark3 = needClearList[toggleIndex].getChildByName('checkmark').active;
                if (_mark3) {
                    this.Toggles['xiapao'][1].getChildByName('checkmark').active = false;
                }
            }
        } else if ('hufa' == key) {
            if (toggleIndex == 1) {
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["piaohuaxuanze"]) {
            if (this.Toggles["piaoHua"][0].getChildByName("checkmark").active) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=kfmjChildCreateRoom.js.map
