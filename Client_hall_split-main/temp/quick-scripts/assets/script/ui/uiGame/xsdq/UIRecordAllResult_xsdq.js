(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xsdq/UIRecordAllResult_xsdq.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '526e9rHHvVCX5wr68DoKadE', 'UIRecordAllResult_xsdq', __filename);
// script/ui/uiGame/xsdq/UIRecordAllResult_xsdq.js
...
cc.Class({
	...
	ShowScore: function ShowScore(setEnd) {
		this.sportsDouble = this.scoreInfos.getChildByName("sportsDouble").getComponent(cc.Label);
		...
		if (zhuangRanksType > 0) {
			var zhuangStr = "庄队: 抓分：" + (rankInfoMap[zhuangRanksType].chiFen > 0 ? "+" : "") + rankInfoMap[zhuangRanksType].chiFen;
			if (rankInfoMap[zhuangRanksType].kouDiFen !== 0) {
				zhuangStr += " 抠底：" + (rankInfoMap[zhuangRanksType].kouDiFen > 0 ? "+" : "") + rankInfoMap[zhuangRanksType].kouDiFen;
			}
			this.scoreInfos.getChildByName("lb_zhuangRankScore").getComponent(cc.Label).string = zhuangStr;

			var xianRanksType = zhuangRanksType == 1 ? 2 : 1;
			var xianStr = "闲队: 抓分：" + (rankInfoMap[xianRanksType].chiFen > 0 ? "+" : "") + rankInfoMap[xianRanksType].chiFen;
			if (rankInfoMap[xianRanksType].kouDiFen !== 0) {
				xianStr += " 抠底：" + (rankInfoMap[xianRanksType].kouDiFen > 0 ? "+" : "") + rankInfoMap[xianRanksType].kouDiFen;
			}
			this.scoreInfos.getChildByName("lb_xianRankScore").getComponent(cc.Label).string = xianStr;
		} else {
			this.scoreInfos.getChildByName("lb_zhuangRankScore").getComponent(cc.Label).string = "";
			this.scoreInfos.getChildByName("lb_xianRankScore").getComponent(cc.Label).string = "";
		}
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIRecordAllResult_xsdq.js.map
