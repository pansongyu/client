(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/npgzmj/npgzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd0648snkpBHdYJwyM10Wg2P', 'npgzmjChildCreateRoom', __filename);
// script/ui/uiGame/npgzmj/npgzmjChildCreateRoom.js
...
var npgzmjChildCreateRoom = cc.Class({
    ...
    GetLocalConfigByKey: function GetLocalConfigByKey(key) {
        var clubId = 0;
        var roomKey = '0';
        var unionId = 0;
        var unionRoomKey = '0';
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key || "wanfa" == key) {
            ...
            if (toggleIndex == 1) {
                // 扎码押注
                for (var idx = 0; idx < this.Toggles['niaoshu'].length; idx++) {
                    var node = this.Toggles['niaoshu'][idx];
                ...
                for (var _idx = 0; _idx < this.Toggles['niaoshu'].length; _idx++) {
                    var _node = this.Toggles['niaoshu'][_idx];
                    this.UpdateLabelColor(_node.parent);
                }
            } else {
                // 扎码159
                ...
                if (typeof this.lastNiaoShuIdx == "undefined" || null == this.lastNiaoShuIdx) {
                    var niaoshu = this.GetLocalConfigByKey("niaoshu");
                    niaoshu = niaoshu || 0;
            ...
            // 码数
            var wanfa159 = this.Toggles['wanfa'][1].getChildByName('checkmark').active; // 扎码押注
            if (wanfa159) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=npgzmjChildCreateRoom.js.map
