(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hnpdk/hnpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2acddeilu1AKqB5OrfKamHp', 'hnpdkChildCreateRoom', __filename);
// script/ui/uiGame/hnpdk/hnpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var a3zha = this.GetIdxByKey('a3zha');
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 0) {
                this.Toggles["a3zha"][0].getChildByName("checkmark").active = false;
                this.Toggles["a3zha"][1].getChildByName("checkmark").active = false;
                this.Toggles["a3zha"][2].getChildByName("checkmark").active = true;
                this.UpdateLabelColor(this.Toggles["a3zha"][0].parent);
            }
        } else if ('a3zha' == key) {
            if (toggleIndex != 2 && this.Toggles['shoupai'][0].getChildByName('checkmark').active) {
                this.Toggles["shoupai"][0].getChildByName("checkmark").active = false;
                this.Toggles["shoupai"][1].getChildByName("checkmark").active = true;
                this.UpdateLabelColor(this.Toggles["shoupai"][0].parent);
            }
        } else if ('kexuanwanfa' == key) {
            //勾选3带2默认勾选3带1对
            if (toggleIndex == 8 && !this.Toggles['kexuanwanfa'][9].getChildByName('checkmark').active) {
                this.Toggles['kexuanwanfa'][9].getChildByName('checkmark').active = true;
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][9].parent);
            }
            ...
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ("kexuanwanfa" == curKey) {
                        this.Toggles['kexuanwanfa'][0].serverIdx = 30;
                        this.Toggles['kexuanwanfa'][1].serverIdx = 24;
                        this.Toggles['kexuanwanfa'][2].serverIdx = 29;
                        this.Toggles['kexuanwanfa'][3].serverIdx = 25;
                        this.Toggles['kexuanwanfa'][4].serverIdx = 26;
                        this.Toggles['kexuanwanfa'][5].serverIdx = 11;
                        this.Toggles['kexuanwanfa'][6].serverIdx = 28;
                        this.Toggles['kexuanwanfa'][7].serverIdx = 14;
                        this.Toggles['kexuanwanfa'][8].serverIdx = 15;
                        this.Toggles['kexuanwanfa'][9].serverIdx = 31;
                        this.Toggles['kexuanwanfa'][10].serverIdx = 16;
                        this.Toggles['kexuanwanfa'][11].serverIdx = 17;
                        this.Toggles['kexuanwanfa'][12].serverIdx = 18;
                        this.Toggles['kexuanwanfa'][13].serverIdx = 27;
                    }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hnpdkChildCreateRoom.js.map
