(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/px258mj/px258mjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '7c211dIwI9FvqKp44oP9Sdo', 'px258mjChildCreateRoom', __filename);
// script/ui/uiGame/px258mj/px258mjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var haidihufen = this.GetIdxByKey('haidihufen');
        var zhuaniao = this.GetIdxByKey('zhuaniao');
        var niaoshu = this.GetIdxByKey('niaoshu');
        var niaofen = this.GetIdxByKey('niaofen');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=px258mjChildCreateRoom.js.map
