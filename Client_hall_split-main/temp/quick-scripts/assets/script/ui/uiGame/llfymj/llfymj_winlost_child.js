(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/llfymj/llfymj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '37279HEq31I44h/lkqU8csq', 'llfymj_winlost_child', __filename);
// script/ui/uiGame/llfymj/llfymj_winlost_child.js
...
cc.Class({
	...
	UpdatePlayData: function UpdatePlayData(PlayerNode, HuList, PlayerInfo) {
		...
		this.ShowPlayerDownCard(PlayerNode.getChildByName('downcard'), HuList.publicCardList, jin1, jin2, HuList.liangPaiList, HuList.baoZhangList);
		this.ShowPlayerShowCard(PlayerNode.getChildByName('showcard'), HuList.shouCard, HuList.handCard, jin1, jin2, HuList.liangPaiList);
		this.ShowPlayerHuaCard(PlayerNode.getChildByName('huacardscrollView'), HuList.baoZhangList);
	},
	ShowPlayerShowCard: function ShowPlayerShowCard(ShowNode, cardIDList, handCard, jin1, jin2, liangPaiList) {
		ShowNode.active = 1;
		var UICard_ShowCard = ShowNode.getComponent("UIMJCard_ShowCard");
		UICard_ShowCard.ShowDownCardByLLFYMJ(cardIDList, handCard, liangPaiList);
	},
	ShowPlayerDownCard: function ShowPlayerDownCard(ShowNode, publishcard) {
		...
		var liangPaiList = arguments[4];
		var baoZhangList = arguments[5];

		ShowNode.active = 1;
		var UICard_DownCard = ShowNode.getComponent("UIMJCard_Down");
		UICard_DownCard.ShowDownCardLLFYMJ(publishcard, 'EatCard_Self_', liangPaiList, baoZhangList);
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=llfymj_winlost_child.js.map
