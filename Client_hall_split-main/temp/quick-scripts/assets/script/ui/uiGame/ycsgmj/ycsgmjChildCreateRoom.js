(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ycsgmj/ycsgmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ace55WVrBpIrLNaQGl7pd7X', 'ycsgmjChildCreateRoom', __filename);
// script/ui/uiGame/ycsgmj/ycsgmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var shanghuo = this.GetIdxByKey('shanghuo');
        var xuanshanghuo = -1;
        var lianmai = this.GetIdxByKey("lianmai");
        if (shanghuo == 0) {
            xuanshanghuo = this.GetIdxByKey('xuanshanghuo');
        }
        var piao = this.GetIdxByKey('piao');
        var xuanpiao = -1;
        if (piao == 0) {
            xuanpiao = this.GetIdxByKey('xuanpiao');
        }
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 0) {
                if (this.Toggles["shanghuo"][0].getChildByName("checkmark").active == false) {
                    if (this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active == false) {
                        app.SysNotifyManager().ShowSysMsg('勾选“可上火”，才可选“庄家必火”', [], 3);
                        return;
                    }
                }
            }
            if (toggleIndex == 2) {
                if (this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active == false) {
                    if (this.Toggles["kexuanwanfa"][2].getChildByName("checkmark").active == false) {
                        app.SysNotifyManager().ShowSysMsg('勾选“可吃牌”，才可选“可上吃下吐”', [], 3);
                        return;
                    }
                }
            }
            if (toggleIndex == 1) {
                if (this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active == true) {
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        if (this.Toggles["xuanshanghuo"]) {
            this.Toggles["xuanshanghuo"][0].parent.active = this.Toggles["shanghuo"][0].getChildByName("checkmark").active;
        }
        if (this.Toggles["xuanpiao"]) {
            this.Toggles["xuanpiao"][0].parent.active = this.Toggles["piao"][0].getChildByName("checkmark").active;
        }
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i = 0; _i < curCostData.length; _i++) {
                                if (curCostData[_i].SetCount == 102) {
                                    this.Toggles['jushu'][_i].getChildByName('label').getComponent(cc.Label).string = '2圈';
                                } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ycsgmjChildCreateRoom.js.map
