(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/wxzmmj/UIRecordAllResult_wxzmmj.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a96cci1rHxMv72sASXocRVk', 'UIRecordAllResult_wxzmmj', __filename);
// script/ui/uiGame/wxzmmj/UIRecordAllResult_wxzmmj.js
...
cc.Class({
	...
	InitShowPlayerInfo: function InitShowPlayerInfo(setEnd) {
		...
		var maList = setEnd["zhuaMaList"] || [];
		this.ShowNiaoPai(maList);
	},
	ShowNiaoPai: function ShowNiaoPai(cardIDList) {
		...
		for (var _i3 = 0; _i3 < cardIDList.length; _i3++) {
			...
			this.ShowImage(node, Math.floor(cardIDList[_i3] / 100));
			node.active = true;
		}
	},
	ShowImage: function ShowImage(btnNode, cardID) {
		var imageName = ["EatCard_Self_", cardID].join("");
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIRecordAllResult_wxzmmj.js.map
