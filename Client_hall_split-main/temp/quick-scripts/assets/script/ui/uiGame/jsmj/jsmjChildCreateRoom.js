(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jsmj/jsmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '76a33JDOf5FwqLVl8Vz+4/o', 'jsmjChildCreateRoom', __filename);
// script/ui/uiGame/jsmj/jsmjChildCreateRoom.js
...
var wxmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var bojing = this.GetIdxByKey('bojing');
        var jingfen = this.GetIdxByKey('jingfen');
        var gangfen = this.GetIdxByKey('gangfen');
        var fengDing = this.GetIdxByKey('fengDing');
        var gangjing = this.GetIdxByKey('gangjing');
        var tiandihu = this.GetIdxByKey('tiandihu');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jsmjChildCreateRoom.js.map
