(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/lslwzmj/lslwzmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '58b944vhTZETLqnWSqnSpn9', 'lslwzmj_winlost_child', __filename);
// script/ui/uiGame/lslwzmj/lslwzmj_winlost_child.js
...
cc.Class({
    ...
    LabelName: function LabelName(huType) {
        ...
        huTypeDict["DanTing"] = "上听";
        huTypeDict["QYS"] = "清一色";
        huTypeDict["ZhangZhang8"] = "8张涨"; //：胡牌时手里万筒条中有一门的张数大于等于8张；
        huTypeDict["DuYing"] = "独赢"; //：只听一张牌的情况下胡牌（单吊、边张、夹子）；
        huTypeDict["YaoSanJiu"] = "幺三九";
        huTypeDict["WuQiJiu"] = "五七九";
        huTypeDict["ZhongFaBai"] = "中发白";
        huTypeDict["LuanSanFeng"] = "乱三风";
        huTypeDict["FengKan"] = "风坎";
        huTypeDict["BanDao"] = "扳倒"; //：只要有胡牌就有此嘴，1嘴；
        huTypeDict["ShuaiZhang"] = "甩张";
        huTypeDict["PaoFen"] = "代跑";
        huTypeDict["Hu"] = "胡";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=lslwzmj_winlost_child.js.map
