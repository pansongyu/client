(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hzbdmj/hzbdmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '73f091PigNLiYsKo7ddit0u', 'hzbdmjChildCreateRoom', __filename);
// script/ui/uiGame/hzbdmj/hzbdmjChildCreateRoom.js
...
var wzmjChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            this.UpdateOnClickToggle();
            return;
        } else if ('kexuanwanfa' == key) {} else if ('guipai' == key) {
            if (toggleIndex == 0) {
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var zhongmafangshi = this.GetIdxByKey('zhongmafangshi');
        var guipai = this.GetIdxByKey('guipai');
        var shisanyao = this.GetIdxByKey('shisanyao');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hzbdmjChildCreateRoom.js.map
