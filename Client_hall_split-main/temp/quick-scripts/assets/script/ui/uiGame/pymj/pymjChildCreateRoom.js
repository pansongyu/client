(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/pymj/pymjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '78151ETe+1BM4ga0ynZ/Zqd', 'pymjChildCreateRoom', __filename);
// script/ui/uiGame/pymj/pymjChildCreateRoom.js
...
var pymjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var liangjian = this.GetIdxByKey("liangjian");
		var quemen = this.GetIdxByKey("quemen");
		var baoting = this.GetIdxByKey("baoting");
		var xianShi = this.GetIdxByKey('xianShi');
		var jiesan = this.GetIdxByKey('jiesan');
		var daipu = [];
		for (var i = 0; i < this.Toggles['daipu'].length; i++) {
			if (this.Toggles['daipu'][i].getChildByName('checkmark').active) {
				daipu.push(i);
			}
		}
		var kexuanwanfa = [];
	...
	UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
		...
		if (this.Toggles["liangjian"]) {
			if (this.Toggles["wanfa"][1].getChildByName("checkmark").active) {
				this.Toggles["liangjian"][1].getChildByName("checkmark").active = true;
				this.Toggles["liangjian"][0].getChildByName("checkmark").active = false;
				this.Toggles["liangjian"][0].active = false;

				this.Toggles["daipu"][0].parent.active = false;
			} else if (this.Toggles["wanfa"][0].getChildByName("checkmark").active) {
				this.Toggles["liangjian"][0].active = true;
				this.Toggles["liangjian"][0].getChildByName("checkmark").active = true;
				this.Toggles["liangjian"][1].getChildByName("checkmark").active = false;
				this.Toggles["daipu"][0].parent.active = true;
			}
		}
...
module.exports = pymjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=pymjChildCreateRoom.js.map
