(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/fqpls/fqplsChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ce3976pDSlAeY96Gk9lwoOR', 'fqplsChildCreateRoom', __filename);
// script/ui/uiGame/fqpls/fqplsChildCreateRoom.js
...
var fqplsChildCreateRoom = cc.Class({
	...
	EditBoxChanged: function EditBoxChanged() {
		var str = this.Toggles["wangpai"][3].getChildByName("editbox").getComponent(cc.EditBox).string;
	...
	Click_btn_create: function Click_btn_create(createType) {
		...
		if (3 == this.sign) {
			var wangpai = this.Toggles["wangpai"][3].getChildByName("editbox").getComponent(cc.EditBox).string;
			var reg = /^[1-9]\d*$/;
			if (!reg.test(wangpai)) {
		...
		if (1 == this.sign) {
			var _wangpai = this.Toggles["wangpai"][3].getChildByName("editbox").getComponent(cc.EditBox).string;
			var _reg = /^[0-9]\d*$/;
			if (!_reg.test(_wangpai)) {
				app.SysNotifyManager().ShowSysMsg("请输入0-13之间的王牌数量");
				return;
			}
			if (parseInt(_wangpai) < 0 || parseInt(_wangpai) > 13) {
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		if (this.sign == 1) {
			...
			//
			for (var _i7 = 0; _i7 < this.Toggles["wangpai"].length; _i7++) {
				if (this.Toggles["wangpai"][_i7].getChildByName("checkmark").active) {
					wangpai = _i7 + 1;
				}
			}
		} else {
	...
	ShowTogglesBySign: function ShowTogglesBySign() {
		...
		if (!isClick) {
			if (this.Toggles["leixing"] && this.Toggles["leixing"].length > 0) {
				for (var i = 0; i < this.Toggles["leixing"].length; i++) {
		...
		var wangpai0 = this.Toggles["wangpai"][0].x;
		if (this.sign == 1) {
			//经典场
...
cc._RF.pop();
        ...
        //# sourceMappingURL=fqplsChildCreateRoom.js.map
