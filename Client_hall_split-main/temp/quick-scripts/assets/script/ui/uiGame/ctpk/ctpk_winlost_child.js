(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ctpk/ctpk_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd4ad9KeL7NH4IwF4SaVnFPk', 'ctpk_winlost_child', __filename);
// script/ui/uiGame/ctpk/ctpk_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        this.node.getChildByName('record').getChildByName('lb_shouCardSize').getComponent(cc.Label).string = "" + posEndList.shengYuZhangShu;
        this.node.getChildByName('record').getChildByName('lb_loseSize').getComponent(cc.Label).string = "" + posEndList.beiShu;
        ...
        for (var idx = 0; idx < shouCard.length; idx++) {
            ...
            this.ShowCard(cardValue, cardNode, true, false, false, false);
        }
    },
    ...
    ShowCard: function ShowCard(cardType, cardNode, isLastCard) {
        ...
        this.PokerCard.GetPokeCard(cardType, cardNode, isLastCard, isShowLandowner, hideBg, isRazz);
    },
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ctpk_winlost_child.js.map
