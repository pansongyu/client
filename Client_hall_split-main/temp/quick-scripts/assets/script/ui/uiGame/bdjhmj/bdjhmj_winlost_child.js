(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/bdjhmj/bdjhmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '738c9Ot7iJIWIjBpWxdAiHa', 'bdjhmj_winlost_child', __filename);
// script/ui/uiGame/bdjhmj/bdjhmj_winlost_child.js
...
cc.Class({
    ...
    UpdatePlayData: function UpdatePlayData(PlayerNode, HuList, PlayerInfo) {
        ...
        this.ShowPlayerShowCard(PlayerNode.getChildByName('showcard'), HuList.shouCard, HuList.handCard);
        this.ShowPlayerHuaCard(PlayerNode.getChildByName('huacard'), HuList.huaList);
        this.ShowPlayerNiaoPai(PlayerNode.getChildByName('zhongma'), zhuaNiaoList, HuList);
    },
    ShowPlayerShowCard: function ShowPlayerShowCard(ShowNode, cardIDList, handCard) {
        ShowNode.active = 1;
        var UICard_ShowCard = ShowNode.getComponent("UIMJCard_ShowCard");
        UICard_ShowCard.ShowDownCardHuaJin(cardIDList, handCard);
    },
    ...
    ShowPlayerNiaoPai: function ShowPlayerNiaoPai(ShowNode, zhuaNiaoList, endPoint) {
        var niaoPaiList = endPoint["zhongList"] || [];
        for (var i = 1; i <= 20; i++) {
        ...
        for (var _i = 0; _i < zhuaNiaoList.length; _i++) {
            var cardType = Math.floor(zhuaNiaoList[_i] / 100);
            var node = ShowNode.getChildByName("card" + (_i + 1));
            this.ShowImage(node, 'EatCard_Self_', cardType);
            node.active = true;
            //更改为没中码都显示码牌
            if (niaoPaiList.length > 0) {
                if (niaoPaiList.indexOf(zhuaNiaoList[_i]) > -1) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=bdjhmj_winlost_child.js.map
