(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/bjpk/bjpk_detail_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd6556fX0wZGHogFzafPRukr', 'bjpk_detail_child', __filename);
// script/ui/uiGame/bjpk/bjpk_detail_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(resultsList, playerAll, idx) {
		...
		this.node.getChildByName("lb_flat").getComponent(cc.Label).string = data.flatCount;
		if (data.point >= 0) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=bjpk_detail_child.js.map
