(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ahmj/ahmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'acc7ad27m1McrjBFkbBdT74', 'ahmj_winlost_child', __filename);
// script/ui/uiGame/ahmj/ahmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerNiaoPai: function ShowPlayerNiaoPai(ShowNode, zhuaNiaoList, huInfo) {
        var zhongNiaoList = huInfo["zhongNiaoList"] || [];
        for (var i = 1; i <= 8; i++) {
        ...
        for (var _i = 0; _i < zhuaNiaoList.length; _i++) {
            ...
            node.active = true;
            //更改为没中码都显示码牌
            if (zhongNiaoList.indexOf(cardType) > -1) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ahmj_winlost_child.js.map
