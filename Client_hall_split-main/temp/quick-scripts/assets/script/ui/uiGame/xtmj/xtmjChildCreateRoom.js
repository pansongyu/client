(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xtmj/xtmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '998e2CZoBBFkoSNrj4phJT4', 'xtmjChildCreateRoom', __filename);
// script/ui/uiGame/xtmj/xtmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 1 && needClearList[toggleIndex + 1].getChildByName('checkmark').active) {
                needClearList[toggleIndex + 1].getChildByName('checkmark').active = false;
            } else if (toggleIndex == 2 && needClearList[toggleIndex - 1].getChildByName('checkmark').active) {
                needClearList[toggleIndex - 1].getChildByName('checkmark').active = false;
            } else if (toggleIndex == 5 && needClearList[toggleIndex + 1].getChildByName('checkmark').active) {
                needClearList[toggleIndex + 1].getChildByName('checkmark').active = false;
            } else if (toggleIndex == 6 && needClearList[toggleIndex - 1].getChildByName('checkmark').active) {
                needClearList[toggleIndex - 1].getChildByName('checkmark').active = false;
            }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xtmjChildCreateRoom.js.map
