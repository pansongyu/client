(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/yjmj/yjmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '9caccbKmNlH9YxBL12qk0Gv', 'yjmjChildCreateRoom', __filename);
// script/ui/uiGame/yjmj/yjmjChildCreateRoom.js
...
var szmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var dingzhuang = this.GetIdxByKey('dingzhuang');
	...
	OnUpdateTogglesLabel: function OnUpdateTogglesLabel(TogglesNode) {
		...
		if (this.Toggles["kexuanwanfa"]) {
			...
			if (this.Toggles["guipai"][0].getChildByName("checkmark").active) {
				// 勾选“无鬼”玩法
				this.Toggles["kexuanwanfa"][0].active = false; // 无鬼加倍
			} else {
			...
			if (this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active) {
				// 勾选“可点炮胡”
				this.Toggles["kexuanwanfa"][16].active = true; // 点炮包胡
			} else {
				this.Toggles["kexuanwanfa"][16].active = false; // 点炮包胡
			}
		}
	},
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if (toggleIndex == 1 && !this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active) {
				this.Toggles['kexuanwanfa'][16].active = true;
			} else {
				this.Toggles['kexuanwanfa'][16].active = false;
			}
			this.UpdateLabelColor(this.Toggles['kexuanwanfa'][16].parent);
		} else if ("guipai" == key) {
			// 	勾选“无鬼”，不可勾选“无鬼加倍”；
			if (toggleIndex == 0) {
				// 勾选“无鬼”玩法
...
cc._RF.pop();
        ...
        //# sourceMappingURL=yjmjChildCreateRoom.js.map
