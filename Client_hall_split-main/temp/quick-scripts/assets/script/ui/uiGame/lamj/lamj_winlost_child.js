(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/lamj/lamj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '4a85c2YkxpL46nfGPzROaJU', 'lamj_winlost_child', __filename);
// script/ui/uiGame/lamj/lamj_winlost_child.js
...
cc.Class({
  ...
  */
	...
	GetHuTypeDict: function GetHuTypeDict() {
		var huTypeDict = {};
		huTypeDict["SSL"] = "十三烂";
		huTypeDict["QSSSL"] = "七星烂";
		huTypeDict["PPH"] = "碰碰胡";
		huTypeDict["PPHQYS"] = "清一色真胡碰碰胡";
		huTypeDict["PPHZYS"] = "字一色真胡碰碰胡";
		huTypeDict["QYS"] = "清一色真胡";
		huTypeDict["QYSSiGuiQD"] = "清一色真胡四固一七对";
		huTypeDict["QYSBaGuiQD"] = "清一色真胡八固一七对";
		huTypeDict["QYSShiErGuiQD"] = "清一色真胡十二固一七对";
		huTypeDict["QYSZhenSiGui"] = "清一色真胡四固一";
		huTypeDict["QYSZhenBaGui"] = "清一色真胡八固一";
		huTypeDict["QYSZhenShiErGui"] = "清一色真胡十二固一";
		huTypeDict["QYSJia"] = "清一色假胡";
		huTypeDict["QYSJiaSiGui"] = "清一色假胡四固一";
		huTypeDict["QYSJiaBaGui"] = "清一色假胡八固一";
		huTypeDict["QYSJiaShiErGui"] = "清一色假胡十二固一";
		huTypeDict["ZYS"] = "字一色真胡";
		huTypeDict["ZYSSiGuiQD"] = "字一色真胡四固一七对";
		huTypeDict["ZYSBaGuiQD"] = "字一色真胡八固一七对";
		huTypeDict["ZYSShiErGuiQD"] = "字一色真胡十二固一七对";
		huTypeDict["ZYSZhenSiGui"] = "字一色真胡四固一";
		huTypeDict["ZYSZhenBaGui"] = "字一色真胡八固一";
		huTypeDict["ZYSZhenShiErGui"] = "字一色真胡十二固一";
		huTypeDict["ZYSJia"] = "字一色假胡";
		huTypeDict["ZYSJiaSiGui"] = "字一色假胡四固一";
		huTypeDict["ZYSJiaBaGui"] = "字一色假胡八固一";
		huTypeDict["ZYSJiaShiErGui"] = "字一色假胡十二固一";
		huTypeDict["QDZYS"] = "字一色真胡七对";
		huTypeDict["QDShiErGui"] = "十二固一七对";
		huTypeDict["QDBaGui"] = "八固一七对";
		huTypeDict["QDSiGui"] = "四固一七对";
		huTypeDict["QDQYS"] = "清一色真胡七对";
		huTypeDict["QD"] = "七对";
		huTypeDict["ShiErGui"] = "十二固一";
		huTypeDict["BaGui"] = "八固一";
		huTypeDict["SiGui"] = "四固一";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=lamj_winlost_child.js.map
