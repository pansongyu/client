(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/qzmj/qzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8fd0eBwsoNAPqZCzkFMFojo', 'qzmjChildCreateRoom', __filename);
// script/ui/uiGame/qzmj/qzmjChildCreateRoom.js
...
var xymjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var newQuanZhou = app.Client.GetClientConfigProperty("newQuanZhou");
        sendPack = {
            "beishu": newQuanZhou ? 1 : beishu,
            "jiesuan": jiesuan,
            "xianShi": xianShi,
            "jiesan": jiesan,
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i2 = 0; _i2 < curCostData.length; _i2++) {
                                if (curCostData[_i2].SetCount == 311) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=qzmjChildCreateRoom.js.map
