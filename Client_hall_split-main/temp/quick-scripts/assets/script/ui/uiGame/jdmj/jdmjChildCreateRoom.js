(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jdmj/jdmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a2b3feeSABDdI0hZa6Vc7Q9', 'jdmjChildCreateRoom', __filename);
// script/ui/uiGame/jdmj/jdmjChildCreateRoom.js
...
var jdmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		var sendPack = {};
		var jifenfangshi = this.GetIdxByKey('jifenfangshi');
		var difenshezhi = this.GetIdxByKey('difenshezhi');
		var qihubiaozhun = this.GetIdxByKey('qihubiaozhun');
		var huangwanfa = this.GetIdxByKey('huangwanfa');
		var kexuanwanfa = this.GetIdxsByKey('kexuanwanfa');
		var fangjian = this.GetIdxsByKey('fangjian');
		var xianShi = this.GetIdxByKey('xianShi');
		var jiesan = this.GetIdxByKey('jiesan');
		var gaoji = this.GetIdxsByKey('gaoji');
		if (kexuanwanfa.indexOf(1) == -1) {
			if (kexuanwanfa.indexOf(2) > -1) {
				kexuanwanfa.Remove(2);
			}
		}
		sendPack = {
			"jifenfangshi": jifenfangshi,
			"difenshezhi": difenshezhi,
			"qihubiaozhun": qihubiaozhun,
			"huangwanfa": huangwanfa,
	...
	RefreshAllToggles: function RefreshAllToggles(gameType) {
		...
		for (var key in this.gameCreateConfig) {
			if (this.gameType == this.gameCreateConfig[key].GameName) {
				...
				var lastPos = { x: 0, y: 0 };
				for (var _i6 = 1; _i6 <= toggleCount; _i6++) {
					var curNode = node.getChildByName('Toggle' + _i6);
					...
					if (curNode) {
						...
						if (1 == _i6) {
							...
							if (AtRows[_i6 - 2] != AtRows[_i6 - 1]) {
								...
								// }
								curNode.x = lastPos.x + parseInt(spacing[_i6 - 1]);
								curNode.y = lastPos.y;
							}
						}
						lastPos.x = curNode.x;
	...
	UpdateOnClickToggle: function UpdateOnClickToggle() {
		if (this.Toggles["kexuanwanfa"]) {
			this.Toggles["kexuanwanfa"][2].active = this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active;
		}
	}
});

module.exports = jdmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jdmjChildCreateRoom.js.map
