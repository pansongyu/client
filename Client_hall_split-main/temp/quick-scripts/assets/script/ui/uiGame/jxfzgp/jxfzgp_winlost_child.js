(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jxfzgp/jxfzgp_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '6a368U3DnJCwYr3XeWg0kRd', 'jxfzgp_winlost_child', __filename);
// script/ui/uiGame/jxfzgp/jxfzgp_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		//得分
		this.node.getChildByName("lb_defen").active = true;
		var lb_defen = this.node.getChildByName("lb_defen").getComponent(cc.Label);
		lb_defen.string = player.baseScore;

		//张数
		this.node.getChildByName("lb_zhangshu").active = true;
		var lb_zhangshu = this.node.getChildByName("lb_zhangshu").getComponent(cc.Label);
		lb_zhangshu.string = player.zhangShu;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jxfzgp_winlost_child.js.map
