(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jxfzgp/jxfzgpChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '82f3eZ7fhBM8Yg1dTeU9w+h', 'jxfzgpChildCreateRoom', __filename);
// script/ui/uiGame/jxfzgp/jxfzgpChildCreateRoom.js
					...
					if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
						...
						if (this.Toggles['jushu']) {
							...
							for (var _i = 0; _i < curCostData.length; _i++) {
								...
								this.Toggles['jushu'][_i].getChildByName('label').getComponent(cc.Label).string = "1次";
							}
						}
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jxfzgpChildCreateRoom.js.map
