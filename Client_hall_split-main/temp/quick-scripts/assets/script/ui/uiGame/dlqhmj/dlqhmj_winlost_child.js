(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/dlqhmj/dlqhmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '0064alD9vVBmpqyYUpEHv6C', 'dlqhmj_winlost_child', __filename);
// script/ui/uiGame/dlqhmj/dlqhmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        this.node.getChildByName("user_info").getChildByName("jiating").active = false;
        this.node.getChildByName("user_info").getChildByName("ting").active = false;
        // 夹听
        if (posResultList[index].isJiaTing) {
            this.node.getChildByName("user_info").getChildByName("jiating").active = true;
        } else {
            // 听
...
cc._RF.pop();
        ...
        //# sourceMappingURL=dlqhmj_winlost_child.js.map
