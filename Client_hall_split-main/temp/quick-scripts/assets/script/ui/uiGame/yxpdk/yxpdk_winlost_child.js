(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/yxpdk/yxpdk_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f24aast809Hip0Prtn8uY+u', 'yxpdk_winlost_child', __filename);
// script/ui/uiGame/yxpdk/yxpdk_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        //飘花
        var piaoHua = player.piaoHua;
        var lb_piao = this.node.getChildByName("user_info").getChildByName("lb_piao").getComponent(cc.Label);
        if (piaoHua > -1) {
            if (piaoHua == 0) {
                lb_piao.string = "不飘";
            } else {
                lb_piao.string = "飘" + piaoHua;
            }
        } else {
            lb_piao.string = "";
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=yxpdk_winlost_child.js.map
