(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/tzpdk/tzpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '66910ePvLRODqbxiUGXTFEG', 'tzpdkChildCreateRoom', __filename);
// script/ui/uiGame/tzpdk/tzpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var baodan = this.GetIdxByKey('baodan');
        var shunzi = this.GetIdxByKey('shunzi');
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active && (toggleIndex == 1 || toggleIndex == 2)) {
                this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active = false;
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][0].parent);
            } else if (this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active && (toggleIndex == 0 || toggleIndex == 2)) {
                this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active = false;
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][1].parent);
            } else if (this.Toggles['kexuanwanfa'][2].getChildByName('checkmark').active && (toggleIndex == 0 || toggleIndex == 1)) {
            ...
            //默认选中
            if (toggleIndex == 3 || toggleIndex == 4 || toggleIndex == 5 || toggleIndex == 6 || toggleIndex == 7 || toggleIndex == 8 || toggleIndex == 10) {
                // this.Toggles['kexuanwanfa'][toggleIndex].getChildByName('checkmark').active = true;
                app.SysNotifyManager().ShowSysMsg("该玩法默认选中");
                return;
            }
            //3A不为炸不能选择3A为最大炸
            if (!this.Toggles['kexuanwanfa'][10].getChildByName('checkmark').active && toggleIndex == 6) {
                // app.SysNotifyManager().ShowSysMsg("未勾选3A为炸时，不可选择3A为最大炸");
                app.SysNotifyManager().ShowSysMsg("请先勾选3A为炸");
                return;
            }
            if (toggleIndex == 10 && this.Toggles['kexuanwanfa'][toggleIndex].getChildByName('checkmark').active) {
                this.Toggles['kexuanwanfa'][6].getChildByName('checkmark').active = false;
            }
            if (toggleIndex == 6 || toggleIndex == 10) {
            ...
            if (toggleIndex == 9) {
                if (!this.Toggles['kexuanwanfa'][toggleIndex].getChildByName('checkmark').active) {
                    ...
                    if (!this.Toggles['zhadansuanfa'][1].getChildByName('checkmark').active) {
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        ...
        if (this.Toggles["kexuanwanfa"]) {
            if (!this.unionData) {
                ...
                this.Toggles["kexuanwanfa"][13].getChildByName("checkmark").active = false; //隐藏高级30秒被踢，ps：注释防止缓存
            } else {
            ...
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ("kexuanwanfa" == curKey) {
                        this.Toggles['kexuanwanfa'][0].serverIdx = 1; //每局红桃3先出
                        this.Toggles['kexuanwanfa'][1].serverIdx = 34; //赢的先出
                        this.Toggles['kexuanwanfa'][2].serverIdx = 35; //输的先出
                        this.Toggles['kexuanwanfa'][3].serverIdx = 2; //可不压牌
                        this.Toggles['kexuanwanfa'][4].serverIdx = 11; //显示手牌
                        this.Toggles['kexuanwanfa'][5].serverIdx = 22; //炸弹可拆
                        this.Toggles['kexuanwanfa'][6].serverIdx = 23; //3A为最大炸
                        this.Toggles['kexuanwanfa'][7].serverIdx = 26; //手动过牌
                        this.Toggles['kexuanwanfa'][8].serverIdx = 27; //手动准备
                        this.Toggles['kexuanwanfa'][9].serverIdx = 29; //无炸
                        this.Toggles['kexuanwanfa'][10].serverIdx = 4; //3A炸
                        this.Toggles['kexuanwanfa'][11].serverIdx = 30; //防作弊
                        this.Toggles['kexuanwanfa'][12].serverIdx = 31; //比赛分不能低于0
                        this.Toggles['kexuanwanfa'][13].serverIdx = 32; //只能赢当前身上分
                        this.Toggles['kexuanwanfa'][14].serverIdx = 33; //四带一为炸
                        this.Toggles['kexuanwanfa'][15].serverIdx = 36; //小关
                    }
    ...
    RefreshAllToggles: function RefreshAllToggles(gameType) {
        ...
        for (var key in this.gameCreateConfig) {
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                ...
                var lastPos = { x: 0, y: 0 };
                for (var _i8 = 1; _i8 <= toggleCount; _i8++) {
                    var curNode = node.getChildByName('Toggle' + _i8);
                    ...
                    if (curNode) {
                        ...
                        if (1 == _i8) {
                            ...
                            if (AtRows[_i8 - 2] != AtRows[_i8 - 1]) {
                                ...
                                // }
                                curNode.x = lastPos.x + parseInt(spacing[_i8 - 1]);
                                curNode.y = lastPos.y;
                            }
                        }
                        lastPos.x = curNode.x;
                            ...
                            if ((typeof cfgDataList === "undefined" ? "undefined" : _typeof(cfgDataList)) == "object") {
                                ...
                                for (var _j = 0; _j < cfgDataList.length; _j++) {
                                    if (dataKey == "kexuanwanfa") {
                                        //默认传的不显示
                                        if (cfgDataList[_j] == 13 || cfgDataList[_j] == 14 || cfgDataList[_j] == 15) {
                                            continue;
                                        }
                                    }
                                    //索引要加1
...
cc._RF.pop();
        ...
        //# sourceMappingURL=tzpdkChildCreateRoom.js.map
