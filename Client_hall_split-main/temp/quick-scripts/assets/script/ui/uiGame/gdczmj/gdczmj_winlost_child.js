(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gdczmj/gdczmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '3f847uMLRpP/4D01KhkI+5a', 'gdczmj_winlost_child', __filename);
// script/ui/uiGame/gdczmj/gdczmj_winlost_child.js
...
cc.Class({
	...
	ShowOtherScore: function ShowOtherScore(ShowNode, huInfo) {
		var huPaiFen = huInfo["huPaiFen"] || 0;
	...
	ShowPlayerMaCard: function ShowPlayerMaCard(ShowNode, huInfoAll) {
		for (var i = 1; i <= 2; i++) {
		...
		var maiMaCardIdList = huInfoAll["maiMaCardIdList"];
		var maiMaYingMaCardIdList = huInfoAll["maiMaYingMaCardIdList"];
		var maiMaShuMaCardIdList = huInfoAll["maiMaShuMaCardIdList"];

		for (var _i = 0; _i < maiMaCardIdList.length; _i++) {
			var cardId = maiMaCardIdList[_i];
   ...
   */
	...
	IsShowNum: function IsShowNum(huType) {
		var multi2 = ["AnGangShu", "PengGangShu", "ZhiGangShu", "DianGangShu"];
		var isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
	//倍数
	IsShowMulti2: function IsShowMulti2(huType) {
		var multi2 = ["WuGuiJiaBei"];
		var isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gdczmj_winlost_child.js.map
