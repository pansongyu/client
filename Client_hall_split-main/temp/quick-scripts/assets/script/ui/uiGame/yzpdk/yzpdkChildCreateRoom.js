(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/yzpdk/yzpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e994euerFxIzK6avCAtSyCn', 'yzpdkChildCreateRoom', __filename);
// script/ui/uiGame/yzpdk/yzpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        for (var _i3 = 0; _i3 < this.Toggles['kexuanwanfa'].length; _i3++) {
            var isCheck = this.Toggles['kexuanwanfa'][_i3].getChildByName('checkmark').active;
            if (isCheck) {
                if (this.Toggles['kexuanwanfa'][_i3].serverIdx) {
                    kexuanwanfa.push(this.Toggles['kexuanwanfa'][_i3].serverIdx);
                } else {
        ...
        for (var _i5 = 0; _i5 < this.Toggles['sidai'].length; _i5++) {
            //炸弹可拆
            if (this.Toggles['sidai'][_i5].getChildByName('checkmark').active && this.Toggles['kexuanwanfa'][4].getChildByName('checkmark').active) {
                sidai.push(_i5);
            }
        }
        sendPack = {
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
                ...
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i7 = 0; _i7 < curCostData.length; _i7++) {
                                this.Toggles['jushu'][_i7].getChildByName('label').getComponent(cc.Label).string = curCostData[_i7].SetCount + '局';
                            }
                        }
                    ...
                    if ('jushu' != curKey) {
                        var descInde = 0;
                        for (var _i8 = 0; _i8 < TogglesNode.children.length; _i8++) {
                            if (TogglesNode.children[_i8].name.startsWith('Toggle')) {
                                TogglesNode.children[_i8].getChildByName('label').getComponent(cc.Label).string = descList[descInde];
                                descInde++;
                            }
                        }
                    }
                    if ("kexuanwanfa" == curKey) {
                        ...
                        this.Toggles['kexuanwanfa'][10].serverIdx = 28; //尾张算分
                        this.Toggles['kexuanwanfa'][11].serverIdx = 29; //无炸
                        this.Toggles['kexuanwanfa'][12].serverIdx = 4; //3A炸
                        this.Toggles['kexuanwanfa'][13].serverIdx = 30; //防作弊
                    }
        ...
        if (this.Toggles["gaoji"]) {
            for (var _i9 = 0; _i9 < this.Toggles["gaoji"].length; _i9++) {
                var ToggleDesc = this.Toggles["gaoji"][_i9].getChildByName("label").getComponent(cc.Label).string;
                if (ToggleDesc == "30秒未准备自动踢出房间") {
                    if (!this.clubData && !this.unionData) {
                        this.Toggles["gaoji"][_i9].active = false;
                        this.Toggles["gaoji"][_i9].getChildByName("checkmark").active = false; //隐藏高级30秒被踢，ps：注释防止缓存
                        break;
                    } else {
                        this.Toggles["gaoji"][_i9].active = true;
    ...
    RefreshAllToggles: function RefreshAllToggles(gameType) {
        ...
        for (var key in this.gameCreateConfig) {
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                ...
                var lastPos = { x: 0, y: 0 };
                for (var _i10 = 1; _i10 <= toggleCount; _i10++) {
                    var curNode = node.getChildByName('Toggle' + _i10);
                    ...
                    if (curNode) {
                        ...
                        if (1 == _i10) {
                            ...
                            //第1个以后都是新增的
                            if (AtRows[_i10 - 2] != AtRows[_i10 - 1]) {
                                ...
                                // }
                                curNode.x = lastPos.x + parseInt(spacing[_i10 - 1]);
                                curNode.y = lastPos.y;
                            }
                        }
                        lastPos.x = curNode.x;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=yzpdkChildCreateRoom.js.map
