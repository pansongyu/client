(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gdy/gdyChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '7a6bdcxIOROH5EAe7aPAG1k', 'gdyChildCreateRoom', __filename);
// script/ui/uiGame/gdy/gdyChildCreateRoom.js
...
var gdyChildCreateRoom = cc.Class({
	...
	UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
		...
		if (this.Toggles["fangjian"]) {
			...
			if (this.Toggles["renshu"][0].getChildByName("checkmark").active) {
				...
				this.Toggles["fangjian"][0].getChildByName("checkmark").active = true;
			}
		}
...
module.exports = gdyChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gdyChildCreateRoom.js.map
