(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/aymj/aymjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'de4c4dqDS1Jv56rLXA5wJhX', 'aymjChildCreateRoom', __filename);
// script/ui/uiGame/aymj/aymjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var jiesancishu = this.GetIdxByKey('jiesancishu');
        var xianShi = this.GetIdxByKey('xianShi');
        var other = [];
        var kexuanwanfa = [];
        var gaoji = [];
        for (var i = 0; i < this.Toggles['other'].length; i++) {
            if (this.Toggles['other'][i].getChildByName('checkmark').active) {
                other.push(i);
            }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=aymjChildCreateRoom.js.map
