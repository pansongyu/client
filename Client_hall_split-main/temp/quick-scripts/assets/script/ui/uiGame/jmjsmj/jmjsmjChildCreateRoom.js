(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jmjsmj/jmjsmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '88d24hljGxHipiIaC/mx3Ju', 'jmjsmjChildCreateRoom', __filename);
// script/ui/uiGame/jmjsmj/jmjsmjChildCreateRoom.js
...
var bzqzmjChildCreateRoom = cc.Class({
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if (toggleIndex == 0 && this.Toggles["renshu"][2].getChildByName("checkmark").active) {
				app.SysNotifyManager().ShowSysMsg("4人场不能勾选无风牌玩法");
				return;
			}
		}
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jmjsmjChildCreateRoom.js.map
