(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jmjsmj/jmjsmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '576e6dY7FJCao0s9BRLKseM', 'jmjsmj_winlost_child', __filename);
// script/ui/uiGame/jmjsmj/jmjsmj_winlost_child.js
...
cc.Class({
    ...
    IsShowMulti: function IsShowMulti(huType) {
        var multi = this.multi || ["AnGang", "JieGang", "Gang", "Piao", "YingHu", "ZiMo"];
    ...
    ShowPlayerRecord: function ShowPlayerRecord(ShowNode, huInfo) {
        var absNum = Math.abs(huInfo["huFen"]);
        if (absNum > 10000) {
            ...
            if (huInfo["huFen"] > 0) {
                ShowNode.getChildByName('tip_point').getChildByName('lb_point').getComponent("cc.Label").string = '+' + huInfo["huFen"];
            } else {
                ShowNode.getChildByName('tip_point').getChildByName('lb_point').getComponent("cc.Label").string = huInfo["huFen"];
            }
        }
    ...
    LabelName: function LabelName(huType) {
        ...
        huTypeDict["PPHu"] = "碰碰胡";
        huTypeDict["QD"] = "七对";
        huTypeDict["QYSPPHu"] = "清一色碰碰胡";
        huTypeDict["QYSQD"] = "清一色七对";
        huTypeDict["LQD"] = "龙七对";
        huTypeDict["QYSLQD"] = "清龙七对";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jmjsmj_winlost_child.js.map
