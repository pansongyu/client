(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hnxymj/hnxymjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '4532aOmi5FMsZZ7IjZZk/Nt', 'hnxymjChildCreateRoom', __filename);
// script/ui/uiGame/hnxymj/hnxymjChildCreateRoom.js
...
var hnxymjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var dazui = this.GetIdxByKey("dazui");
    ...
    this.Toggles["dazui"][1].getChildByName("checkmark").active = false;*/
		...
		if (this.Toggles["kexuanwanfa"]) {
			if (this.Toggles["wanfa"][2].getChildByName("checkmark").active && this.Toggles["fengpai"][0].getChildByName("checkmark").active) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hnxymjChildCreateRoom.js.map
