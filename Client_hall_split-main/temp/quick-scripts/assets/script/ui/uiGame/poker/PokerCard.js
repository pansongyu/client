(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/poker/PokerCard.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd0ab5ZCetZJP7OG1rYntZT5', 'PokerCard', __filename);
// script/ui/uiGame/poker/PokerCard.js
...
var PokerCard = app.BaseClass.extend({
    ...
    //小牌渲染
    GetMiniPokeCard: function GetMiniPokeCard(poker, cardNode) {
        if (0 == poker) {
            return;
        }
        var numNode = cardNode.getChildByName("num");
        var iconNode = cardNode.getChildByName("icon");
        var type = "";
        var type1 = "bg_poker";
        var num = "";
        ...
        if (cardColor == 0) {
            ...
            if (cardValue == this.LOGIC_MASK_XIAOWANG) {
                //小鬼
                type = "small_bg_xw";
                num = "";
            } else if (cardValue == this.LOGIC_MASK_DAWANG) {
                //大鬼
                type = "small_bg_dw";
                num = "";
            }
        ...
        for (var i = 0; i < this.miniPokerList.length; i++) {
    ...
    LoadAllPokerRes: function LoadAllPokerRes() {
        ...
        //小牌
        if (0 != this.miniPokerList.length) return;
    ...
    GetCardValue: function GetCardValue(poker) {
        //大小王值最大
        if (poker == 65 || poker == 145 || poker == 225 || poker == 305) return this.LOGIC_MASK_XIAOWANG;
        if (poker == 66 || poker == 146 || poker == 226 || poker == 306) return this.LOGIC_MASK_DAWANG;
    ...
    //获取花色玉山打炸
    GetCardColorTwo: function GetCardColorTwo(poker) {
        return (poker & this.LOGIC_MASK_COLOR) % 64;
    },
    //获取牌值玉山打炸
    GetCardValueTwo: function GetCardValueTwo(poker) {
        return poker & this.LOGIC_MASK_VALUE;
    },
    //牌型检测
    ...
    GetYSDZPokeCard: function GetYSDZPokeCard(poker, cardNode) {
        var isShowIcon1 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
        var isShowLandowner = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
        var hideBg = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
        var isRazz = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
