(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/fdmj/fdmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fb80dP+1BFAGq4WE7LcQLoE', 'fdmj_winlost_child', __filename);
// script/ui/uiGame/fdmj/fdmj_winlost_child.js
...
cc.Class({
    ...
    LabelCardName: function LabelCardName(card) {
        var LabelCardArray = [];
    ...
    ShowPlayerJieSuan: function ShowPlayerJieSuan(ShowNode, huInfoAll) {
        ...
        var totalHushu = huInfoAll['endPoint'].totalHushu;
        var unit = "";
        var lb_hu = "";
        var huNum = 0;
        var taiNum = 0;
        for (var i = 0; i < huInfo.length; i++) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=fdmj_winlost_child.js.map
