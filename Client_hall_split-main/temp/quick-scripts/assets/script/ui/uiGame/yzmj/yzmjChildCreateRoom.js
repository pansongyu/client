(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/yzmj/yzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '79d6elWzQNP5p3kn5hacrq4', 'yzmjChildCreateRoom', __filename);
// script/ui/uiGame/yzmj/yzmjChildCreateRoom.js
					...
					if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
						...
						if (this.Toggles['jushu']) {
							...
							for (var _i3 = 0; _i3 < curCostData.length; _i3++) {
								...
								} else if (curCostData[_i3].SetCount == 106) {
									this.Toggles['jushu'][_i3].getChildByName('label').getComponent(cc.Label).string = "6圈";
								} else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=yzmjChildCreateRoom.js.map
