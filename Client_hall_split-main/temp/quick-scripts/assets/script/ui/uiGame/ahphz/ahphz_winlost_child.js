(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ahphz/ahphz_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '507d4YHnyFBOZO83U3TAgsa', 'ahphz_winlost_child', __filename);
// script/ui/uiGame/ahphz/ahphz_winlost_child.js
...
cc.Class({
    ...
    IsShowNum: function IsShowNum(huType) {
        var multi2 = ["ZiMoJiaOne"];
        var isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    //倍数
    IsShowMulti2: function IsShowMulti2(huType) {
        var multi2 = ["ZiMoJiaBei"];
        var isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    CheckInLayout: function CheckInLayout(huType) {
        var dict1 = ["ZiMoJiaOne", // 
        "ZiMoJiaBei"];
        var dict3 = ["HuXiNum"];
    ...
    PlayerData: function PlayerData(PlayerNode, result, pos) {
        ...
        if (huType != 0) {
            ...
            var layout1 = layout_huinfo.getChildByName("layout1");
            var layout2 = layout_huinfo.getChildByName("layout2");
            var layout3 = layout_huinfo.getChildByName("layout3");
            ...
            var huTypeMap = this.SortMap(result.endPoint.huTypeMap);
            var huTypeDict = {
                DianHu: "一点红",
                DaHongHu: "十三红",
                XiaoHongHu: "小红",
            ...
            for (var _huType in huTypeMap) {
                ...
                if (this.IsShowMulti2(_huType)) {
                    lb_huInfo.getComponent(cc.Label).string = huTypeDict[_huType] + "x" + huPoint;
                } else if (this.IsShowNum(_huType)) {
                    lb_huInfo.getComponent(cc.Label).string = huTypeDict[_huType] + "+" + huPoint + "囤";
                } else {
                    lb_huInfo.getComponent(cc.Label).string = huTypeDict[_huType] + "：" + huPoint;
                }
                lb_huInfo.active = true;
                if (this.CheckInLayout(_huType) == 1) {
                    layout1.addChild(lb_huInfo);
                } else if (this.CheckInLayout(_huType) == 2) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ahphz_winlost_child.js.map
