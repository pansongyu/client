(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ahphz/ahphzChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '9dda6mKRzpNbIvH1iIKO93M', 'ahphzChildCreateRoom', __filename);
// script/ui/uiGame/ahphz/ahphzChildCreateRoom.js
...
var ahphzChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var tunshu = this.GetIdxByKey('tunshu');
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (key == "renshu") {
                if (toggleIndex == 0) {
                    ...
                    this.ClearToggleCheck(this.Toggles['choupai'], [3]);
                    this.UpdateLabelColor(this.Toggles['choupai'][3].parent);
                }
            ...
            if (toggleIndex < 3 && !this.Toggles['renshu'][0].getChildByName('checkmark').active) {
                app.SysNotifyManager().ShowSysMsg("二人场才能抽牌", [], 3);
                return;
            }
...
module.exports = ahphzChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ahphzChildCreateRoom.js.map
