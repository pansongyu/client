(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/pxpdk/pxpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '31c53MpggdCtoJgoX57KrZx', 'pxpdkChildCreateRoom', __filename);
// script/ui/uiGame/pxpdk/pxpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            //3A不为炸不能选择3A为最大炸
            if (!this.Toggles['kexuanwanfa'][10].getChildByName('checkmark').active && toggleIndex == 5) {
            ...
            if (toggleIndex == 5 || toggleIndex == 10) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=pxpdkChildCreateRoom.js.map
