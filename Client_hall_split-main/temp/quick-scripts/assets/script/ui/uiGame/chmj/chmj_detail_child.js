(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/chmj/chmj_detail_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '41dba6UjfFPZbkRvsRVRWio', 'chmj_detail_child', __filename);
// script/ui/uiGame/chmj/chmj_detail_child.js
...
cc.Class({
    ...
    huTypesShow: function huTypesShow(jiesuan, huData) {
        ...
        jiesuan.getChildByName('top').getChildByName('lb_piaozi').getComponent(cc.Label).string = huData.piaoZi;
        jiesuan.getChildByName('top').getChildByName('lb_difen').getComponent(cc.Label).string = huData.curPoint;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=chmj_detail_child.js.map
