(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xxtdhmj/xxtdhmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8d5874stBRHca1KTp9VDhxa', 'xxtdhmj_winlost_child', __filename);
// script/ui/uiGame/xxtdhmj/xxtdhmj_winlost_child.js
...
cc.Class({
  ...
  UICard_ShowCard.ShowHuaList(hualist);*/
	...
	ShowPlayerRecord: function ShowPlayerRecord(ShowNode, huInfo) {
		...
		//显示带摸分
		var xiaPao = huInfo["xiaPao"];
		if (xiaPao > -1) {
			xiaPao = "+" + xiaPao;
		}
		ShowNode.getChildByName("recordstr").active = true;
		ShowNode.getChildByName("recordstr").getComponent("cc.Label").string = "胡牌分：" + huPoint + "    " + "杠分：" + gangPoint + "漂分：" + xiaPao;
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xxtdhmj_winlost_child.js.map
