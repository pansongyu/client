(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/dphmj/dphmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd9de6oXGKlJtrijTR5+e2Zi', 'dphmjChildCreateRoom', __filename);
// script/ui/uiGame/dphmj/dphmjChildCreateRoom.js
...
var bzqzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var gangdi = -1;
        if (!this.GetEditBoxByKey('gangdi') && this.GetEditBoxByKey('gangdi') != 0) {
            app.SysNotifyManager().ShowSysMsg('请检查输入的区间值是否正确');
            return;
        } else {
            gangdi = this.GetEditBoxByKey('gangdi');
        }
        var dianpao = -1;
        if (!this.GetEditBoxByKey('dianpao') && this.GetEditBoxByKey('dianpao') != 0) {
            app.SysNotifyManager().ShowSysMsg('请检查输入的区间值是否正确');
            return;
        } else {
            dianpao = this.GetEditBoxByKey('dianpao');
        }
        var zimo = -1;
        if (!this.GetEditBoxByKey('zimo') && this.GetEditBoxByKey('zimo') != 0) {
            app.SysNotifyManager().ShowSysMsg('请检查输入的区间值是否正确');
            return;
        } else {
            zimo = this.GetEditBoxByKey('zimo');
        }
        var biankadiao = -1;
        if (!this.GetEditBoxByKey('biankadiao') && this.GetEditBoxByKey('biankadiao') != 0) {
            app.SysNotifyManager().ShowSysMsg('请检查输入的区间值是否正确');
            return;
        } else {
            biankadiao = this.GetEditBoxByKey('biankadiao');
        }
                ...
                for (var _i = 1; _i <= toggleCount; _i++) {
                    ...
                    if (curNode) {
                        ...
                        if (2 == this.gameCreateConfig[key].ToggleType) {
                            ...
                            //纪录区间
                            var minAndMax = this.gameCreateConfig[key].ToggleDesc.toString().split('-');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=dphmjChildCreateRoom.js.map
