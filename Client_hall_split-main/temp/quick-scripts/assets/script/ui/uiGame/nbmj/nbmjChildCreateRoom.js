(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/nbmj/nbmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b04afFHs69IMqXGmf+92jUF', 'nbmjChildCreateRoom', __filename);
// script/ui/uiGame/nbmj/nbmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var qinghunpeng = this.GetIdxByKey('qinghunpeng');
		var qihutaishu = this.GetIdxByKey('qihutaishu');
		...
		sendPack = {
			...
			"difen": difen,
			"wanfa": wanfa,
			"qinghunpeng": qinghunpeng,
			"qihutaishu": qihutaishu,
			"fangjian": fangjian,
			"gaoji": gaoji,
			"jiesan": jiesan,
			"xianShi": xianShi,
...
cc._RF.pop();
        ...
        //# sourceMappingURL=nbmjChildCreateRoom.js.map
