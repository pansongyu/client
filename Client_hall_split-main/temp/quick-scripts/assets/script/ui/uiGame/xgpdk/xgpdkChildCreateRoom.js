(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xgpdk/xgpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1636f8fo1JLlJm7tSWJiHc3', 'xgpdkChildCreateRoom', __filename);
// script/ui/uiGame/xgpdk/xgpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        if (sendPack.piaoHua != 1) {
            sendPack.piaohuaxuanze = -1;
        }
        if (sendPack.zhadansuanfa == 2) {
            sendPack.zhadanfenshu = -1;
        }
        return sendPack;
    },
    ...
    RefreshAllToggles: function RefreshAllToggles(gameType) {
            ...
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                ...
                for (var _i8 = 1; _i8 <= toggleCount; _i8++) {
                    ...
                    if (curNode) {
                        ...
                        if (dataKey == 'piaoHua') {
                            if (parseInt(showList[0]) == 2) {
                                isHidePiaoHuaXuanZe = true;
                            } else {
                                isHidePiaoHuaXuanZe = false;
                            }
                        }
                        //尝试获取缓存
        ...
        this.Toggles['piaohuaxuanze'][0].parent.active = isHidePiaoHuaXuanZe;
    },
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xgpdkChildCreateRoom.js.map
