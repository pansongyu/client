(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ccmj/ccmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '26175RBlb9Kqa7sOaITxs73', 'ccmjChildCreateRoom', __filename);
// script/ui/uiGame/ccmj/ccmjChildCreateRoom.js
...
var gamjChildCreateRoom = cc.Class({
    ...
    AdjustSendPack: function AdjustSendPack(sendPack) {
        // 	2人场才能勾选“不许吃牌”，不能勾选“点炮包其他家”；
        // "点炮包其他家,三风蛋,带缺门,下蛋算站立,通宝翻番,当圈听,豪华七对,两头夹,有胡必胡,蛋随庄走,不许吃牌,飘胡、七对不限三色和幺九,明宝"
        if (sendPack.playerNum == 2) {
            var index = sendPack.kexuanwanfa.indexOf(0); // 点炮包其他家
            if (-1 != index) {
                sendPack.kexuanwanfa.splice(index, 1);
            }
        } else {
            var index = sendPack.kexuanwanfa.indexOf(10); // 不许吃牌
            if (-1 != index) {
                sendPack.kexuanwanfa.splice(index, 1);
            }
        }
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["kexuanwanfa"]) {
            if (this.Toggles["renshu"][0].getChildByName("checkmark").active) {
                // 2人   012
                this.Toggles["kexuanwanfa"][0].active = false; // 点炮包其他家
                this.Toggles["kexuanwanfa"][10].active = true; // 不许吃牌
            } else {
                this.Toggles["kexuanwanfa"][0].active = true; // 点炮包其他家
                this.Toggles["kexuanwanfa"][10].active = false; // 不许吃牌
            }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ccmjChildCreateRoom.js.map
