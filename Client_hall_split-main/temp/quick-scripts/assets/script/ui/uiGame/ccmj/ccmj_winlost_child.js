(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ccmj/ccmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8a6e4QOr/FH3bOosc/4CXdf', 'ccmj_winlost_child', __filename);
// script/ui/uiGame/ccmj/ccmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerJieSuan: function ShowPlayerJieSuan(ShowNode, huInfoAll) {
        ...
        this.score_add = ["PH", "JH", "PiaoH", "QXD", "HHQX"]; // 显示+胡类型
        this.score_multi = ["ZJ", "ZM", "LB", "DB", "ZL", "DP", "QYS"]; // 显示x胡类型

        var huInfo = huInfoAll['endPoint'].huTypeMap;
        for (var huType in huInfo) {
            var huPoint = huInfo[huType];
            var isNoShowScore = this.noShowScore.indexOf(huType) != -1;
            var isScore_add = this.score_add.indexOf(huType) != -1;
            var isScore_multi = this.score_multi.indexOf(huType) != -1;
            if (isNoShowScore) {
                this.ShowLabelName(ShowNode.getChildByName('label_lists'), this.LabelName(huType));
            } else if (isScore_add) {
                this.ShowLabelName(ShowNode.getChildByName('label_lists'), this.LabelName(huType) + "+" + huPoint);
            } else if (isScore_multi) {
    ...
    ShowPlayerDownCard: function ShowPlayerDownCard(ShowNode, publishcard) {
        ...
        UICard_DownCard.ShowDownCardByCCMJ(publishcard, this.posCount, jin1, jin2);
    },
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ccmj_winlost_child.js.map
