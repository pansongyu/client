(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/rcwsk6/rcwsk6ChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '13d5cntpkNOMoFFnGMuawQ5', 'rcwsk6ChildCreateRoom', __filename);
// script/ui/uiGame/rcwsk6/rcwsk6ChildCreateRoom.js
...
var rcwskChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var dangshu = this.GetIdxByKey("dangshu");
        var weizhi = this.GetIdxByKey("weizhi");
        var paishu = [];
        for (var i = 0; i < this.Toggles['paishu'].length; i++) {
            if (this.Toggles['paishu'][i].getChildByName('checkmark').active) {
                paishu.push(i);
            }
        }
        var jiefeng = this.GetIdxByKey("jiefeng");
        var gou = this.GetIdxByKey("gou");
        var yufen = this.GetIdxByKey("yufen");
        var dangdifen = this.GetIdxByKey("dangdifen");
        var goudifen = this.GetIdxByKey("goudifen");
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            return;
        } else if ('kexuanwanfa' == key) {} else if ('wanfa' == key) {
            if (toggleIndex < 2) {
                this.Toggles["moshi"][0].getChildByName("checkmark").active = true;
            ...
            if (toggleIndex == 1 && (this.Toggles["wanfa"][0].getChildByName("checkmark").active || this.Toggles["wanfa"][1].getChildByName("checkmark").active)) {
                app.SysNotifyManager().ShowSysMsg("该玩法下无法选择疯狂模式");
                return;
            }
        }
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i3 = 0; _i3 < curCostData.length; _i3++) {
                                if (curCostData[_i3].SetCount > 100) {
                                    this.Toggles['jushu'][_i3].getChildByName('label').getComponent(cc.Label).string = curCostData[_i3].SetCount % 100 + '档';
                                    continue;
                                }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=rcwsk6ChildCreateRoom.js.map
