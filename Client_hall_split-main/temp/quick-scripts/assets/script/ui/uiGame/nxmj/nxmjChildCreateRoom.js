(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/nxmj/nxmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a3c13natoxA6ahHspKia+a8', 'nxmjChildCreateRoom', __filename);
// script/ui/uiGame/nxmj/nxmjChildCreateRoom.js
...
var wxmjChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key || 'piaoHua' == key) {
            ...
            if (toggleIndex == 0 && this.Toggles['moshi'][0].getChildByName('checkmark').active) {
                app[app.subGameName + "_SysNotifyManager"]().ShowSysMsg('推倒胡模式下不可勾选该玩法');
                return;
            }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=nxmjChildCreateRoom.js.map
