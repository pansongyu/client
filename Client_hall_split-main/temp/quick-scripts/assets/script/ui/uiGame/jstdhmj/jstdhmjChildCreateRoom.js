(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jstdhmj/jstdhmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '7905bvk8cZErLM3pte36iow', 'jstdhmjChildCreateRoom', __filename);
// script/ui/uiGame/jstdhmj/jstdhmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if (toggleIndex == 1) {
				// 点击 爆头
				var is0 = this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active;
				var is6 = this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active;
				if (!is6 && !is0) {
					app.SysNotifyManager().ShowSysMsg("勾选报听才能改变听口不能杠", [], 3);
					//this.ShowSysMsg("勾选报听才能改变听口不能杠");
					return;
				}
			}
			if (toggleIndex == 0) {
				// 点击 爆头
				var _is = this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active;
				if (_is) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jstdhmjChildCreateRoom.js.map
