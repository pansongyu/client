(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hnjzmj/hnjzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a8879/WmaxLh5yDDrB4A4B+', 'hnjzmjChildCreateRoom', __filename);
// script/ui/uiGame/hnjzmj/hnjzmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["niaoshu"]) {
            if (this.Toggles["zhuaniaomoshi"][1].getChildByName("checkmark").active) {
                // 不抓鸟
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hnjzmjChildCreateRoom.js.map
