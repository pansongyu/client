...
cc._RF.push(module, '29c87DEUBVG1J9qbH2JyjDe', 'lptsChildCreateRoom', __filename);
// script/ui/uiGame/lpts/lptsChildCreateRoom.js
...
var ctwskChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var dazhadan = this.GetIdxByKey("dazhadan");
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('renshu' == key) {
            if (toggleIndex != 2 && !this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=lptsChildCreateRoom.js.map
