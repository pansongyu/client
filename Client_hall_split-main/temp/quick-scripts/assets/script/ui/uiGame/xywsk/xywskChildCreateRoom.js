(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xywsk/xywskChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e0717BnAnxCXYZKgERjt+Oi', 'xywskChildCreateRoom', __filename);
// script/ui/uiGame/xywsk/xywskChildCreateRoom.js
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if (toggleIndex == 2) {
				...
				this.Toggles["wangpai"][1].getChildByName("checkmark").active = true;
				this.UpdateLabelColor(this.Toggles['wangpai'][0].parent);
			}
			if (toggleIndex == 3 || toggleIndex == 4) {
				if (this.Toggles["renshu"][0].getChildByName("checkmark").active == false) {
					app.SysNotifyManager().ShowSysMsg("2人场才能选择此玩法", [], 3);
					return;
				}
				if (toggleIndex == 3) {
					if (this.Toggles["kexuanwanfa"][3].getChildByName("checkmark").active == false) {
						this.Toggles["kexuanwanfa"][4].getChildByName("checkmark").active = false;
					}
				}
				if (toggleIndex == 4) {
					if (this.Toggles["kexuanwanfa"][4].getChildByName("checkmark").active == false) {
						this.Toggles["kexuanwanfa"][3].getChildByName("checkmark").active = false;
					}
				}
				this.UpdateLabelColor(this.Toggles['kexuanwanfa'][0].parent);
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xywskChildCreateRoom.js.map
