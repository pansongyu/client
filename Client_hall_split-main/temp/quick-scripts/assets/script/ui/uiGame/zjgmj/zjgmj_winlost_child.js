...
cc._RF.push(module, 'cebf9+19WhB4rvfz9fomF0s', 'zjgmj_winlost_child', __filename);
// script/ui/uiGame/zjgmj/zjgmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerNiaoPai: function ShowPlayerNiaoPai(ShowNode, zhuaNiaoList, huInfo) {
        /*let zhongNiaoList = huInfo["zhongNiaoList"] || [];
        for(let i=1;i<=8;i++){
    ...
    LabelName: function LabelName(huType) {
        ...
        huTypeDict["HunYaoJiu"] = "十三幺";
        huTypeDict["QingYaoJiu"] = "全幺九";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zjgmj_winlost_child.js.map
