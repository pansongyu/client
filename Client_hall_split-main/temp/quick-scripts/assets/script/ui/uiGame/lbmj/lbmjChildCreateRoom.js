(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/lbmj/lbmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ded6727BYNFkLPKfD6oDwGD', 'lbmjChildCreateRoom', __filename);
// script/ui/uiGame/lbmj/lbmjChildCreateRoom.js
...
var wzmjChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 2 || toggleIndex == 3) {
                this.Toggles["fengyupai"][0].parent.active = true;
            } else {
                this.Toggles["fengyupai"][0].parent.active = false;
            }
        }
        ...
        for (var key in this.gameCreateConfig) {
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ('yushu' == curKey) {
                        if (this.Toggles["diaoyu"][0].getChildByName("checkmark").active) {
                            this.Toggles["yushu"][0].parent.active = true;
                        } else {
                            this.Toggles["yushu"][0].parent.active = false;
                        }
                    } else if ('fengyupai' == curKey) {
                        if (this.Toggles["diaoyu"][2].getChildByName("checkmark").active || this.Toggles["diaoyu"][3].getChildByName("checkmark").active) {
                            this.Toggles["fengyupai"][0].parent.active = true;
                        } else {
                            this.Toggles["fengyupai"][0].parent.active = false;
                        }
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        if (diaoyu == 2 || diaoyu == 3) {
            yushu = -1;
        }
        var fengyupai = this.GetIdxByKey('fengyupai');
        if (diaoyu == 0) {
            fengyupai = -1;
        }
        sendPack = {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=lbmjChildCreateRoom.js.map
