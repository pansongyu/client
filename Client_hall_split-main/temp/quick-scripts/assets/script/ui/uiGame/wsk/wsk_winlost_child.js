(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/wsk/wsk_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd8182E4RsBBIpoixriJl1Bn', 'wsk_winlost_child', __filename);
// script/ui/uiGame/wsk/wsk_winlost_child.js
...
cc.Class((_cc$Class = {
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        for (var j = 0; j < zhaDanLayOut.children.length; j++) {
            ...
            if (prizeCardList[j]) {
                var pailist = prizeCardList[j].slice(2, prizeCardList[j].length);
                var zhashu = pailist.length;
...
}, _defineProperty(_cc$Class, "ShowPlayerShowCard", function ShowPlayerShowCard(ShowNode, cardIDList, handCard, jin1, jin2) {
    // ShowNode.active = 1;
    // let UICard_ShowCard = ShowNode.getComponent("UIMJCard_ShowCard");
    // UICard_ShowCard.ShowDownCard(cardIDList, handCard, jin1, jin2);
}), _defineProperty(_cc$Class, "createCardNode", function createCardNode(paiNode, num) {
...
}), _defineProperty(_cc$Class, "createZhaDanNode", function createZhaDanNode(zhaDanLayOut, num) {
    //
    var card = cc.instantiate(this.prefab_zhadan); //this# one
    card.name = "zhadan" + num;
    zhaDanLayOut.addChild(card);
}), _defineProperty(_cc$Class, "LabelName", function LabelName(huType) {
    var huTypeDict = {
        QDHu: "七对胡",
        Gang: "杠",
        JieGang: "接杠",
...
cc._RF.pop();
        ...
        //# sourceMappingURL=wsk_winlost_child.js.map
