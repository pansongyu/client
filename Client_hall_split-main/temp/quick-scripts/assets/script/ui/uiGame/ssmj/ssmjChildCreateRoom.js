(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ssmj/ssmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '53f74f/L7hGA789LqHEuZq0', 'ssmjChildCreateRoom', __filename);
// script/ui/uiGame/ssmj/ssmjChildCreateRoom.js
...
var xymjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var youjin = this.GetIdxByKey("youjin");
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i2 = 0; _i2 < curCostData.length; _i2++) {
                                if (curCostData[_i2].SetCount == 310) {
                                    this.Toggles['jushu'][_i2].getChildByName('label').getComponent(cc.Label).string = '1课:10分';
                                } else if (curCostData[_i2].SetCount == 311) {
                                    this.Toggles['jushu'][_i2].getChildByName('label').getComponent(cc.Label).string = '1课:100分';
                                } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ssmjChildCreateRoom.js.map
