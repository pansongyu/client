(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/thgz/thgz_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a876a933z1KVLqMPeqEIZhe', 'thgz_winlost_child', __filename);
// script/ui/uiGame/thgz/thgz_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        //赏数
        str += '奖数:';
        var wuJiangFlag = posEndList["wuJiangFlag"];
        var boomRewardTotal = posEndList["boomRewardTotal"];
        if (wuJiangFlag) {
            str += "无奖+ " + boomRewardTotal + "奖";
        } else {
            var minBoomRewardTotal = posEndList["minBoomRewardTotal"];
            var subOne = posEndList["subOne"];
            var subTwo = posEndList["subTwo"];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=thgz_winlost_child.js.map
