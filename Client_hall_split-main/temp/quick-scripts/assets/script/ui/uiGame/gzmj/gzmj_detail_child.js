(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gzmj/gzmj_detail_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1e29e61NKtCp4bKu3srdzAp', 'gzmj_detail_child', __filename);
// script/ui/uiGame/gzmj/gzmj_detail_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(resultsList, playerAll, idx) {
		...
		for (var key in pointMap) {
			...
			var item = jufenLayout.getChildByName(key);
			if (!item) {
		...
		var maxPoint = 0;
		var maxDianPao = 0;
		for (var _i = 0; _i < resultsList.length; _i++) {
			var _data = resultsList[_i];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gzmj_detail_child.js.map
