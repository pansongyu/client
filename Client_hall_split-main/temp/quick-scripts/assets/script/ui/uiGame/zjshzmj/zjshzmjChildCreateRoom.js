(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zjshzmj/zjshzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8dd5chYxzVBH43x82vQ5iVL', 'zjshzmjChildCreateRoom', __filename);
// script/ui/uiGame/zjshzmj/zjshzmjChildCreateRoom.js
...
var gamjChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            // 	同时勾选“七对子”、“爆头”，才能勾选“七对爆头翻倍”；
            if (toggleIndex == 0) {
                // 点击 七对子
                var is6 = this.Toggles['kexuanwanfa'][6].getChildByName('checkmark').active;
                var is0 = this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active;
                if (is0 && is6) {
                    this.ShowSysMsg("勾选七对爆头翻倍, 必须勾选七对子");
                    return;
                }
            }
            ...
            if (toggleIndex == 1) {
                // 点击 爆头
                var is7 = this.Toggles['kexuanwanfa'][6].getChildByName('checkmark').active;
                var _is = this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active;
                if (is7 && _is) {
                    this.ShowSysMsg("勾选七对翻倍, 必须勾选七小对");
                    return;
                }
            }
            if (toggleIndex == 6) {
            ...
            // if (toggleIndex == 6) {// 点击七小对
            // 	let is7 = this.Toggles['kexuanwanfa'][7].getChildByName('checkmark').active;
            // 	let is6 = this.Toggles['kexuanwanfa'][6].getChildByName('checkmark').active;
            // 	if (is7 && is6) {
            // 		this.ShowSysMsg("勾选七对翻倍, 必须勾选七小对");
            // 		return;
            // 	}
            // }
            // if (toggleIndex == 7) {// 七对翻倍
            // 	this.UpdateLabelColor(toggles);
            // 	this.UpdateTogglesLabel(toggles);
            // }
        }
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["kexuanwanfa"]) {
            if (this.Toggles["kexuanwanfa"][6] && !this.Toggles["kexuanwanfa"][6].getChildByName("checkmark").active) {
                // 勾选七对爆头翻倍
                if (this.Toggles["kexuanwanfa"][0]) {
                    this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active = true; // 七对子
                    this.UpdateLabelColor(this.Toggles["kexuanwanfa"][0].parent);
                }
                if (this.Toggles["kexuanwanfa"][1]) {
                    this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active = true; // 爆头
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zjshzmjChildCreateRoom.js.map
