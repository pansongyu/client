(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hncsmj/hncsmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'eb9b4laBzJPRaBPLLjiYD11', 'hncsmjChildCreateRoom', __filename);
// script/ui/uiGame/hncsmj/hncsmjChildCreateRoom.js
...
var hncsmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var gudingpiaofen = this.GetIdxByKey("gudingpiaofen");
		var kaigang = this.GetIdxByKey("kaigang");
		...
		if (piaofen == 0 || piaofen == 2) {
			gudingpiaofen = -1;
		}
		sendPack = {
			"gudingpiaofen": gudingpiaofen,
	...
	UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
		...
		if (this.Toggles["gudingpiaofen"]) {
			if (this.Toggles["piaofen"][0].getChildByName("checkmark").active || this.Toggles["piaofen"][2].getChildByName("checkmark").active) {
				this.Toggles["gudingpiaofen"][0].parent.active = false;
			} else {
				this.Toggles["gudingpiaofen"][0].parent.active = true;
			}
		}
		...
		if (this.Toggles["niaoshu"]) {
			if (this.Toggles["zhuaniao"][0].getChildByName("checkmark").active) {
				this.Toggles["niaoshu"][1].getChildByName("checkmark").active = !this.Toggles["niaoshu"][3].getChildByName("checkmark").active;
				this.Toggles["niaoshu"][0].active = false;
				this.Toggles["niaoshu"][1].active = true;
				this.Toggles["niaoshu"][2].active = true;
				this.Toggles["niaoshu"][3].active = true;
				this.Toggles["niaoshu"][0].parent.active = true;
			} else if (this.Toggles["zhuaniao"][1].getChildByName("checkmark").active) {
				this.Toggles["niaoshu"][0].getChildByName("checkmark").active = !this.Toggles["niaoshu"][1].getChildByName("checkmark").active;
				this.Toggles["niaoshu"][2].getChildByName("checkmark").active = false;
				this.Toggles["niaoshu"][3].getChildByName("checkmark").active = false;
				this.Toggles["niaoshu"][0].active = true;
				this.Toggles["niaoshu"][1].active = true;
				this.Toggles["niaoshu"][2].active = false;
				this.Toggles["niaoshu"][3].active = false;
				this.Toggles["niaoshu"][0].parent.active = true;
			} else if (this.Toggles["zhuaniao"][2].getChildByName("checkmark").active) {
				this.Toggles["niaoshu"][0].active = false;
				this.Toggles["niaoshu"][1].active = false;
				this.Toggles["niaoshu"][2].active = false;
				this.Toggles["niaoshu"][3].active = false;
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key || "piaofen" == key || "zhuaniao" == key) {
		...
		this.UpdateOnClickToggle();
		if ("kexuanwanfa" == key) {
			if (this.Toggles["kexuanwanfa"][10].getChildByName("checkmark").active && this.Toggles["renshu"][0].getChildByName("checkmark").active) {
				this.Toggles["kexuanwanfa"][3].active = false;
				this.Toggles["kexuanwanfa"][4].active = false;
				this.Toggles["kexuanwanfa"][3].getChildByName("checkmark").active = false;
				this.Toggles["kexuanwanfa"][4].getChildByName("checkmark").active = false;
				if (toggleIndex == 3 || toggleIndex == 4) {
					app[app.subGameName + "_FormManager"]().ShowForm(app.subGameName + "_UIMessage_Drift", "", "", "勾选了缺一门，不能勾选金童玉女和三同");
				}
			}
			if (this.Toggles["renshu"][0].getChildByName("checkmark").active && !this.Toggles["kexuanwanfa"][10].getChildByName("checkmark").active) {
				this.Toggles["kexuanwanfa"][3].active = true;
				this.Toggles["kexuanwanfa"][4].active = true;
			}
		}
	...
	UpdateOnClickToggle: function UpdateOnClickToggle() {
		if (this.Toggles["kexuanwanfa"]) {
			if (this.unionData && this.Toggles["renshu"][0].getChildByName("checkmark").active) {
				...
				this.Toggles['kexuanwanfa'][13].getChildByName('checkmark').active = false;
...
module.exports = hncsmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hncsmjChildCreateRoom.js.map
