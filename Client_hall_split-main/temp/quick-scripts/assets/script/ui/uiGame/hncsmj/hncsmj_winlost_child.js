(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hncsmj/hncsmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '439944czaVGrayHv/nEPP0O', 'hncsmj_winlost_child', __filename);
// script/ui/uiGame/hncsmj/hncsmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerZhaMa: function ShowPlayerZhaMa(ShowNode, maList, zhongList, endPoint) {
		for (var i = 1; i <= 10; i++) {
			ShowNode.getChildByName('card' + i).active = false;
		}
		var maCardLeng = maList.length;
		if (maCardLeng == 0) {
			ShowNode.getChildByName('lb_tip').getComponent(cc.Label).string = '';
			return;
		}

		ShowNode.getChildByName('lb_tip').getComponent(cc.Label).string = '扎鸟：';
		for (var _i = 0; _i < maCardLeng; _i++) {
			var liangNode = ShowNode.getChildByName('card' + (_i + 1));
			this.ShowMaCardImg(liangNode, maList[_i], zhongList);
		}
	},
	ShowMaCardImg: function ShowMaCardImg(liangNode, cardID, zhongList) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hncsmj_winlost_child.js.map
