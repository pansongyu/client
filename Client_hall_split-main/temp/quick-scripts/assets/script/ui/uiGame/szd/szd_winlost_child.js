(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/szd/szd_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ed7ad2pLiZNWpEC6D1a5Nww', 'szd_winlost_child', __filename);
// script/ui/uiGame/szd/szd_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        var daTingShowPoint = player.daTingShowPoint;
        ...
        if (daTingShowPoint > 0) {
            winNode.active = true;
            winNode.getComponent(cc.Label).string = "+" + /*point*/daTingShowPoint;
        } else {
            loseNode.active = true;
            loseNode.getComponent(cc.Label).string = /*point*/daTingShowPoint;
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=szd_winlost_child.js.map
