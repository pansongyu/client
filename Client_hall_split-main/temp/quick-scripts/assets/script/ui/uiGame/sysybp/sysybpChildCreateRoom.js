(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sysybp/sysybpChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '685b1S2v8NKR6rRaprElXDi', 'sysybpChildCreateRoom', __filename);
// script/ui/uiGame/sysybp/sysybpChildCreateRoom.js
...
var hhhgwChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            // 小局托管解散,托管2小局解散,
            if (this.Toggles['fangjian'][3].getChildByName('checkmark').active && toggleIndex == 2) {
                this.Toggles['fangjian'][3].getChildByName('checkmark').active = false;
                this.UpdateLabelColor(this.Toggles['fangjian'][3].parent);
            } else if (this.Toggles['fangjian'][2].getChildByName('checkmark').active && toggleIndex == 3) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sysybpChildCreateRoom.js.map
