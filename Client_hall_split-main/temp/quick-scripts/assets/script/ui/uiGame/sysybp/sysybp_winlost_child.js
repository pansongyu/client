(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sysybp/sysybp_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '7ab54w6jeZE6oz592nlFKC1', 'sysybp_winlost_child', __filename);
// script/ui/uiGame/sysybp/sysybp_winlost_child.js
...
cc.Class({
    ...
    GetHuTypeDict: function GetHuTypeDict() {
        var huTypeDict = {};
        huTypeDict["HuXiNum"] = "总胡数";
        huTypeDict["SBX"] = "十八小";
        huTypeDict["WuHu"] = "黑胡";
        huTypeDict["DaHongHu"] = "大红";
        huTypeDict["DianHu"] = "一点红";
        huTypeDict["XiaoHongHu"] = "小红";
    ...
    PlayerData: function PlayerData(PlayerNode, result, pos) {
        ...
        if (huType != 0) {
            ...
            for (var _huType in huTypeMap) {
                ...
                //     if (huPoint == 1) str = "跟醒";
                // }
                huPoint = huPoint > 100 ? "X" + huPoint / 100 : huPoint;
        ...
        this.node.getChildByName("lb_chongDuoTime").getComponent(cc.Label).string = "重舵数：" + result["chongDuoTime"];
        ...
        if (point > 0) {
            ...
            lb_winpoint.getComponent(cc.Label).string = "+" + getPoint;
        } else {
            lb_winpoint.active = false;
            lb_lostpoint.active = true;
            lb_lostpoint.getComponent(cc.Label).string = getPoint;
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sysybp_winlost_child.js.map
