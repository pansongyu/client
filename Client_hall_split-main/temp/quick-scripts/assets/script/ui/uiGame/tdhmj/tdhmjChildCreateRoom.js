(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/tdhmj/tdhmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c7d1f/EgSRDPaSh5IfP6euC', 'tdhmjChildCreateRoom', __filename);
// script/ui/uiGame/tdhmj/tdhmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var tdhmj_hupai = this.GetIdxByKey('hupai');
        var tdhmj_kexuanwanfa = [];
        for (var _i2 = 0; _i2 < this.Toggles['kexuanwanfa'].length; _i2++) {
            if (this.Toggles['kexuanwanfa'][_i2].getChildByName('checkmark').active) {
                tdhmj_kexuanwanfa.push(_i2);
            }
        }
        var cityId = app.Client.GetClientConfigProperty("CityID");
        if (cityId == 1070301) {
            if (tdhmj_kexuanwanfa.indexOf(0) == -1) {
                tdhmj_kexuanwanfa.push(0);
            }
            if (tdhmj_kexuanwanfa.indexOf(1) == -1) {
                tdhmj_kexuanwanfa.push(1);
            }
            if (tdhmj_kexuanwanfa.indexOf(4) >= 0) {
                tdhmj_kexuanwanfa.splice(tdhmj_kexuanwanfa.indexOf(4), 1);
            }
            tdhmj_kexuanwanfa.push(6);
        }
        sendPack = {
            "hupai": tdhmj_hupai,
            "kexuanwanfa": tdhmj_kexuanwanfa,
        ...
        console.warn('c 最终创建的房间', sendPack);
        return sendPack;
    },
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i3 = 0; _i3 < curCostData.length; _i3++) {
                                if (curCostData[_i3].SetCount == 102) {
        ...
        var cityId = app.Client.GetClientConfigProperty("CityID");
        if (!this.Toggles || !this.Toggles['kexuanwanfa']) {
            return;
        }
        if (cityId == 1070301) {
            console.log(this.Toggles['kexuanwanfa']);
            this.Toggles['kexuanwanfa'][0].active = false;
            this.Toggles['kexuanwanfa'][2].x = this.Toggles['kexuanwanfa'][0].x;
            this.Toggles['kexuanwanfa'][1].active = false;
            this.Toggles['kexuanwanfa'][4].active = false;
            this.Toggles['kexuanwanfa'][5].x = this.Toggles['kexuanwanfa'][4].x;
        }
    }
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=tdhmjChildCreateRoom.js.map
