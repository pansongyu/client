(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/pydd/pydd_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd6766OX4OFLMbeiRSgG8bXd', 'pydd_winlost_child', __filename);
// script/ui/uiGame/pydd/pydd_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        var dingPrizeList = posEndList.dingPrizeList;
        // dingPrizeList = [
        ...
        for (var _i = 0; _i < dingPrizeList.length; _i++) {
            var dingCardList = dingPrizeList[_i];
            var cardNodes = cc.instantiate(this.prefab_zhadan);
            zhaDanLayOut.addChild(cardNodes);
            cardNodes.active = true;

            for (var j = 0; j < dingCardList.length; j++) {
                var poker = dingCardList[j];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=pydd_winlost_child.js.map
