(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sdh/sdhChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '597129VVlBHNo1L1kzQkiEK', 'sdhChildCreateRoom', __filename);
// script/ui/uiGame/sdh/sdhChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var shufenfengding = this.GetIdxByKey("shufenfengding");
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 0 && this.Toggles["renshu"][0].getChildByName("checkmark").active) {
                app.SysNotifyManager().ShowSysMsg("三人场必选“去掉6”");
                return;
            }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sdhChildCreateRoom.js.map
