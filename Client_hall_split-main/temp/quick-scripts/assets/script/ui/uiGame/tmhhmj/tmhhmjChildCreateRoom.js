(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/tmhhmj/tmhhmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b4075E3Sw1LGrJNQw14MJPn', 'tmhhmjChildCreateRoom', __filename);
// script/ui/uiGame/tmhhmj/tmhhmjChildCreateRoom.js
...
var tmhhmjChildCreateRoom = cc.Class({
	...
	UpdateOnClickToggle: function UpdateOnClickToggle() {
		if (this.Toggles["difen"]) {
			if (this.Toggles["moshi"][1].getChildByName("checkmark").active) {
				for (var i = 6; i <= 8; i++) {
					//如果其中一个有被选中就默认为一
					if (this.Toggles["difen"][i].getChildByName("checkmark").active) {
						this.Toggles["difen"][0].getChildByName("checkmark").active = true;
					}
					this.Toggles["difen"][i].active = false;
					this.Toggles["difen"][i].getChildByName("checkmark").active = false;
				}
			} else {
				for (var _i2 = 0; _i2 < this.Toggles["difen"].length; _i2++) {
					this.Toggles["difen"][_i2].active = true;
				}
			}
		}
		if (this.Toggles["kexuanwanfa"]) {
			if (this.Toggles["moshi"][0].getChildByName("checkmark").active) {
				for (var _i3 = 0; _i3 < this.Toggles["kexuanwanfa"].length; _i3++) {
					if (_i3 == 0 || _i3 == 1) {
						this.Toggles["kexuanwanfa"][_i3].active = true;
					} else {
						this.Toggles["kexuanwanfa"][_i3].active = false;
					}
				}
			} else {
...
module.exports = tmhhmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=tmhhmjChildCreateRoom.js.map
