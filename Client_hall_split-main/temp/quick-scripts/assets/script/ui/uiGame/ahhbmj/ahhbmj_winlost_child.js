(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ahhbmj/ahhbmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ef2edYBbi9KkJj2kEH1pnYW', 'ahhbmj_winlost_child', __filename);
// script/ui/uiGame/ahhbmj/ahhbmj_winlost_child.js
...
cc.Class({
    ...
    ShowOtherScore: function ShowOtherScore(ShowNode, huInfo) {
        ...
        var huPaiPoint = huInfo["huCardPoint"];
        if (huPaiPoint > 0) {
        ...
        var otherPoint = huInfo["jiaPoint"];
        if (otherPoint >= 0) {
            ShowNode.getChildByName('lb_ewaifen').active = true;
            ShowNode.getChildByName('lb_ewaifen').getComponent("cc.Label").string = "加分:+" + otherPoint;
        } else {
            ShowNode.getChildByName('lb_ewaifen').active = true;
            ShowNode.getChildByName('lb_ewaifen').getComponent("cc.Label").string = "加分:" + otherPoint;
        }
    ...
    LabelName: function LabelName(huType) {
        ...
        huTypeDict["SSL"] = "十三不靠";
        huTypeDict["QDHu"] = "七对胡";
        huTypeDict["BianJiaDiao"] = "夹子";
        huTypeDict["DanTing"] = "报胡";
        huTypeDict["QueYiSe"] = "缺一";
        huTypeDict["JieGang"] = "直杠";
        huTypeDict["Gang"] = "续杠";
        huTypeDict["AnGang"] = "暗杠";
        huTypeDict["JiePao"] = "炮胡";
        huTypeDict["PaoFen"] = "跑";
        huTypeDict["PiaoFen"] = "拉";
        huTypeDict["KanFen"] = "坐";
        huTypeDict["QXSSL"] = "七星十三不靠";
        huTypeDict["SSY"] = "十三幺";
        huTypeDict["Hua"] = "花";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ahhbmj_winlost_child.js.map
