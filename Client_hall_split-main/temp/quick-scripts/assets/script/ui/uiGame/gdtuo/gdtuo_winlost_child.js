(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gdtuo/gdtuo_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '9050cEsXSNIUaPjgwb0tU2Z', 'gdtuo_winlost_child', __filename);
// script/ui/uiGame/gdtuo/gdtuo_winlost_child.js
...
cc.Class({
	...
	ShowSpecData: function ShowSpecData(setEnd, playerAll, index) {
		...
		if (isQiPai) {
			var qiPai = -4;
			var cardList = [];
			for (var _i = 0; _i < player["privateCards"].length; _i++) {
				cardList.push(0);
			}
			this.ShowPrivateCards(cardList, isQiPai);
			this.ShowChipValue(qiPai);
		} else {
			this.ShowPrivateCards(player["privateCards"]);
			this.ShowChipValue(player["value"], player["isShowValue"]);
		}

		this.ShowPointValue(player["setPoint"]);
		/*//比赛分消耗
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gdtuo_winlost_child.js.map
