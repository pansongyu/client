(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hhpdk/hhpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '3c6b31LvotM6oj4QmZAgRFJ', 'hhpdkChildCreateRoom', __filename);
// script/ui/uiGame/hhpdk/hhpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if ((this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active || this.Toggles['kexuanwanfa'][13].getChildByName('checkmark').active) && toggleIndex == 1) {
            ...
            } else if ((this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active || this.Toggles['kexuanwanfa'][13].getChildByName('checkmark').active) && toggleIndex == 0) {
                this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active = false;
                this.Toggles['kexuanwanfa'][13].getChildByName('checkmark').active = false;
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][1].parent);
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][13].parent);
            } else if ((this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active || this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active) && toggleIndex == 13) {
                this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active = false;
                this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active = false;
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][0].parent);
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][1].parent);
            ...
            //3A不为炸不能选择3A为最大炸
            if (!this.Toggles['kexuanwanfa'][11].getChildByName('checkmark').active && toggleIndex == 5) {
                // app.SysNotifyManager().ShowSysMsg("未勾选3A为炸时，不可选择3A为最大炸");
                app.SysNotifyManager().ShowSysMsg("请先勾选3A为炸");
                return;
            }
            if (toggleIndex == 11 && this.Toggles['kexuanwanfa'][toggleIndex].getChildByName('checkmark').active) {
                this.Toggles['kexuanwanfa'][5].getChildByName('checkmark').active = false;
            }
            if (toggleIndex == 5 || toggleIndex == 11) {
            ...
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ("kexuanwanfa" == curKey) {
                        ...
                        this.Toggles['kexuanwanfa'][9].serverIdx = 28; //尾张算分
                        this.Toggles['kexuanwanfa'][10].serverIdx = 29; //无炸
                        this.Toggles['kexuanwanfa'][11].serverIdx = 4; //3A炸
                        this.Toggles['kexuanwanfa'][12].serverIdx = 30; //防作弊
                        this.Toggles['kexuanwanfa'][13].serverIdx = 31; //随机首来
                        this.Toggles['kexuanwanfa'][14].serverIdx = 32; //比赛分不为负
                        this.Toggles['kexuanwanfa'][15].serverIdx = 33; //带多少只赢多少
                    }
                ...
                for (var _i9 = 1; _i9 <= toggleCount; _i9++) {
                    ...
                    if (curNode) {
                        ...
                        for (var _j2 = 0; _j2 < showList.length; _j2++) {
                            ...
                            //判断是否亲友圈
                            if (dataKey == "kexuanwanfa") {
                                if (showList[_j2] == 15 || showList[_j2] == 16 || showList[_j2] == 19) {
                                    //三个默认得 不显示 直接跳过
                                    continue;
                                }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hhpdkChildCreateRoom.js.map
