(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/htmj/htmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1017536gltGbI9elZT+nAY1', 'htmj_winlost_child', __filename);
// script/ui/uiGame/htmj/htmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        if (posResultList[index]['jiaMa']) {
            this.node.getChildByName("user_info").getChildByName("ma").active = true;
        } else {
            this.node.getChildByName("user_info").getChildByName("ma").active = false;
        }
        //显示头像，如果头像UI
    ...
    UpdatePlayData: function UpdatePlayData(PlayerNode, HuList, PlayerInfo) {
        ...
        this.ShowPlayerNiaoPai(PlayerNode.getChildByName('zhongma'), PlayerNode.getChildByName('mavalue'), zhuaNiaoList, HuList.endPoint);
    },
    ...
    ShowPlayerNiaoPai: function ShowPlayerNiaoPai(ShowNode, valueNode, zhuaNiaoList, endPoint) {
        var niaoPaiList = endPoint["niaoPaiList"] || [];
        var niaoValueList = endPoint["niaoValueList"] || [];
        for (var i = 1; i <= 3; i++) {
            ShowNode.getChildByName('card' + i).active = false;
            ShowNode.getChildByName("card" + i).color = cc.color(255, 255, 255);
        }
        for (var j = 1; j <= 5; j++) {
            valueNode.getChildByName("dot" + j).active = false;
        }
        ...
        //     return;
        // }
        for (var index = 0; index < niaoValueList.length; index++) {
            var num = niaoValueList[index];
            valueNode.getChildByName("dot" + (index + 1)).active = true;
            valueNode.getChildByName("dot" + (index + 1)).getChildByName("label").getComponent(cc.Label).string = num;
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=htmj_winlost_child.js.map
