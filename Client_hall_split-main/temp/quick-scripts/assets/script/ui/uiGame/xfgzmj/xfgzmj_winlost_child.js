(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xfgzmj/xfgzmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a352dKmaJlB/J34MgYpPpHh', 'xfgzmj_winlost_child', __filename);
// script/ui/uiGame/xfgzmj/xfgzmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		this.UpdatePlayData(this.node, posResultList[index], PlayerInfo, jin1, jin2, setEnd.maList || []);
	...
	UpdatePlayData: function UpdatePlayData(PlayerNode, HuList, PlayerInfo) {
		...
		this.ShowPlayerNiaoPai(PlayerNode.getChildByName('niaopai'), zhuaNiaoList, HuList.endPoint, HuList.huType);
	},
	...
	ShowPlayerNiaoPai: function ShowPlayerNiaoPai(ShowNode, zhuaNiaoList, endPoint, huType) {
   ...
   */
		...
		if (typeof huType == "undefined") {
			...
			huNode.getComponent(cc.Label).string = '放铳';
	...
	LabelName: function LabelName(huType) {
		...
		huTypeDict["JiangMa"] = "奖马分";
		huTypeDict["JingJDiao"] = "精吊奖";
		huTypeDict["ZiMo"] = "自摸";
		huTypeDict["QGH"] = "抢杠胡";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xfgzmj_winlost_child.js.map
