(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xfgzmj/xfgzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '62f13DY0fdHCpGT8cOzaZcp', 'xfgzmjChildCreateRoom', __filename);
// script/ui/uiGame/xfgzmj/xfgzmjChildCreateRoom.js
...
var jsnyzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var jingpai = this.GetIdxByKey('jingpai');
        var kexuanwanfa = this.GetIdxsByKey('kexuanwanfa');
        var zhongmaguize = this.GetIdxByKey('zhongmaguize');
        ...
        if (this.Toggles["zhongmaguize"]) {
            if (this.Toggles["maima"][3].getChildByName("checkmark").active) {
                zhongmaguize = -1;
            }
        }
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 2) {
                var mark = needClearList[toggleIndex - 1].getChildByName('checkmark').active;
                if (!mark) {
                    app.SysNotifyManager().ShowSysMsg("未勾选可胡七对时，不可选择七对翻倍");
                    return;
                }
            } else if (toggleIndex == 1 && needClearList[2].getChildByName('checkmark').active) {
                needClearList[2].getChildByName('checkmark').active = false;
            } else if (toggleIndex == 6) {
                if (!this.Toggles["maima"][3].getChildByName("checkmark").active) {
                    app.SysNotifyManager().ShowSysMsg("未勾选随机买1个马时，不可选择一算十");
                    return;
                }
            }
        } else if ('maima' == key) {
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        if (this.Toggles["zhongmaguize"]) {
            if (this.Toggles["maima"][3].getChildByName("checkmark").active) {
                this.Toggles['zhongmaguize'][0].parent.active = false;
            } else {
                this.Toggles['zhongmaguize'][0].parent.active = true;
            }
        }
    }
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xfgzmjChildCreateRoom.js.map
