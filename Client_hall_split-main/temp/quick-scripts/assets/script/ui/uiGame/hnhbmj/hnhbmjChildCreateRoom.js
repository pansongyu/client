(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hnhbmj/hnhbmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a7e4bOBRWpNVJ5vUUWINdho', 'hnhbmjChildCreateRoom', __filename);
// script/ui/uiGame/hnhbmj/hnhbmjChildCreateRoom.js
...
var hnhbmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var hudifen = this.GetIdxByKey('hudifen');
 ...
 UpdateOnClickToggle:function () {
 	if (this.Toggles["kexuanwanfa"]) {
 		if (this.Toggles["fengpai"][0].getChildByName("checkmark").active && this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active) {
 		...
 		if (this.Toggles["xiapao"][1].getChildByName("checkmark").active) {
 			this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active = false;
 	...
 	if (this.Toggles["xuanpao"]) {
 		if (this.Toggles["xiapao"][0].getChildByName("checkmark").active && this.Toggles["xuanpaofangshi"][1].getChildByName("checkmark").active) {
 			this.Toggles["xuanpao"][0].parent.active = true;
 		} else {
 			this.Toggles["xuanpao"][0].parent.active = false;
 		}
 	}
 	if (this.Toggles["xuanpaofangshi"]) {
 		if (this.Toggles["xiapao"][0].getChildByName("checkmark").active) {
 			this.Toggles["xuanpaofangshi"][0].parent.active = true;
 		} else {
 			this.Toggles["xuanpaofangshi"][0].parent.active = false;
 		}
 	}
 },*/
});

module.exports = hnhbmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hnhbmjChildCreateRoom.js.map
