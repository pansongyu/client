(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hnhbmj/hnhbmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5e4caqSf41OXKt+2/3wvxGu', 'hnhbmj_winlost_child', __filename);
// script/ui/uiGame/hnhbmj/hnhbmj_winlost_child.js
...
cc.Class({
	...
	UpdatePlayData: function UpdatePlayData(PlayerNode, HuList, PlayerInfo) {
		...
		this.ShowGeZongFen(PlayerNode.getChildByName("gezongfen"), HuList["huPointMap"]);
	},
	...
	ShowGeZongFen: function ShowGeZongFen(showNode, huPointMap) {
		var nodes = {
			GangFen: showNode.children[0],
			PaoFen: showNode.children[1],
			NiaoFen: showNode.children[2],
			HuFen: showNode.children[3]
		};
		showNode.active = true;
		for (var i = 0; i < showNode.children.length; i++) {
			showNode.children[i].getComponent(cc.Label).string = "";
		}
		var huPointDict = {
			GangFen: "杠分：",
			PaoFen: "跑分：",
		...
		for (var key in huPointMap) {
			var huPoint = huPointMap[key];
			var pointStr = huPointDict[key];
			nodes[key].getComponent(cc.Label).string = pointStr + huPoint;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hnhbmj_winlost_child.js.map
