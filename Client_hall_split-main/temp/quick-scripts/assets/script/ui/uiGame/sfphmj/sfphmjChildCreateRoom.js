(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sfphmj/sfphmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'bfb60/n+DJF0Jhw3ZMTbtac', 'sfphmjChildCreateRoom', __filename);
// script/ui/uiGame/sfphmj/sfphmjChildCreateRoom.js
...
var sfphmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var duotou = this.GetIdxByKey('duotou');
		var kexuanwanfa = this.GetIdxsByKey('kexuanwanfa');
		var huanzhang = this.GetIdxByKey('huanzhang');
		var qishi = this.GetIdxByKey('qishi');
		var qidui = this.GetIdxByKey('qidui');
		var shenlong = this.GetIdxByKey('shenlong');
	...
	AdjustSendPack: function AdjustSendPack(sendPack) {
		...
		} else if (sendPack.playerNum == 4) {
			this.RemoveMultiSelect(sendPack, "kexuanwanfa", 6);
		}
		if (sendPack.playerNum != 4) {
			this.RemoveMultiSelect(sendPack, "kexuanwanfa", 12);
		}
		if (sendPack.kexuanwanfa.indexOf(0) < 0) {
	...
	UpdateOnClickToggle: function UpdateOnClickToggle() {
		if (this.Toggles["kexuanwanfa"]) {
			...
			} else if (this.Toggles["renshu"][1].getChildByName("checkmark").active || this.Toggles["renshu"][2].getChildByName("checkmark").active) {
				this.Toggles["kexuanwanfa"][5].active = true;
			} else if (this.Toggles["renshu"][0].getChildByName("checkmark").active || this.Toggles["renshu"][1].getChildByName("checkmark").active) {
...
module.exports = sfphmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sfphmjChildCreateRoom.js.map
