(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zzph/zzphChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8a62dfIAXpEzKJrNKqOxAFu', 'zzphChildCreateRoom', __filename);
// script/ui/uiGame/zzph/zzphChildCreateRoom.js
...
var zzphChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var wudui = this.GetIdxByKey('wudui');
	...
	UpdateOnClickToggle: function UpdateOnClickToggle() {
		if (this.Toggles["choupai"]) {
			if (this.Toggles["renshu"][2].getChildByName('checkmark').active) {
				this.Toggles["choupai"][0].parent.active = false;
			} else {
				this.Toggles["choupai"][0].parent.active = true;
				this.Toggles["choupai"][1].active = true;
				if (this.Toggles["renshu"][1].getChildByName('checkmark').active) {
					this.Toggles["choupai"][1].active = false;
					if (this.Toggles["choupai"][1].getChildByName('checkmark').active) {
						this.Toggles["choupai"][1].getChildByName('checkmark').active = false;
						this.Toggles["choupai"][2].getChildByName('checkmark').active = true;
					}
				}
			}
		}
		if (this.Toggles["dajusuanfen"]) {
...
module.exports = zzphChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zzphChildCreateRoom.js.map
