(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ygpdk/ygpdk_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '762cem1cOlLuYU1w+i/0PB2', 'ygpdk_winlost_child', __filename);
// script/ui/uiGame/ygpdk/ygpdk_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        if (typeof player.faFen != "undefined") {
            ...
            var fafen = this.node.getChildByName("lb_fafen").getComponent(cc.Label);
            if (player.faFen > 0) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ygpdk_winlost_child.js.map
