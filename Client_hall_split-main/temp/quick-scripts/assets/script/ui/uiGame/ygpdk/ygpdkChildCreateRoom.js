(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ygpdk/ygpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '87102zQ3RJH9Z09hXEhFHoW', 'ygpdkChildCreateRoom', __filename);
// script/ui/uiGame/ygpdk/ygpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if (toggles.getComponent(cc.Toggle)) {
            //复选框
            needShowIndexList = [];
            for (var _i5 = 0; _i5 < needClearList.length; _i5++) {
                var mark = needClearList[_i5].getChildByName('checkmark').active;
                //如果复选框为勾选状态并且点击的复选框不是该复选框，则继续保持勾选状态
                if (mark && _i5 != toggleIndex) {
                    needShowIndexList.push(_i5);
                }
                //如果复选框为未勾选状态并且点击的复选框是该复选框，则切换为勾选状态
                else if (!mark && _i5 == toggleIndex) {
                        needShowIndexList.push(_i5);
                    }
            }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ygpdkChildCreateRoom.js.map
