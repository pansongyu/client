(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/whmj/whmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'df662e7vZBJa6StmODtws9d', 'whmjChildCreateRoom', __filename);
// script/ui/uiGame/whmj/whmjChildCreateRoom.js
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i = 0; _i < curCostData.length; _i++) {
                                if (curCostData[_i].SetCount > 400) {
                                    this.Toggles['jushu'][_i].getChildByName('label').getComponent(cc.Label).string = curCostData[_i].SetCount % 400 + '底';
                                } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=whmjChildCreateRoom.js.map
