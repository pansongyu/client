(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/yzyzmj/yzyzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '60312oFnXpG+bCgf3J5rwvu', 'yzyzmjChildCreateRoom', __filename);
// script/ui/uiGame/yzyzmj/yzyzmjChildCreateRoom.js
...
var thgjmjChildCreateRoom = cc.Class({
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["renshu"]) {
            var isHide = this.Toggles["renshu"][0].getChildByName("checkmark").active;
            var hideIdxs = [3, 4, 5]; //     财神、边卡吊、带风仅互报互飞可选；
            for (var i = 0; i < hideIdxs.length; i++) {
                var idx = hideIdxs[i];
                var toggle = this.Toggles['jushu'][idx];
                toggle.active = !isHide;
            }
            for (var _i = 0; _i < this.Toggles["jushu"].length; _i++) {
                if (this.Toggles["jushu"][_i].getChildByName("checkmark").active) {
                    if (_i > 2) {
                        this.Toggles['renshu'][0].active = false;
                    } else {
                        this.Toggles['renshu'][0].active = true;
                    }
                }
            }
        }
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i3 = 0; _i3 < curCostData.length; _i3++) {
                                if (curCostData[_i3].SetCount > 100) {
                                    this.Toggles['jushu'][_i3].getChildByName('label').getComponent(cc.Label).string = curCostData[_i3].SetCount % 100 + '圈';
                                    continue;
                                }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=yzyzmjChildCreateRoom.js.map
