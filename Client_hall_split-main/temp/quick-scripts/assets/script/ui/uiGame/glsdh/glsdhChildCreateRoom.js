(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/glsdh/glsdhChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ff398t/a5lNaLj8vRTNirDe', 'glsdhChildCreateRoom', __filename);
// script/ui/uiGame/glsdh/glsdhChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var jichujifen = this.GetIdxByKey("jichujifen");
        var baoguangfen = this.GetIdxByKey("baoguangfen");
        ...
        sendPack = {
            "jichujifen": jichujifen,
            "baoguangfen": baoguangfen,
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 4 && this.Toggles["kexuanwanfa"][2].getChildByName("checkmark").active) {
                app.SysNotifyManager().ShowSysMsg("勾选无6不可勾选“有6688”");
                return;
            }
            if (toggleIndex == 5 && !this.Toggles["kexuanwanfa"][2].getChildByName("checkmark").active) {
                app.SysNotifyManager().ShowSysMsg("未勾选无6不可勾选“有5588”");
                return;
            }
            if (toggleIndex == 4) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=glsdhChildCreateRoom.js.map
