(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xwmj/xwmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b1c1dVd6NxDRrb5Cg4IUXIk', 'xwmj_winlost_child', __filename);
// script/ui/uiGame/xwmj/xwmj_winlost_child.js
...
cc.Class({
  ...
  */
		...
		if (huTypeName == "QiangTiHu") {
			huNode.getComponent(cc.Label).string = '抢提胡';
		} else if (typeof huType == "undefined") {
	...
	ShowPlayerJieSuan: function ShowPlayerJieSuan(ShowNode, huInfoAll) {
		var huInfo = huInfoAll.huTypeMap || huInfoAll.endPoint.huTypeMap;
		...
		for (var huType in huInfo) {
			...
			if (this.IsShowMulti(huType)) {
				...
				this.ShowLabelName(ShowNode.getChildByName("label_lists"), huTypeDict[huType] + "个");
			} else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xwmj_winlost_child.js.map
