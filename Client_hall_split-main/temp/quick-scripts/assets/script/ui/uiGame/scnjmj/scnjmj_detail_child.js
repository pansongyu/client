(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/scnjmj/scnjmj_detail_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2ab23icN2VGn57hxLjX6enS', 'scnjmj_detail_child', __filename);
// script/ui/uiGame/scnjmj/scnjmj_detail_child.js
...
cc.Class({
    ...
    huTypesShow: function huTypesShow(jiesuan, huData) {
        var jiepao = this.GetJiePaoCount(huData);
        var hupaiNum = huData.huTypes.length - jiepao;
    ...
    GetJiePaoCount: function GetJiePaoCount(huData) {
        var jiepao = 0;
        for (var i = 0; i < huData.huTypes.length; i++) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=scnjmj_detail_child.js.map
