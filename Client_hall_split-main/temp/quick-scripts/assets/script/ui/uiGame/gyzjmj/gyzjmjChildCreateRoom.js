(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gyzjmj/gyzjmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '838bcy5BUpMD4xoncVmvmzp', 'gyzjmjChildCreateRoom', __filename);
// script/ui/uiGame/gyzjmj/gyzjmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var jipai = this.GetIdxByKey("jipai");
        var yinghu = -1;
        if (wanfa == 1) {
            yinghu = this.GetIdxByKey("yinghu");
        }
    ...
    HideOrShowToggle: function HideOrShowToggle() {
        if (this.Toggles['wanfa'][1].getChildByName('checkmark').active == true) {
            if (this.Toggles['yinghu']) {
                this.Toggles['yinghu'][0].parent.active = true;
            }
        } else {
            if (this.Toggles['yinghu']) {
                this.Toggles['yinghu'][0].parent.active = false;
            }
        }
        if (this.Toggles['wanfa'][1].getChildByName('checkmark').active == true) {
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i4 = 0; _i4 < curCostData.length; _i4++) {
                                if (curCostData[_i4].SetCount > 100) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gyzjmjChildCreateRoom.js.map
