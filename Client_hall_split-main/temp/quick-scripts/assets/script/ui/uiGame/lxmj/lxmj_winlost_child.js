(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/lxmj/lxmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2a196QIVgtCT5HcIA6R5vkt', 'lxmj_winlost_child', __filename);
// script/ui/uiGame/lxmj/lxmj_winlost_child.js
...
cc.Class({
    ...
    // 参照位置，提供位置
    GetProvidePos: function GetProvidePos(referencePos, providePos) {
        ...
        var offPos = (providePos - referencePos + 2 * playerCount) % playerCount;
        return cfg[playerCount][offPos];
    },
    ShowPlayerHuPai: function ShowPlayerHuPai(showNode, huInfoAll, pos) {
        var huInfo = false;
        ...
        var huPosInfo = huInfo["huPosInfo"];
        for (var i = 1; i <= 23; i++) {
            showNode.getChildByName("card" + i).active = false;
        ...
        for (var key in huInfoMap) {
            ...
            var lb_provide = this.GetProvidePos(pos, providePos);
...
cc._RF.pop();
        ...
        //# sourceMappingURL=lxmj_winlost_child.js.map
