(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zjqzsk/zjqzsk_detail_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ea01cLKI2hHrr2ldZwH1S60', 'zjqzsk_detail_child', __filename);
// script/ui/uiGame/zjqzsk/zjqzsk_detail_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(resultsList, playerAll, idx) {
		...
		this.node.getChildByName("lbMaxScore").getComponent(cc.Label).string = data["highScore"] || 0;
		this.node.getChildByName("lbMaxXiang").getComponent(cc.Label).string = data["highMultiple"] || 0;
		this.node.getChildByName("lbDoubleKou").getComponent(cc.Label).string = data["shuangKouNum"] || 0;
		if (data.point >= 0) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zjqzsk_detail_child.js.map
