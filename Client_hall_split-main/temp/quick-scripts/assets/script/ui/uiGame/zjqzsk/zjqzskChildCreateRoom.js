(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zjqzsk/zjqzskChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8020cKn+ShEtaRrAk7soo0W', 'zjqzskChildCreateRoom', __filename);
// script/ui/uiGame/zjqzsk/zjqzskChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var fenpai = this.GetIdxByKey('fenpai');
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		var lightChangeChair = null;
		if ("renshu" == key && 1 == toggleIndex) {
			// 人数：2人局
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key || 'sign' == key) {
			...
			if (this.gameType == 'zjqzsk') {
				var renshu2 = this.Toggles['renshu'][1].getChildByName('checkmark').active; // 2人局
				if (renshu2 && 3 == toggleIndex) {
					// 无亮牌换位
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zjqzskChildCreateRoom.js.map
