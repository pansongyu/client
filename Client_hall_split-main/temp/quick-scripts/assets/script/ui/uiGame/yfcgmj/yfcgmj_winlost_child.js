(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/yfcgmj/yfcgmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'aa718Peg/REPLF3Dr3IekNl', 'yfcgmj_winlost_child', __filename);
// script/ui/uiGame/yfcgmj/yfcgmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        var shangJingList = setEnd.shangJingList;
        var jin1 = shangJingList[0];
        var jin2 = 0;
        if (shangJingList[1] > 0) {
            jin2 = shangJingList[1];
        }
    ...
    LabelName: function LabelName(huType) {
        ...
        huTypeDict["ChaoZhuang"] = "抄庄";
        huTypeDict["ShangJingFen"] = "上精分";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=yfcgmj_winlost_child.js.map
