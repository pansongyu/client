(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/yfcgmj/yfcgmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '0cdefAFaE9KoISUlTEMyqVv', 'yfcgmjChildCreateRoom', __filename);
// script/ui/uiGame/yfcgmj/yfcgmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        if (this.Toggles["jingpai"]) {
            if (this.Toggles["wanfa"][1].getChildByName("checkmark").active) {
                this.Toggles['jingpai'][0].parent.active = false;
            } else {
                this.Toggles['jingpai'][0].parent.active = true;
            }
        }
        if (this.Toggles["piaofen"]) {
            if (this.Toggles["wanfa"][0].getChildByName("checkmark").active) {
                this.Toggles['piaofen'][0].parent.active = false;
            } else {
                this.Toggles['piaofen'][0].parent.active = true;
            }
        }
                    ...
                    if (curNode) {
                        ...
                        if (this.unionData == null || this.unionData.cfgData == null) {
                            ...
                            if ((typeof cfgDataList === "undefined" ? "undefined" : _typeof(cfgDataList)) == "object") {
                                ...
                                if (cfgDataList == -1) {
                                    showList = this.gameCreateConfig[key].ShowIndexs.toString().split(',');
                                }
                            }
                        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=yfcgmjChildCreateRoom.js.map
