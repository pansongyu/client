(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/cqcp/UIRecordAllResult_cqcp.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f8a4c6R3PxMTYUTmxH53v1a', 'UIRecordAllResult_cqcp', __filename);
// script/ui/uiGame/cqcp/UIRecordAllResult_cqcp.js
...
cc.Class({
	...
	InitShowPlayerInfo: function InitShowPlayerInfo(setEnd) {
		...
		//叫分 抓分
		this.zhuafen.string = "抓分：" + setEnd.k510Point;
		this.jiaofen.string = "叫分：" + setEnd.jiaoDang + "挡（" + setEnd.jiaoDangFen + "分）";
	...
	ShowDiPai: function ShowDiPai(setEnd) {
		for (var i = 0; i < this.dipaiLayout.length; i++) {
			this.dipaiLayout.children[i].active = false;
		}
		var diPai = setEnd["diPaiList"];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIRecordAllResult_cqcp.js.map
