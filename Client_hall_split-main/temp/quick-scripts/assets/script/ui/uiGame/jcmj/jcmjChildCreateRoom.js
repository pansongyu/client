(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jcmj/jcmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'bcd0fscQC1CbIoBis8NHPCI', 'jcmjChildCreateRoom', __filename);
// script/ui/uiGame/jcmj/jcmjChildCreateRoom.js
...
var gamjChildCreateRoom = cc.Class({
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["kexuanwanfa"]) {
            if (this.Toggles["kexuanwanfa"][7] && !this.Toggles["kexuanwanfa"][7].getChildByName("checkmark").active) {
                // 勾选七对翻倍
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jcmjChildCreateRoom.js.map
