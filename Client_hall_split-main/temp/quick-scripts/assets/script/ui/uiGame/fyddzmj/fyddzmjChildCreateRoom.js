(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/fyddzmj/fyddzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8b98erHkVVJ2ZqIyZUBrjH2', 'fyddzmjChildCreateRoom', __filename);
// script/ui/uiGame/fyddzmj/fyddzmjChildCreateRoom.js
...
var thgjmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var haozi = this.GetIdxByKey('haozi');
        var paohu = this.GetIdxByKey('paohu');
        var zhuangjiazidai = this.GetIdxByKey('zhuangjiazidai');
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 0) {
                var mark = this.Toggles['haozi'][1].getChildByName('checkmark').active;
                if (!mark) {
                    app.SysNotifyManager().ShowSysMsg("带耗子玩法才能勾选此玩法", [], 3);
                    return;
                }
            }
            if (toggleIndex == 1 || toggleIndex == 2) {
                var _mark = this.Toggles['haozi'][1].getChildByName('checkmark').active;
                if (_mark) {
                    app.SysNotifyManager().ShowSysMsg("带耗子玩法不能勾选此玩法", [], 3);
                    return;
                }
            }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=fyddzmjChildCreateRoom.js.map
