(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/njmj/njmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '093c5ok61JOjJ9QkTZLc3ft', 'njmjChildCreateRoom', __filename);
// script/ui/uiGame/njmj/njmjChildCreateRoom.js
...
var gamjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var jinyuanzi = this.GetIdxByKey('jinyuanzi');
        var changkaitou = this.GetIdxByKey('changkaitou');
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["jinyuanzi"]) {
            if (this.Toggles["wanfa"][0].getChildByName("checkmark").active) {
                // 进园子玩法
                this.Toggles["jinyuanzi"][0].parent.active = true; // 进园子
                if (this.Toggles["changkaitou"]) {
                    this.Toggles["changkaitou"][0].parent.active = false; // 敞开头
                }
            } else {
                // 敞开头玩法
                this.Toggles["jinyuanzi"][0].parent.active = false; // 进园子
                if (this.Toggles["changkaitou"]) {
                    this.Toggles["changkaitou"][0].parent.active = true; // 敞开头
                }
                if (this.Toggles["kexuanwanfa"]) {
                    this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active = true; // 花砸2
                    this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active = true; // 东南西北罚分
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key || "wanfa" == key) {
            ...
            if (toggleIndex == 0 || toggleIndex == 1) {
                var is = this.Toggles['wanfa'][1].getChildByName('checkmark').active;
                if (is) {
    ...
    AdjustSendPack: function AdjustSendPack(sendPack) {
        if (sendPack.wanfa == 0) {
            // 进园子
            sendPack.changkaitou = -1;
        } else {
            // 敞开头
            sendPack.jinyuanzi = -1;
            // let index = sendPack.kexuanwanfa.indexOf(0);// 花砸2
            // if (-1 != index) {
            // 	sendPack.kexuanwanfa.splice(index, 1);
            // }
            // index = sendPack.kexuanwanfa.indexOf(1);// 东南西北罚分
            // if (-1 != index) {
            // 	sendPack.kexuanwanfa.splice(index, 1);
            // }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=njmjChildCreateRoom.js.map
