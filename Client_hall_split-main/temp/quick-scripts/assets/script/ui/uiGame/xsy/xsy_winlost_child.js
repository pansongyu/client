(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xsy/xsy_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '713292w3KNBIYP4ElLcvXJk', 'xsy_winlost_child', __filename);
// script/ui/uiGame/xsy/xsy_winlost_child.js
...
cc.Class({
    ...
    OnLoad: function OnLoad() {
        app["gxcdd_PokerCard"] = require("gxcdd_PokerCard").GetModel;
        this.ComTool = app.ComTool();
        this.ShareDefine = app.ShareDefine();
        this.PokerCard = app.gxcdd_PokerCard();
    },
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        this.node.getChildByName('record').getChildByName('lb_shouCardSize').getComponent(cc.Label).string = "" + posEndList.liuPai;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xsy_winlost_child.js.map
