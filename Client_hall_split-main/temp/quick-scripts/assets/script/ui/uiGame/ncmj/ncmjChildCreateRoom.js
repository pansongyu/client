(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ncmj/ncmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '556187tzbpAMK4uDwNa4R+9', 'ncmjChildCreateRoom', __filename);
// script/ui/uiGame/ncmj/ncmjChildCreateRoom.js
...
var thgjmjChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 3 && this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active) {
                this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active = false;
                this.UpdateLabelColor(this.Toggles['kexuanwanfa'][0].parent);
            }
        } else if ('kexuanwanfa' == key) {
            if (this.Toggles['guize'][3].getChildByName('checkmark').active && toggleIndex == 0) {
                return;
            }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ncmjChildCreateRoom.js.map
