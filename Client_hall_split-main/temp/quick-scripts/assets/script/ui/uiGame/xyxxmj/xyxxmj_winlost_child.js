(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xyxxmj/xyxxmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '290704Zh1xFs6FWl0PGdxnz', 'xyxxmj_winlost_child', __filename);
// script/ui/uiGame/xyxxmj/xyxxmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		// let piaoFen = posResultList[index]["piaoFen"] || -1;
		// if (piaoFen < 0) {
		// 	this.node.getChildByName("user_info").getChildByName("pao").getComponent(cc.Sprite).spriteFrame = "";
		// } else {
		// 	this.node.getChildByName("user_info").getChildByName("pao").getComponent(cc.Sprite).spriteFrame = this.paoIcon[piaoFen];
		// }
		//显示头像，如果头像UI
	...
	ShowPlayerRecord: function ShowPlayerRecord(ShowNode, huInfo) {
		...
		var xiaPaoFen = huInfo["xiaPaoFen"];
		if (xiaPaoFen > 0) {
			ShowNode.getChildByName('lb_xiapaofen').active = true;
			ShowNode.getChildByName('lb_xiapaofen').getComponent("cc.Label").string = "下跑分:" + xiaPaoFen;
		} else {
			ShowNode.getChildByName('lb_xiapaofen').active = false;
		}
		...
		var zuiFen = huInfo["zuiFen"];
		if (zuiFen > 0) {
			ShowNode.getChildByName('lb_zuifen').active = true;
			ShowNode.getChildByName('lb_zuifen').getComponent("cc.Label").string = "嘴分:" + zuiFen;
		} else {
   ...
   */
	...
	LabelName: function LabelName(huType) {
		...
		huTypeDict["Luan119"] = "119";
		huTypeDict["Luan991"] = "991";
		huTypeDict["Luan111"] = "111";
		huTypeDict["Luan999"] = "999";
		huTypeDict["TongHua139"] = "139";
		huTypeDict["TongHua579"] = "579";
		huTypeDict["BenBenGao"] = "奔奔高";
		huTypeDict["Dui258"] = "对258";
		huTypeDict["Luan258"] = "乱258";
		huTypeDict["CaiFeng"] = "彩风";
		huTypeDict["LuanFeng"] = "乱风";
		huTypeDict["ZhengFeng"] = "正风";
		huTypeDict["ShiDian"] = "十点";
		huTypeDict["ErShiDian"] = "二十点";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xyxxmj_winlost_child.js.map
