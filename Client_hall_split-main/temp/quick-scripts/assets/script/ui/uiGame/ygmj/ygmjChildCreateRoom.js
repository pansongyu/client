(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ygmj/ygmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'be98fCbtKZPuojqFhDu1lh8', 'ygmjChildCreateRoom', __filename);
// script/ui/uiGame/ygmj/ygmjChildCreateRoom.js
...
var zjmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var feibaofengding = this.GetIdxByKey('feibaofengding');

        // let baofen = -1;
        // if(renshu[0]==2){
        var baofen = this.GetIdxByKey('baofen');
        // }
        var tuoguan = this.GetIdxByKey('tuoguan');

        var fafen = this.GetIdxByKey('fafen');
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        // if (this.Toggles["baofen"]) {
        //     this.Toggles["baofen"][0].parent.active = this.Toggles["renshu"][0].getChildByName("checkmark").active;
        // }
        if (this.Toggles["fangjian"] && this.Toggles["fafen"]) {
            if (!this.Toggles["fafen"][4].getChildByName("checkmark").active) {
                this.Toggles["fangjian"][1].active = false;
                this.Toggles["fangjian"][1].getChildByName("checkmark").active = false;
                this.UpdateLabelColor(this.Toggles['fangjian'][1].parent);
            } else {
                this.Toggles["fangjian"][1].active = true;
            }
        }
        if (this.Toggles["kexuanwanfa"]) {
            this.Toggles["kexuanwanfa"][2].active = this.Toggles["wanfa"][0].getChildByName("checkmark").active;
            this.Toggles["kexuanwanfa"][3].active = !this.Toggles["wanfa"][0].getChildByName("checkmark").active;
        }
    },
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 0 && !this.Toggles["fafen"][4].getChildByName("checkmark").active) {
                for (var i = 0; i < this.Toggles["fafen"].length; i++) {
        ...
        if (toggles.getComponent(cc.Toggle)) {
            //复选框
            needShowIndexList = [];
            for (var _i = 0; _i < needClearList.length; _i++) {
                var mark = needClearList[_i].getChildByName('checkmark').active;
                //如果复选框为勾选状态并且点击的复选框不是该复选框，则继续保持勾选状态
                if (mark && _i != toggleIndex) {
                    needShowIndexList.push(_i);
                }
                //如果复选框为未勾选状态并且点击的复选框是该复选框，则切换为勾选状态
                else if (!mark && _i == toggleIndex) {
                        needShowIndexList.push(_i);
                    }
            }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ygmjChildCreateRoom.js.map
