(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/qzkhmj/qzkhmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'dd35f7uR5VCoIEDHEQFQEhp', 'qzkhmjChildCreateRoom', __filename);
// script/ui/uiGame/qzkhmj/qzkhmjChildCreateRoom.js
...
var thgjmjChildCreateRoom = cc.Class({
    ...
    AdjustSendPack: function AdjustSendPack(sendPack) {
        ...
        // 	勾选“硬自摸”，才能勾选“七对”；
        // 	勾选“抬头胡”，才能勾选“禁止吃牌”；
        /*if (sendPack.moshi == 0) { // 硬自摸
        	this.RemoveMultiSelect(sendPack, "kexuanwanfa", 3);  // 禁止吃牌
        } else {
        	this.RemoveMultiSelect(sendPack, "kexuanwanfa", 2);  // 七对
        	this.ClearRadioSelect(sendPack, "fengding");		// 封顶
        }*/
    ...
    /**
    	this.ClearRadioSelect(sendPack, "kexuanwanfa");
     * 单选
     * @param {*} sendPack 
     * @param {*} name 
     */
    ClearRadioSelect: function ClearRadioSelect(sendPack, name) {
        sendPack[name] = -1;
        return sendPack;
    },

    /**
    	this.ClearMultiSelect(sendPack, "kexuanwanfa");
     * 多选
     * @param {*} sendPack 
     * @param {*} name 
     */
    ClearMultiSelect: function ClearMultiSelect(sendPack, name) {
        sendPack[name] = [];
        return sendPack;
    },
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key || 'moshi' == key) {
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        // 	勾选“硬自摸”，才能勾选“4局,8局,16局”；
        // 	勾选“抬头胡”，才能勾选“1圈,2圈,4圈”；
        if (this.Toggles["jushu"] && this.Toggles["moshi"]) {
            if (this.Toggles["moshi"][0] && this.Toggles["moshi"][0].getChildByName("checkmark").active) {
                // 勾选 “硬自摸”
                // 	勾选“硬自摸”，才能勾选“4局,8局,16局”；
                this.Toggles["jushu"][0].active = true;
                this.Toggles["jushu"][1].active = true;
                this.Toggles["jushu"][2].active = true;

                if (!this.Toggles["jushu"][0].getChildByName("checkmark").active && !this.Toggles["jushu"][1].getChildByName("checkmark").active && !this.Toggles["jushu"][2].getChildByName("checkmark").active) {
                ...
                // 勾选“抬头胡”，才能勾选“1圈,2圈,4圈”；
                this.Toggles["jushu"][3].active = false;
                this.Toggles["jushu"][4].active = false;
                this.Toggles["jushu"][5].active = false;

                // 	勾选“硬自摸”，才能勾选封顶选项；
                if (this.Toggles["fengding"] && this.Toggles["fengding"][0]) {
                    this.Toggles["fengding"][0].parent.active = true;
                }

                if (this.Toggles["kexuanwanfa"]) {
                    // 	勾选“硬自摸”，才能勾选“七对”；
                    if (this.Toggles["kexuanwanfa"][2]) {
                        this.Toggles["kexuanwanfa"][2].active = true;
                    }

                    // 	勾选“抬头胡”，才能勾选“禁止吃牌”；
                    if (this.Toggles["kexuanwanfa"][3]) {
                        this.Toggles["kexuanwanfa"][3].active = false;
                    }
                }
            }
            if (this.Toggles["moshi"][1] && this.Toggles["moshi"][1].getChildByName("checkmark").active) {
                // 勾选 "抬头胡"
                // 	勾选“硬自摸”，才能勾选“4局,8局,16局”；
                this.Toggles["jushu"][0].active = false;
                this.Toggles["jushu"][1].active = false;
                this.Toggles["jushu"][2].active = false;
                ...
                if (!this.Toggles["jushu"][3].getChildByName("checkmark").active && !this.Toggles["jushu"][4].getChildByName("checkmark").active && !this.Toggles["jushu"][5].getChildByName("checkmark").active) {

                    this.Toggles["jushu"][3].getChildByName("checkmark").active = true;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=qzkhmjChildCreateRoom.js.map
