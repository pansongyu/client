(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/dzzj/dzzj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '204dfmUgplNdaROL3QJ59+v', 'dzzj_winlost_child', __filename);
// script/ui/uiGame/dzzj/dzzj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        this.myRanksType = -1;
        var myPid = app.HeroManager().GetHeroID();
        for (var i = 0; i < posCount; i++) {
            var posInfo = posResultList[i];
            var pos = posInfo["pos"];
            var pid = posInfo["pid"];
            var ranksType = posInfo["ranksType"];
        ...
        var prizeCard = [];
        var prizeInfos = posEndList.prizeInfos; //[cardList:{},isBeiMie:true]
        if (prizeInfos.length > 0) {
            for (var _i = 0; _i < prizeInfos.length; _i++) {
                var prizeInfo = prizeInfos[_i];
                var cardList = prizeInfo["cardList"];
                var isBeiMie = prizeInfo["isBeiMie"];
                var carNum = cardList.length;
                var array = [].concat(carNum, isBeiMie, cardList);
        ...
        for (var j = 0; j < zhaDanLayOut.children.length; j++) {
            ...
            if (prizeCardList[j]) {
                ...
                var zhashu = prizeCardList[j][0];
                // paiNode.getChildByName('lb_num').getComponent(cc.Label).string = 'x' + zhashu;
                var pailist = prizeCardList[j].slice(1, prizeCardList[j].length);
                var num = zhashu;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=dzzj_winlost_child.js.map
