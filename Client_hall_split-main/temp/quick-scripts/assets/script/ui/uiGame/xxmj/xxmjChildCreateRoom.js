(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xxmj/xxmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '6844dUm1klJV7huSiHPTN3H', 'xxmjChildCreateRoom', __filename);
// script/ui/uiGame/xxmj/xxmjChildCreateRoom.js
...
var xxmjChildCreateRoom = cc.Class({
	...
	RefreshAllToggles: function RefreshAllToggles(gameType) {
		...
		this.UpdateToolesByKeXuanWanFa();
	},
	...
	UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
		...
		if (this.Toggles["kexuanwanfa"]) {
			if (this.Toggles["xiapao"][0].getChildByName("checkmark").active) {
				...
				// this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active = !this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active;
			}
			// u 胡牌勾选“点炮胡”后，才可勾选“自摸加倍”、“自摸跑加倍”和“暗杠加倍”；
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key || 'wanfa' == key || 'xiapao' == key || 'hupai' == key) {
	...
	UpdateToolesByKeXuanWanFa: function UpdateToolesByKeXuanWanFa() {
		//u 勾选“可胡七对”后才可勾选“七对加倍”；
		...
		// u 同时勾选“可胡七对”和“带混”后才可勾选“混顶七小对”；
		if (this.Toggles["kexuanwanfa"][5].getChildByName("checkmark").active && this.Toggles["kexuanwanfa"][8].getChildByName("checkmark").active) {
...
module.exports = xxmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xxmjChildCreateRoom.js.map
