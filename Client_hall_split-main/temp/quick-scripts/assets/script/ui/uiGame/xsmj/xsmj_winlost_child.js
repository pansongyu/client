(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xsmj/xsmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '79201cVJNZF5qAnxHyCLg7z', 'xsmj_winlost_child', __filename);
// script/ui/uiGame/xsmj/xsmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		var isTing = posResultList[index]["isTing"] || false;
		this.node.getChildByName("user_info").getChildByName("ting").active = isTing;

		var isTuoDi = posResultList[index]["isTuoDi"] || false;
		this.node.getChildByName("user_info").getChildByName("img_tuodi").active = isTuoDi;

		var lianZhuangShu = posResultList[index]["lianZhuangShu"] || 0;
		var zhuangStr = "";
		if (lianZhuangShu > 0) {
			zhuangStr = "连庄次数 x " + lianZhuangShu;
		}
		this.node.getChildByName("user_info").getChildByName('lb_zhuang').getComponent("cc.Label").string = zhuangStr;
   ...
   */
	...
	LabelName: function LabelName(huType) {
		...
		huTypeDict["ShuangHaoHuaQiDui"] = "双豪华";
		huTypeDict["SanHaoHuaQiDui"] = "三豪华";
		...
		huTypeDict["ShiFeng"] = "十风";
		huTypeDict["BaoTou"] = "爆头";
		huTypeDict["GSKH"] = "杠上开花";
		huTypeDict["CaiPiao"] = "财飘";
		huTypeDict["GangBao"] = "杠爆";
		huTypeDict["GangPiao"] = "杠飘";
		huTypeDict["QingYiSe"] = "清一色";
		huTypeDict["QingHaoHua"] = "清豪华";
		huTypeDict["QingShuangHao"] = "清双豪";
		huTypeDict["QingSanHao"] = "清三豪";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xsmj_winlost_child.js.map
