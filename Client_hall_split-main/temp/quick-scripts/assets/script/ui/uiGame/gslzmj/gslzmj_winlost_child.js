(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gslzmj/gslzmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd5ceeBv2iRJWre7SiOE92RZ', 'gslzmj_winlost_child', __filename);
// script/ui/uiGame/gslzmj/gslzmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerJiePao: function ShowPlayerJiePao(showNode, demo, jiePaoPosList, jiePaoCardList) {
		showNode.removeAllChildren();
		for (var i = 0; i < jiePaoCardList.length; i++) {
			var addNode = cc.instantiate(demo);
			addNode.x = 0;
			addNode.y = 0;
	...
	ShowJiePao: function ShowJiePao(lb, jiepao) {
		var lbString = "";
		if (jiepao == "zhuangXia") {
			lbString = "庄下";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gslzmj_winlost_child.js.map
