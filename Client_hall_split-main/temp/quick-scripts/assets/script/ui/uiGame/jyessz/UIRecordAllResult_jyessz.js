(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jyessz/UIRecordAllResult_jyessz.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd7daahDZi5Fbo0cPQPICVjm', 'UIRecordAllResult_jyessz', __filename);
// script/ui/uiGame/jyessz/UIRecordAllResult_jyessz.js
...
cc.Class({
	...
	InitShowPlayerInfo: function InitShowPlayerInfo(setEnd) {
		...
		var restCardList = setEnd["restCard"] || [];
		this.ShowRestCard(restCardList);
	},
	ShowRestCard: function ShowRestCard(restCardList) {
		if (restCardList.length == 0) {
			this.sp_restCard.active = false;
			return;
		}
		this.sp_restCard.active = true;
		var cardNode = this.sp_restCard.getChildByName("cardNode");
		var cardListNode = this.sp_restCard.getChildByName("cardList");
		cardListNode.removeAllChildren();
		for (var i = 0; i < restCardList.length; i++) {
			var childNode = cc.instantiate(cardNode);
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIRecordAllResult_jyessz.js.map
