(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jyessz/jyesszChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '61cd1B6NMFDPZvUx/E5A8FV', 'jyesszChildCreateRoom', __filename);
// script/ui/uiGame/jyessz/jyesszChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var junzhuang = this.GetIdxByKey('junzhuang');
        var qihu = this.GetIdxByKey('qihu');
        var quansu = this.GetIdxByKey('quansu');
        var chupai = this.GetIdxByKey('chupai');
        var kexuanwanfa = this.GetIdxsByKey('kexuanwanfa');
        var fenghu = this.GetIdxByKey('fenghu');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jyesszChildCreateRoom.js.map
