(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sdfjmj/sdfjmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd10444KxcdPg4ieOtgfYjff', 'sdfjmjChildCreateRoom', __filename);
// script/ui/uiGame/sdfjmj/sdfjmjChildCreateRoom.js
...
var sdfjmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var jiesuan = [];
        for (var _i = 0; _i < this.Toggles['jiesuan'].length; _i++) {
            if (this.Toggles['jiesuan'][_i].getChildByName('checkmark').active) {
                jiesuan.push(_i);
            }
        }
        var kexuanwanfa = [];
...
module.exports = sdfjmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sdfjmjChildCreateRoom.js.map
