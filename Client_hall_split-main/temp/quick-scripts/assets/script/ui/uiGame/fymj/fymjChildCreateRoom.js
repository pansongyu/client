(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/fymj/fymjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '315e0x91I1MDJKdGELIL/qu', 'fymjChildCreateRoom', __filename);
// script/ui/uiGame/fymj/fymjChildCreateRoom.js
...
var thgjmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        // 多选
        var quemenkexuan = this.GetIdxsByKey("quemenkexuan");
        var shimomokexuan = this.GetIdxsByKey("shimomokexuan");
        var fangjian = this.GetIdxsByKey("fangjian");
        var gaoji = this.GetIdxsByKey("gaoji");

        sendPack = {
            "wanfa": wanfa,
            "quemenkexuan": quemenkexuan,
            "shimomokexuan": shimomokexuan,
            "fangjian": fangjian,
            "gaoji": gaoji,
            "jiesan": jiesan,
            "xianShi": xianShi,
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex) {
                this.Toggles['quemenkexuan'][0].parent.active = false;
                this.Toggles['shimomokexuan'][0].parent.active = true;
            } else {
                this.Toggles['quemenkexuan'][0].parent.active = true;
                this.Toggles['shimomokexuan'][0].parent.active = false;
            }
    ...
    RefreshAllToggles: function RefreshAllToggles(gameType) {
        ...
        this.Toggles['quemenkexuan'][0].parent.active = isQuqMen;
        this.Toggles['shimomokexuan'][0].parent.active = !isQuqMen;
    },
...
cc._RF.pop();
        ...
        //# sourceMappingURL=fymjChildCreateRoom.js.map
