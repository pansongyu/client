(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zgmj/zgmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '426e2AcUWhNa7iLWQbs74y7', 'zgmjChildCreateRoom', __filename);
// script/ui/uiGame/zgmj/zgmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var luobo = this.GetIdxByKey('luobo');
		var gaoji = [];
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if (toggleIndex == 4) {
				var mark = this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active;
				if (!mark) {
					app.SysNotifyManager().ShowSysMsg("勾选报叫，才能勾选博自摸", [], 3);
					return;
				}
			}
			if (toggleIndex == 1) {
				var _mark = this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active;
				if (_mark) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zgmjChildCreateRoom.js.map
