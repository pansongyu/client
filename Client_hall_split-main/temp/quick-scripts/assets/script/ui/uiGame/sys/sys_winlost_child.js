(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sys/sys_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '676eebTV85ILpz1PH5xUAxe', 'sys_winlost_child', __filename);
// script/ui/uiGame/sys/sys_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        var partnerPosList = [];
        // let enemyPosList = [];
        for (var i = 0; i < this.posResultList.length; i++) {
            var posResultInfo = this.posResultList[i];
            var pid = posResultInfo["pid"];
            if (myPid == pid) {
                clientPos = posResultInfo["pos"];
                var partnerPos = posResultInfo["partnerPos"];
        ...
        for (var _i = 0; _i < this.posResultList.length; _i++) {
            var _posResultInfo = this.posResultList[_i];
            var pos = _posResultInfo.pos;
            if (partnerPosList.indexOf(pos) > -1) {
                _posResultInfo["isShowPartner"] = true;
            } else {
                _posResultInfo["isShowPartner"] = false;
            }
        }
        ...
        for (var _i2 = 0; _i2 < posCount; _i2++) {
            var posInfo = posResultList[_i2];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sys_winlost_child.js.map
