(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xjxzmj/xjxzmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e8e801H5QlKIqYvB/fIu7IF', 'xjxzmj_winlost_child', __filename);
// script/ui/uiGame/xjxzmj/xjxzmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		this.ShowPlayerHuImg(huNode.getComponent(cc.Sprite), posResultList[index]['huType'], posResultList[index].isJiePao);
	...
	ShowPlayerHuImg: function ShowPlayerHuImg(huNodeSprite, huType) {
		/*huLbIcon
  ...
  */
		...
		} else if (huType == "NotHu") {
			huNodeSprite.spriteFrame = "";
		}
		var huIndex = huTypeMap[huType];
		if (huIndex >= 0) {
			huNodeSprite.spriteFrame = this.huLbIcon[huIndex];
		}
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xjxzmj_winlost_child.js.map
