(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/nxkwmj/nxkwmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f75d1N4WGlMM5MPyPzU/xow', 'nxkwmjChildCreateRoom', __filename);
// script/ui/uiGame/nxkwmj/nxkwmjChildCreateRoom.js
...
var gamjChildCreateRoom = cc.Class({
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["zhuaniao"]) {
            if (this.Toggles["zhuaniao"][2] && this.Toggles["zhuaniao"][2].getChildByName("checkmark").active) {
                // 勾选不抓
                if (this.Toggles["niaoshu"] && this.Toggles["niaoshu"][0]) {
                    // 鸟/s/s/s/s/s/s数
                    this.Toggles["niaoshu"][0].parent.active = false;
                }
                if (this.Toggles["niaofen"] && this.Toggles["niaofen"][0]) {
                    // 鸟/s/s/s/s/s/s分
...
cc._RF.pop();
        ...
        //# sourceMappingURL=nxkwmjChildCreateRoom.js.map
