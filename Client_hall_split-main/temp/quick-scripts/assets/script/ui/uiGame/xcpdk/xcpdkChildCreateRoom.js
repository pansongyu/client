(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xcpdk/xcpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '70d1c3kH8hKWIVEk+xR7Q1Y', 'xcpdkChildCreateRoom', __filename);
// script/ui/uiGame/xcpdk/xcpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            //默认选中
            if (toggleIndex == 0 || toggleIndex == 3 || toggleIndex == 4 || toggleIndex == 7 || toggleIndex == 8) {
                app[app.subGameName + "_SysNotifyManager"]().ShowSysMsg("该玩法默认选中");
                return;
            }
            //3A不为炸不能选择3A为最大炸
            if (!this.Toggles['kexuanwanfa'][8].getChildByName('checkmark').active && toggleIndex == 8) {
                // app.SysNotifyManager().ShowSysMsg("未勾选3A为炸时，不可选择3A为最大炸");
                app.SysNotifyManager().ShowSysMsg("请先勾选3A为炸");
                return;
            }
            if (toggleIndex == 8 && this.Toggles['kexuanwanfa'][toggleIndex].getChildByName('checkmark').active) {
                this.Toggles['kexuanwanfa'][8].getChildByName('checkmark').active = false;
            }
            // if(toggleIndex == 4 || toggleIndex == 8){
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        if (this.Toggles["kexuanwanfa"]) {
            if (!this.unionData) {
                ...
                this.Toggles["kexuanwanfa"][110].getChildByName("checkmark").active = false; //隐藏高级30秒被踢，ps：注释防止缓存
            ...
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ("kexuanwanfa" == curKey) {
                        this.Toggles['kexuanwanfa'][1].serverIdx = 2;
                        this.Toggles['kexuanwanfa'][2].serverIdx = 11;
                        this.Toggles['kexuanwanfa'][3].serverIdx = 22;
                        this.Toggles['kexuanwanfa'][4].serverIdx = 23;
                        ...
                        this.Toggles['kexuanwanfa'][8].serverIdx = 4; //3A炸
                        this.Toggles['kexuanwanfa'][9].serverIdx = 30; //防作弊
                        this.Toggles['kexuanwanfa'][10].serverIdx = 31; //比赛分不能低于0
                        this.Toggles['kexuanwanfa'][11].serverIdx = 32; //只能赢当前身上分
                    }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xcpdkChildCreateRoom.js.map
