(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/lsmj/lsmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a831aN7Eu1FD53GZxrC/nYB', 'lsmjChildCreateRoom', __filename);
// script/ui/uiGame/lsmj/lsmjChildCreateRoom.js
...
var gamjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var yuanziguize = this.GetIdxByKey('yuanziguize');
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 6) {
                // 点击七小对
                var is7 = this.Toggles['kexuanwanfa'][7].getChildByName('checkmark').active;
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        // 	if (this.Toggles["kexuanwanfa"][7] && !this.Toggles["kexuanwanfa"][7].getChildByName("checkmark").active) { // 勾选七对翻倍
        // 		if (this.Toggles["kexuanwanfa"][6]) {
        // 			this.Toggles["kexuanwanfa"][6].getChildByName("checkmark").active = true;		// 七小对
...
cc._RF.pop();
        ...
        //# sourceMappingURL=lsmjChildCreateRoom.js.map
