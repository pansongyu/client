(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jayxmj/jayxmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '89500wr8QpCWpqQ/es3kqnb', 'jayxmj_winlost_child', __filename);
// script/ui/uiGame/jayxmj/jayxmj_winlost_child.js
...
cc.Class({
    ...
    ShowOtherScore: function ShowOtherScore(ShowNode, huInfo) {
        var mingGang = huInfo["mingGang"] || 0;
        ShowNode.getChildByName('mingGangLb').getComponent("cc.Label").string = "明杠  " + mingGang;

        var anGang = huInfo["anGang"] || 0;
        ShowNode.getChildByName('anGangLb').getComponent("cc.Label").string = "暗杠  " + anGang;

        var gang = huInfo["gang"] || 0;
        ShowNode.getChildByName('gangLb').getComponent("cc.Label").string = "放杠  " + gang;

        var zhengJing = huInfo["zhengJing"] || 0;
        ShowNode.getChildByName('zhengJingLb').getComponent("cc.Label").string = "正精  " + zhengJing;

        var fuJing = huInfo["fuJing"] || 0;
        ShowNode.getChildByName('fuJingLb').getComponent("cc.Label").string = "副精  " + fuJing;
    },
    ...
    LabelName: function LabelName(huType) {
        ...
        huTypeDict["Gang"] = "补杠";
        huTypeDict["ChongYiBaoSan"] = "冲一包三";
        huTypeDict["BaJing"] = "霸精";

        return huTypeDict[huType];
    },
    IsNotShowScore: function IsNotShowScore(huType) {
        var multi2 = ["ChongYiBaoSan", "BaJing"];
        var isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    IsShowMulti2: function IsShowMulti2(huType) {
        var multi2 = ["QSSL", "SSL", "GSKH", "JingDiao", "DG", "PPHu", "QD", "ZiMo", "ZhuangJia"];
        var isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jayxmj_winlost_child.js.map
