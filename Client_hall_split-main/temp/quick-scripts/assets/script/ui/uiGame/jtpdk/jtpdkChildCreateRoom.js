(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jtpdk/jtpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '29b3bh+aXtMhZyw/CjdvaoD', 'jtpdkChildCreateRoom', __filename);
// script/ui/uiGame/jtpdk/jtpdkChildCreateRoom.js
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        if (this.Toggles["sidai"]) {
            if (this.Toggles["kexuanwanfa"][4].getChildByName("checkmark").active) {
                ...
                if (this.Toggles["kexuanwanfa"][16].getChildByName("checkmark").active) {
                    this.Toggles['sidai'][0].getChildByName("checkmark").active = true;
                }
            } else {
        ...
        if (this.Toggles["kexuanwanfa"]) {
            if (!this.unionData) {
                ...
                this.Toggles["kexuanwanfa"][14].getChildByName("checkmark").active = false; //隐藏高级30秒被踢，ps：注释防止缓存
                this.Toggles["kexuanwanfa"][15].active = false;
                this.Toggles["kexuanwanfa"][15].getChildByName("checkmark").active = false; //隐藏高级30秒被踢，ps：注释防止缓存
            } else {
            ...
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ("kexuanwanfa" == curKey) {
                        ...
                        this.Toggles['kexuanwanfa'][14].serverIdx = 31; //比赛分不能低于0
                        this.Toggles['kexuanwanfa'][15].serverIdx = 32; //只能赢当前身上分
                        this.Toggles['kexuanwanfa'][16].serverIdx = 33; //四带一为炸
                    }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jtpdkChildCreateRoom.js.map
