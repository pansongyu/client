(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xyxxpdk/xyxxpdk_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '280dclzs4hBprWmrll1JTmG', 'xyxxpdk_winlost_child', __filename);
// script/ui/uiGame/xyxxpdk/xyxxpdk_winlost_child.js
...
cc.Class({
    ...
    properties: {
        ...
        icon_finishOrder: [cc.SpriteFrame]
    },
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        //显示游数
        var icon_you = this.node.getChildByName("icon_you");
        icon_you.active = false;
        if (player.finishOrder > 0) {
            icon_you.getComponent(cc.Sprite).spriteFrame = this.icon_finishOrder[player.finishOrder - 1];
            icon_you.active = true;
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xyxxpdk_winlost_child.js.map
