(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xyxxpdk/xyxxpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '6bdd8kUrzZGk6Ku/eWmKU2T', 'xyxxpdkChildCreateRoom', __filename);
// script/ui/uiGame/xyxxpdk/xyxxpdkChildCreateRoom.js
...
var pypdkChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var renShu = this.GetIdxByKey('renshu');
        ...
        for (var _i4 = 0; _i4 < this.Toggles['sidai'].length; _i4++) {
            //炸弹可拆
            if (this.Toggles['sidai'][_i4].getChildByName('checkmark').active && this.Toggles['kexuanwanfa'][4].getChildByName('checkmark').active) {
                sidai.push(_i4);
            }
        }
        if (zhadansuanfa == 2) {
            ...
            if (toggleIndex == 5 || toggleIndex == 11) {
                if (this.Toggles['shoupai'][0].getChildByName('checkmark').active) {
                    if (this.Toggles['renshu'][2].getChildByName('checkmark').active) {
                        app[app.subGameName + "_SysNotifyManager"]().ShowSysMsg("4人玩法下没有3张A");
                        return;
                    }
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        ...
        if (this.Toggles['shoupai']) {
            if (this.Toggles['renshu'][2].getChildByName("checkmark").active) {
                this.Toggles['shoupai'][0].parent.active = false;
            } else {
                this.Toggles['shoupai'][0].parent.active = true;
            }
        }
    },
            ...
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ("kexuanwanfa" == curKey) {
                        ...
                        this.Toggles['kexuanwanfa'][13].serverIdx = 31; //春天
                        this.Toggles['kexuanwanfa'][14].serverIdx = 32; //反春天
                    }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xyxxpdkChildCreateRoom.js.map
