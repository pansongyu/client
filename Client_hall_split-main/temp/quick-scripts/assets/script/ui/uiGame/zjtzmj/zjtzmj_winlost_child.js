(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zjtzmj/zjtzmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ea8a5z1sf5BZpGwYuEHzQew', 'zjtzmj_winlost_child', __filename);
// script/ui/uiGame/zjtzmj/zjtzmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        var fengCardID = this.GetFengCard(index, dPos, posCount);
    ...
    GetFengCard: function GetFengCard(pos, dPos, posCount) {
        var fengCardID = -1;
        if (posCount == 2) {
            if (dPos == pos) {
                //东 春
    ...
    ShowOtherScore: function ShowOtherScore(ShowNode, huInfo) {
        var laZiFlag = huInfo["laZiFlag"] || false;
        var beiBaoPeiFlag = huInfo["beiBaoPeiFlag"] || false;
        var yuanShiHuShu = huInfo["yuanShiHuShu"] || 0;
        var taiShu = huInfo["taiShu"] || 0;
    ...
    IsNotShowScore: function IsNotShowScore(huType) {
        var multi2 = ["PingHu", "HYS", "QYS", "WuDe", "DeHuanYua"];
        var isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    IsShowMulti2: function IsShowMulti2(huType) {
        var multi2 = ["PPH", "ZiMo", "DanDiao", "QianDang", "KaoBian", "HuPai", "PaiMian"];
        var isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    ...
    ShowPlayerShowCard: function ShowPlayerShowCard(ShowNode, cardIDList, handCard, jin1, jin2, fengCardID) {
        ShowNode.active = 1;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zjtzmj_winlost_child.js.map
