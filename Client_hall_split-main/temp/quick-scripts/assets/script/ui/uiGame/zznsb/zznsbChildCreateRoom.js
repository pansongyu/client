(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zznsb/zznsbChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f9ad2OJ5aRP349Tw3Msfhyx', 'zznsbChildCreateRoom', __filename);
// script/ui/uiGame/zznsb/zznsbChildCreateRoom.js
...
var rcwskChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var qianfenjushuying = this.GetIdxByKey('qianfenjushuying');
        ...
        sendPack = {
            "wanfa": wanfa,
            "difen": difen,
            "qianfenjushuying": qianfenjushuying,
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        this.OnUpdateTogglesLabel(TogglesNode, isResetPos = true);
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i = 0; _i < curCostData.length; _i++) {
                                var setCount = curCostData[_i].SetCount == 501 ? "千分" : curCostData[_i].SetCount;
                                this.Toggles['jushu'][_i].getChildByName('label').getComponent(cc.Label).string = setCount + '局';
                            }
                        }
    ...
    OnUpdateTogglesLabel: function OnUpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["qianfenjushuying"]) {
            if (this.Toggles["jushu"][3] && this.Toggles["jushu"][3].getChildByName("checkmark").active) {
                // 勾选千分局
                this.Toggles["qianfenjushuying"][0].parent.active = true;
                this.Toggles["wanfa"][0].active = false;

                if (this.Toggles["wanfa"][0].getChildByName("checkmark").active) {
                    // 摸队为勾选状态
                    this.Toggles["wanfa"][0].getChildByName("checkmark").active = false; // 摸队
                ...
                this.Toggles["qianfenjushuying"][0].parent.active = false;
                this.Toggles["wanfa"][0].active = true;

                if (this.Toggles["wanfa"][0].getChildByName("checkmark").active) {
                    // 摸队为勾选状态
                    this.Toggles["wanfa"][0].getChildByName("checkmark").active = true;
                    this.Toggles["wanfa"][1].getChildByName("checkmark").active = false;
                    this.UpdateLabelColor(this.Toggles["wanfa"][0].parent);
                    this.UpdateLabelColor(this.Toggles["wanfa"][1].parent);
                }
            }
    ...
    AdjustSendPack: function AdjustSendPack(sendPack) {
        ...
        if (sendPack.setCount != 501) {
            sendPack.qianfenjushuying = -1;
            // sendPack.wanfa = -1;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zznsbChildCreateRoom.js.map
