(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/py/UIRecordAllResult_py.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd8e37XgXv9F14ALQ1jLyYwc', 'UIRecordAllResult_py', __filename);
// script/ui/uiGame/py/UIRecordAllResult_py.js
...
cc.Class({
    ...
    InitShowPlayerInfo: function InitShowPlayerInfo(setEnd) {
        ...
        for (var _i5 = 0; _i5 < posResultList.length; _i5++) {
            if (!posResultList[_i5].pid || pidList.indexOf(posResultList[_i5].pid) > -1) continue;
            pidList.push(posResultList[_i5].pid);
    ...
    OnClick: function OnClick(btnName, btnNode) {
        if (btnName == "btn_close") {
            ...
            this.NetManager.SendPack("game.CPYPlayerPlayBack", {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIRecordAllResult_py.js.map
