(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/aydss/aydssChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '580b8fxqG9A7LMePy4dFNMc', 'aydssChildCreateRoom', __filename);
// script/ui/uiGame/aydss/aydssChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if ("aydss" == this.gameType && "renshu" == key) {
				if (toggleIndex == 2) {
					// this.Toggles["kexuanwanfa"][4].x = 400;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=aydssChildCreateRoom.js.map
