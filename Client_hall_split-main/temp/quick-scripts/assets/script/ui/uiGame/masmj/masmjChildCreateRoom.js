(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/masmj/masmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c328d3gb0hKPqjsdO1uEDXt', 'masmjChildCreateRoom', __filename);
// script/ui/uiGame/masmj/masmjChildCreateRoom.js
...
var thgjmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var meidao = this.GetIdxByKey('meidao');
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i = 0; _i < curCostData.length; _i++) {
                                if (curCostData[_i].SetCount > 600) {
                                    this.Toggles['jushu'][_i].getChildByName('label').getComponent(cc.Label).string = curCostData[_i].SetCount % 100 + '倒';
                                } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=masmjChildCreateRoom.js.map
