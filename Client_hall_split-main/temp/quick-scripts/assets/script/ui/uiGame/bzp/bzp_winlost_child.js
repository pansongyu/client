(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/bzp/bzp_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '51b308hsRdP2o87tXMcXIZb', 'bzp_winlost_child', __filename);
// script/ui/uiGame/bzp/bzp_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        //硬包、素包、反包标识
        this.node.getChildByName("user_info").getChildByName('img_yb').active = posEndList.yingBaoFlag;
        this.node.getChildByName("user_info").getChildByName('img_sb').active = posEndList.suBaoFlag;
        this.node.getChildByName("user_info").getChildByName('img_fb').active = posEndList.fanBaoFlag;
        //十三幺、滚筒标识
        this.node.getChildByName("user_info").getChildByName('img_ssy').active = posEndList.shiSanYaoFlag;
        this.node.getChildByName("user_info").getChildByName('img_gl').active = posEndList.gunTongFlag;
        ...
        str += '附加分:';
        str += this.onPlusScore(posEndList.fuJiaFen) + '  ';

        if (posEndList.paiDianShowFlag) {
            str += '牌点:';
            str += this.onPlusScore(posEndList.paiDian) + '  ';
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=bzp_winlost_child.js.map
