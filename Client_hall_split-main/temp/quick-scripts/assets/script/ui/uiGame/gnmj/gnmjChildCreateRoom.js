(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gnmj/gnmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a1055tL8UxM4Zby+2ekqp1Y', 'gnmjChildCreateRoom', __filename);
// script/ui/uiGame/gnmj/gnmjChildCreateRoom.js
...
var bzqzmjChildCreateRoom = cc.Class({
	...
	UpdateOnClickToggle: function UpdateOnClickToggle() {
		if (this.Toggles["zhuangjia"]) {
			if (this.Toggles["wanfa"][0].getChildByName("checkmark").active) {
				this.Toggles['zhuangjia'][0].parent.active = false;
			} else {
				this.Toggles['zhuangjia'][0].parent.active = true;
			}
		}
	}
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gnmjChildCreateRoom.js.map
