(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hylymj/hylymj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'db252v3GTpMNK2MKdAFD9Pv', 'hylymj_winlost_child', __filename);
// script/ui/uiGame/hylymj/hylymj_winlost_child.js
...
cc.Class({
    ...
    ShowOtherScore: function ShowOtherScore(ShowNode, huInfo) {
        ...
        var otherPoint = huInfo["otherPoint"];
        if (otherPoint >= 0) {
    ...
    LabelName: function LabelName(huType) {
        ...
        huTypeDict["ShaGuiFanFan"] = "杀鬼翻番";
        huTypeDict["ShaGuiSiGuiFanFan"] = "杀鬼死鬼翻番";
        huTypeDict["ShaGuiJiaFen"] = "杀鬼加分";
        huTypeDict["ShaGuiSiGuiJiaFen"] = "杀鬼死鬼加分";
        huTypeDict["DiYuShiJiaFen"] = "低于10分加10分";
        huTypeDict["DiYuXJiaBei"] = "低于";
        huTypeDict["AnGang"] = "暗杠个数";
        huTypeDict["JieGang"] = "接杠个数";
        huTypeDict["Gang"] = "碰杠个数";

        return huTypeDict[huType];
    },
    IsNotShowScore: function IsNotShowScore(huType) {
        var multi2 = ["DiYuXJiaBei"];
        var isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    IsShowMulti2: function IsShowMulti2(huType) {
        var multi2 = ["AnGang", "JieGang", "Gang"];
        var isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    ShowPlayerJieSuan: function ShowPlayerJieSuan(ShowNode, huInfoAll) {
        ...
        for (var huType in huInfo) {
            ...
            if (this.IsShowMulti2(huType)) {
                ...
                this.ShowLabelName(ShowNode.getChildByName("label_lists"), this.LabelName(huType) + huPoint + "分加倍");
            } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hylymj_winlost_child.js.map
