(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/njlhmj/njlhmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '017cf8Q3QhGj6Lp2vURaHw8', 'njlhmjChildCreateRoom', __filename);
// script/ui/uiGame/njlhmj/njlhmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
				...
				CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
								...
								var liufen = this.GetIdxByKey('liufen');
								var wanfa = this.GetIdxByKey('wanfa');
								var danjufengding = this.GetIdxByKey('danjufengding');
				...
				UpdateOnClickToggle: function UpdateOnClickToggle() {
								if (this.Toggles["zhangzhuang"]) {
												if (this.Toggles["kexuanwanfa"][0].getChildByName('checkmark').active) {
																this.Toggles["zhangzhuang"][0].parent.active = true;
												} else {
																this.Toggles["zhangzhuang"][0].parent.active = false;
												}
								}
				}
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=njlhmjChildCreateRoom.js.map
