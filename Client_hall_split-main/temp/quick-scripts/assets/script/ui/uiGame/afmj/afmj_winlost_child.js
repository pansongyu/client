(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/afmj/afmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '76c836igAdMWoP+twdXK5p0', 'afmj_winlost_child', __filename);
// script/ui/uiGame/afmj/afmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerJieSuan: function ShowPlayerJieSuan(ShowNode, huInfoAll) {
        ...
        //     }
        // }
        var lastPos = ["HuPaiPoint", "ShangJingPoint", "XiaJingPoint", "BoJingPoint", "GangPoint"];
        ...
        for (var i = 0; i < lastPos.length; i++) {
            var _huType = lastPos[i];
            var _huPoint = huInfo[_huType];
            this.ShowLabelName(ShowNode.getChildByName('label_lists'), this.LabelName(_huType) + ":" + _huPoint);
        }
    },
    ...
    ShowLabelName: function ShowLabelName(jiesuan, labelText) {
        ...
        var item = this.node.getChildByName("label_item");
...
cc._RF.pop();
        ...
        //# sourceMappingURL=afmj_winlost_child.js.map
