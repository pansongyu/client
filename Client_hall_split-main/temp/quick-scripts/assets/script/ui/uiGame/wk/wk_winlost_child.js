(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/wk/wk_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e4bd0FSFDlK5J17VOP8J/oD', 'wk_winlost_child', __filename);
// script/ui/uiGame/wk/wk_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        var state = player.state; //胜负  -1为默认值
        var stateType = -1;
        if (state == "WIN") {
            stateType = 0;
        } else if (state == "LOSE") {
        ...
        if (stateType > -1) {
            this.node.getChildByName('winIcon').getComponent(cc.Sprite).spriteFrame = this.icon_winlost[stateType];
        } else {
            this.node.getChildByName('winIcon').getComponent(cc.Sprite).spriteFrame = "";
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=wk_winlost_child.js.map
