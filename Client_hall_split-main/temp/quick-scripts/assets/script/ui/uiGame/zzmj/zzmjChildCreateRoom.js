(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zzmj/zzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd2e93eVDHFLKb0KOD4Ox/pq', 'zzmjChildCreateRoom', __filename);
// script/ui/uiGame/zzmj/zzmjChildCreateRoom.js
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i = 0; _i < curCostData.length; _i++) {
                                if (curCostData[_i].SetCount == 311) {
                                    this.Toggles['jushu'][_i].getChildByName('label').getComponent(cc.Label).string = '1课:100分';
                                } else if (curCostData[_i].SetCount > 100 && curCostData[_i].SetCount < 200) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zzmjChildCreateRoom.js.map
