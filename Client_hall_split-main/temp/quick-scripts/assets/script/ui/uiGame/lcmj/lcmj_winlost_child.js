(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/lcmj/lcmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f3c99qtLr9LFan4iZjiVM3Q', 'lcmj_winlost_child', __filename);
// script/ui/uiGame/lcmj/lcmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        //不同位置显示不同的头像框
        var zhuangjiaNode = this.node.getChildByName("user_info").getChildByName("zhuangjia");
        zhuangjiaNode.active = true;
        zhuangjiaNode.getComponent(cc.Sprite).spriteFrame = this.zhuang_img[posResultList[index]["colorType"]];
        var img_txkNode = this.node.getChildByName("user_info").getChildByName("img_txk");
...
cc._RF.pop();
        ...
        //# sourceMappingURL=lcmj_winlost_child.js.map
