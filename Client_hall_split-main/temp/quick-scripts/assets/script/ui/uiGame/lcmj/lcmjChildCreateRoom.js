(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/lcmj/lcmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '261c8lGQthD9Z0nJ718vN7i', 'lcmjChildCreateRoom', __filename);
// script/ui/uiGame/lcmj/lcmjChildCreateRoom.js
...
var bzqzmjChildCreateRoom = cc.Class({
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if (toggleIndex == 1) {
				var mark = this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active;
				if (!mark) {
					app.SysNotifyManager().ShowSysMsg("流局算码必须勾选庄家买码", [], 3);
					return;
				}
			}
			if (toggleIndex == 0) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=lcmjChildCreateRoom.js.map
