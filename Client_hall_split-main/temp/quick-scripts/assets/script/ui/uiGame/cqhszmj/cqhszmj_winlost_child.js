(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/cqhszmj/cqhszmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '317d0Gffv9NVajRVQjtokHI', 'cqhszmj_winlost_child', __filename);
// script/ui/uiGame/cqhszmj/cqhszmj_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerInfo: function ShowPlayerInfo(ShowNode, PlayerInfo, HuList) {
        ...
        var isBaoJiao = HuList["isBaoJiao"];
        var isDisoolve = HuList["isDisoolve"];

        ShowNode.getChildByName('ting').active = isBaoJiao;
    ...
    ShowPlayerJieSuan: function ShowPlayerJieSuan(ShowNode, huInfoAll) {
        ...
        for (var huType in huInfo) {
            ...
            if (huPoint[1] == 1) {
                if (huPoint[0] > 0) {
                    this.ShowLabelName(ShowNode.getChildByName('label_lists'), this.LabelName(huType) + "+" + huPoint[0] + "番");
                } else {
                    this.ShowLabelName(ShowNode.getChildByName('label_lists'), this.LabelName(huType) + huPoint[0] + "番");
                }
            } else if (huPoint[1] == 2) {
                if (huPoint[0] > 0) {
                    this.ShowLabelName(ShowNode.getChildByName('label_lists'), this.LabelName(huType) + "+" + huPoint[0] + "分");
                } else {
                    this.ShowLabelName(ShowNode.getChildByName('label_lists'), this.LabelName(huType) + huPoint[0] + "分");
                }
            } else {
    ...
    LabelName: function LabelName(huType) {
        ...
        huTypeDict["DDH"] = "对对胡";
        huTypeDict["QiDui"] = "七对";
        huTypeDict["LongQiDuiHu"] = "龙七对";
        huTypeDict["ShuangLongQiDuiHu"] = "双龙七对";
        huTypeDict["SanLongQiDuiHu"] = "三龙七对";
        huTypeDict["QYS"] = "清一色";
        huTypeDict["STQYS"] = "三塔清一色";
        huTypeDict["JinGouDiao"] = "金钩钓";
        ...
        huTypeDict["QSHS"] = "前四后四";
        huTypeDict["BaoJ"] = "报叫";
        huTypeDict["Gang"] = "杠分";
        huTypeDict["XiaoHu"] = "小胡";
        huTypeDict["ChaDaJiao"] = "查大叫";
        huTypeDict["MaiPai"] = "买牌";
        huTypeDict["PeiJ"] = "赔叫";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=cqhszmj_winlost_child.js.map
