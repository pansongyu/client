(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/byzp/byzpChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c911332mApEnLD+yxa3oL/S', 'byzpChildCreateRoom', __filename);
// script/ui/uiGame/byzp/byzpChildCreateRoom.js
...
var byzpChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var yizi = this.GetIdxByKey("yizi");
        var zimo = this.GetIdxByKey("zimo");
        var lianmai = this.GetIdxByKey("lianmai");
        var dianpao = this.GetIdxByKey("dianpao");
        var gudingxing = this.GetIdxByKey("gudingxing");

        var zhengyouyoushu = this.GetIdxByKey("zhengyouyoushu");
        var shuxingsuanfen = this.GetIdxByKey("shuxingsuanfen");
        ...
        sendPack = {
            ...
            "yizi": yizi,
            "zimo": zimo,
            "gudingxing": gudingxing,
            "dianpao": dianpao,
            "lianmai": lianmai,
            "zhengyouyoushu": zhengyouyoushu,
            "shuxingsuanfen": shuxingsuanfen
        };
        return sendPack;
    },
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if ("renshu" == key && toggleIndex < 2) {
                this.Toggles["shuxingsuanfen"][0].parent.active = false;
                this.Toggles["gudingxing"][0].parent.active = false;
            } else {
                this.Toggles["shuxingsuanfen"][0].parent.active = true;
                this.Toggles["gudingxing"][0].parent.active = this.Toggles["shuxingsuanfen"][1].getChildByName("checkmark").active;
            }

            return;
        } else if ('shuxingsuanfen' == key) {
            this.Toggles["gudingxing"][0].parent.active = toggleIndex == 1;
        }
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["shuxingsuanfen"] && this.Toggles["gudingxing"]) {
            if (this.Toggles["renshu"][2].getChildByName("checkmark").active == true) {
                this.Toggles["shuxingsuanfen"][0].parent.active = true;
                this.Toggles["gudingxing"][0].parent.active = this.Toggles["shuxingsuanfen"][1].getChildByName("checkmark").active;
            } else {
                this.Toggles["shuxingsuanfen"][0].parent.active = false;
...
module.exports = byzpChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=byzpChildCreateRoom.js.map
