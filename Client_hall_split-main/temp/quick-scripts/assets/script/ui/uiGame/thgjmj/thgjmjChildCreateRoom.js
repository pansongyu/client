(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/thgjmj/thgjmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fd2admfF2BMNKGVS+8X2hG6', 'thgjmjChildCreateRoom', __filename);
// script/ui/uiGame/thgjmj/thgjmjChildCreateRoom.js
...
var thgjmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var piaojing = this.GetIdxByKey('piaojing');
        var piaojingcaozuo = this.GetIdxByKey('piaojingcaozuo');
        var gangjingwanfa = this.GetIdxByKey('gangjingwanfa');
        var chaozhuang = this.GetIdxByKey('chaozhuang');
        ...
        sendPack = {
            "piaojing": piaojing,
            "piaojingcaozuo": piaojingcaozuo,
            "gangjingwanfa": gangjingwanfa,
            "chaozhuang": chaozhuang,
            "fengDing": fengDing,
    ...
    UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
        ...
        if (this.Toggles["chaozhuang"]) {
            if (this.Toggles["renshu"][2].getChildByName("checkmark").active) {
                this.Toggles["chaozhuang"][0].parent.active = true;
            } else {
                this.Toggles["chaozhuang"][0].parent.active = false;
            }
        }
        ...
        if (this.Toggles["kexuanwanfa"]) {
            for (var _i4 = 0; _i4 < this.Toggles["kexuanwanfa"].length; _i4++) {
                ...
                if (_ToggleDesc == "比赛分不能低于0分" || _ToggleDesc == "只能赢当前身上分") {
                    if (!this.clubData && !this.unionData) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=thgjmjChildCreateRoom.js.map
