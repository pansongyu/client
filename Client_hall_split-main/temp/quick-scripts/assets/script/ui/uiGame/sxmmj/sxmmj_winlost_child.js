(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sxmmj/sxmmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1e28cP5SdpJvrQ1fApktCbx', 'sxmmj_winlost_child', __filename);
// script/ui/uiGame/sxmmj/sxmmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		if (piaoFen <= 0) {
			...
			this.node.getChildByName("user_info").getChildByName("pao").getComponent(cc.Sprite).spriteFrame = this.paoIcon[piaoFen - 1];
		}
		//显示头像，如果头像UI
   ...
   */
	...
	LabelName: function LabelName(huType) {
		...
		huTypeDict["Jin"] = "表演";
		huTypeDict["MaiMa"] = "跑分";
		huTypeDict["HunXing"] = "下混";
		huTypeDict["SSY"] = "十三幺";
		huTypeDict["PingHu"] = "平胡";
		huTypeDict["Zhuang"] = "庄加底";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sxmmj_winlost_child.js.map
