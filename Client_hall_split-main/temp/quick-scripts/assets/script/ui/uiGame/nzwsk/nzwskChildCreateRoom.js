(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/nzwsk/nzwskChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b4e20uKShNM9Jtq/Ufdd7w3', 'nzwskChildCreateRoom', __filename);
// script/ui/uiGame/nzwsk/nzwskChildCreateRoom.js
...
var nzwskChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var fendui = this.GetIdxByKey('fendui');
	...
	UpdateOnClickToggle: function UpdateOnClickToggle() {
		// 仅4人场可选，3人场隐藏；
		if (this.Toggles["fendui"]) {
			if (this.Toggles["renshu"][0].getChildByName("checkmark").active) {
				this.Toggles["fendui"][0].parent.active = false;
			} else {
				this.Toggles["fendui"][0].parent.active = true;
			}
		}
	...
	AdjustSendPack: function AdjustSendPack(sendPack) {
		...
		if (sendPack.playerNum != 4) {
			...
			this.RemoveRadioSelect(sendPack, "fendui");
		} //	“必管”，三人场默认勾选；四人场不可选；
		if (sendPack.playerNum == 4) {
			this.RemoveMultiSelect(sendPack, "kexuanwanfa", 1);
			// this.RemoveRadioSelect(sendPack, "yingpaibeihus");
		}
		return sendPack;
	}
...
module.exports = nzwskChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=nzwskChildCreateRoom.js.map
