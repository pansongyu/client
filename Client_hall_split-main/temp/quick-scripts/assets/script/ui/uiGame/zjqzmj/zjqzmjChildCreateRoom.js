(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zjqzmj/zjqzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '946efUObOZJzJSdvFUkLQOc', 'zjqzmjChildCreateRoom', __filename);
// script/ui/uiGame/zjqzmj/zjqzmjChildCreateRoom.js
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i2 = 0; _i2 < curCostData.length; _i2++) {
                                if (curCostData[_i2].SetCount == 312) {
                                    this.Toggles['jushu'][_i2].getChildByName('label').getComponent(cc.Label).string = '局麻';
                                } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zjqzmjChildCreateRoom.js.map
