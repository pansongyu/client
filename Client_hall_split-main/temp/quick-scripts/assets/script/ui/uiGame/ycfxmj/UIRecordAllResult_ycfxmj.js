(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ycfxmj/UIRecordAllResult_ycfxmj.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '09972anmnNHQ6eb4jG+HlYs', 'UIRecordAllResult_ycfxmj', __filename);
// script/ui/uiGame/ycfxmj/UIRecordAllResult_ycfxmj.js
...
cc.Class({
	...
	InitShowPlayerInfo: function InitShowPlayerInfo(setEnd) {
		...
		this.ShowNiaoPai(maList, zhongList);
	},
	ShowNiaoPai: function ShowNiaoPai(cardIDList, zhongList) {
		if (cardIDList.length == 0) {
			this.bg_niaopai.active = false;
			return;
		}
		this.bg_niaopai.active = true;
		var niaopaiNode = this.bg_niaopai.getChildByName("niaopai");
		...
		for (var _i3 = 0; _i3 < cardIDList.length; _i3++) {
			...
			node.active = true;
			node.color = zhongList.indexOf(cardIDList[_i3]) != -1 ? cc.color(255, 255, 125) : cc.color(255, 255, 255);
		}
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIRecordAllResult_ycfxmj.js.map
