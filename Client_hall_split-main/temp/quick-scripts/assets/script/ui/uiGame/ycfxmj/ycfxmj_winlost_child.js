(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ycfxmj/ycfxmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '357a8fo0M5KTIl9frVDfkeG', 'ycfxmj_winlost_child', __filename);
// script/ui/uiGame/ycfxmj/ycfxmj_winlost_child.js
...
cc.Class({
	...
	ShowOtherScore: function ShowOtherScore(ShowNode, huInfo) {
		var huPai = huInfo["huPai"] || 0;
		ShowNode.getChildByName('hupaiLb').getComponent("cc.Label").string = "胡牌 " + this.ToUiScore(huPai);

		var gangFen = huInfo["gangFen"] || 0;
		ShowNode.getChildByName('gangfenLb').getComponent("cc.Label").string = "杠分 " + this.ToUiScore(gangFen);

		var maFen = huInfo["maFen"] || 0;
		ShowNode.getChildByName('maimaLb').getComponent("cc.Label").string = "码分 " + this.ToUiScore(maFen);

		var genZhuangFen = huInfo["genZhuangFen"] || 0;
		ShowNode.getChildByName('genzhuangLb').getComponent("cc.Label").string = "跟庄分 " + this.ToUiScore(genZhuangFen);
	},
  ...
  */
	...
	LabelName: function LabelName(huType) {
		...
		huTypeDict["MaiMaFen"] = "中码分";
		huTypeDict["SSL"] = "十三烂";
		huTypeDict["QingSSL"] = "七星十三烂";
		huTypeDict["QYSDP"] = "清一色大飘";
		huTypeDict["QYSQD"] = "清一色麻七";
		huTypeDict["QYSHHQD"] = "清一色麻七王";
		huTypeDict["QYSCHHQD"] = "清一色王中王";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ycfxmj_winlost_child.js.map
