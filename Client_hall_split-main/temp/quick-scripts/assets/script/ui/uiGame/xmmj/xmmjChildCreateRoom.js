(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xmmj/xmmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd17daw0PPRD0q92ULbIk46+', 'xmmjChildCreateRoom', __filename);
// script/ui/uiGame/xmmj/xmmjChildCreateRoom.js
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 3 || toggleIndex == 4) {
                var mark = needClearList[2].getChildByName('checkmark').active;
                if (!mark) {
                    ...
                    if ('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey) {
                        ...
                        if (this.Toggles['jushu']) {
                            ...
                            for (var _i3 = 0; _i3 < curCostData.length; _i3++) {
                                if (curCostData[_i3].SetCount == 311) {
                                    this.Toggles['jushu'][_i3].getChildByName('label').getComponent(cc.Label).string = '1课:100分';
                                } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xmmjChildCreateRoom.js.map
