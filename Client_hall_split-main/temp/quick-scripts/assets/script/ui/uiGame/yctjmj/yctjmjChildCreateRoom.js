...
var yctjmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		var sendPack = {};
		var jinshu = this.GetIdxByKey('jinshu');
		var kexuanwanfa = this.GetIdxsByKey('kexuanwanfa');
		var fanfanpaixin = this.GetIdxsByKey('fanfanpaixin');
 ...
 UpdateOnClickToggle: function () {
 	if (this.Toggles["difen"]) {
 		if (this.Toggles["moshi"][1].getChildByName("checkmark").active) {
 			...
 			for (let i = 0; i < this.Toggles["difen"].length; i++) {
 				this.Toggles["difen"][i].active = true;
 			}
 		}
 	}
...
module.exports = yctjmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=yctjmjChildCreateRoom.js.map
