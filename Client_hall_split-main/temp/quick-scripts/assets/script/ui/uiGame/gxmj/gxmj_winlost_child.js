(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gxmj/gxmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'bd2eer53M5H5ZwyOIxY+Gn4', 'gxmj_winlost_child', __filename);
// script/ui/uiGame/gxmj/gxmj_winlost_child.js
...
cc.Class({
  ...
  UICard_ShowCard.ShowHuaList(hualist);*/
	...
	ShowPlayerRecord: function ShowPlayerRecord(ShowNode, huInfo) {
		...
		//显示带摸分
		var daiMoFen = huInfo["daiMoFen"];
		if (daiMoFen > -1) {
			daiMoFen = "+" + daiMoFen;
		}
		ShowNode.getChildByName("recordstr").active = true;
		ShowNode.getChildByName("recordstr").getComponent("cc.Label").string = "胡牌分：" + huPaiFen + "    " + "杠分：" + gangFen + "带摸分：" + daiMoFen;
	},
  ...
  */
	...
	LabelName: function LabelName(huType) {
		...
		huTypeDict["QuanQiuRen"] = "全求人";
		huTypeDict["QYS"] = "清一色";
		huTypeDict["QYSQuanQiuRenPPHu"] = "清一色全求人碰碰胡";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gxmj_winlost_child.js.map
