(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jzwzmj/jzwzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '77d46iM9EFJeaLcnOrtgCSC', 'jzwzmjChildCreateRoom', __filename);
// script/ui/uiGame/jzwzmj/jzwzmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var huangzhuang = this.GetIdxByKey('huangzhuang');
        var suanfenyaoqiu = this.GetIdxByKey('suanfenyaoqiu');
        var xiazhuangshezhi = this.GetIdxByKey('xiazhuangshezhi');
        ...
        sendPack = {
            ...
            "suanfenyaoqiu": suanfenyaoqiu,
            "xiazhuangshezhi": xiazhuangshezhi,
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 1) {
                if (this.Toggles["kexuanwanfa"][0].getChildByName("checkmark").active == false && this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active == false) {
                    app.SysNotifyManager().ShowSysMsg("勾选混牌，才能勾选七对带混", [], 3);
                }
            }
            if (toggleIndex == 2) {
                if (this.Toggles["wanfa"][0].getChildByName("checkmark").active == false && this.Toggles["kexuanwanfa"][2].getChildByName("checkmark").active == false) {
                    app.SysNotifyManager().ShowSysMsg("勾选亮四打一，才能勾选缺一门", [], 3);
                }
            }
        }
    ...
    UpdateOnClickToggle: function UpdateOnClickToggle() {
        ...
        if (this.Toggles["wanfa"][0].getChildByName("checkmark").active == false) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jzwzmjChildCreateRoom.js.map
