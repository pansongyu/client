(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hnxcmj/hnxcmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '33427Qhh/1GHZJNGz9xTjiV', 'hnxcmjChildCreateRoom', __filename);
// script/ui/uiGame/hnxcmj/hnxcmjChildCreateRoom.js
...
var hnxcmjChildCreateRoom = cc.Class({
	...
	UpdateTogglesLabel: function UpdateTogglesLabel(TogglesNode) {
		...
		if (this.Toggles["kexuanwanfa"]) {
			if (this.Toggles["xiapao"][9].getChildByName("checkmark").active) {
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key || 'xiapao' == key) {
...
module.exports = hnxcmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hnxcmjChildCreateRoom.js.map
