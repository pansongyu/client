(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/pcmj/pcmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cf8b3oJBN9HvJ8ApUbRRcpD', 'pcmjChildCreateRoom', __filename);
// script/ui/uiGame/pcmj/pcmjChildCreateRoom.js
...
var tgmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var zhuangfeiniao = this.GetIdxByKey('zhuangfeiniao');
        // let quanfeiniao = this.GetIdxByKey('quanfeiniao');
        var hongzhonglaizi = this.GetIdxByKey('hongzhonglaizi');
        ...
        sendPack = {
            "hupai": hupai,
            "zhuangfeiniao": zhuangfeiniao,
            // "quanfeiniao": quanfeiniao,
            "hongzhonglaizi": hongzhonglaizi,
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 0) {
                if (needClearList[0].getChildByName('checkmark').active) {
                    this.Toggles['hongzhonglaizi'][0].parent.active = false;
                } else {
                    this.Toggles['hongzhonglaizi'][0].parent.active = true;
                }
            }
        }
    ...
    RefreshAllToggles: function RefreshAllToggles(gameType) {
        ...
        var isShowHongZhongLaiZi = false;
                ...
                for (var _i = 1; _i <= toggleCount; _i++) {
                    ...
                    if (curNode) {
                        ...
                        if (dataKey == 'kexuanwanfa') {
                            if (linshi != null && linshi.indexOf(1) > -1) {
                                isShowHongZhongLaiZi = true;
                            }
                        }
                        //尝试获取缓存
        ...
        this.Toggles['hongzhonglaizi'][0].parent.active = isShowHongZhongLaiZi;
    },
    // CreateSendPack -end-
...
module.exports = tgmjChildCreateRoom;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=pcmjChildCreateRoom.js.map
