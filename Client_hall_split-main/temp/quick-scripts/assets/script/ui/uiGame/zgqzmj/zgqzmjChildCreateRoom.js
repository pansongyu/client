(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/zgqzmj/zgqzmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '4ed3bFTo0dN3a7AE1cmVJpI', 'zgqzmjChildCreateRoom', __filename);
// script/ui/uiGame/zgqzmj/zgqzmjChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			// if (toggleIndex == 4) {
			// 	let mark = this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active;
			// 	if (!mark) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zgqzmjChildCreateRoom.js.map
