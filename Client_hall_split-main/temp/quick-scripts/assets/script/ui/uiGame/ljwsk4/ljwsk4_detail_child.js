(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ljwsk4/ljwsk4_detail_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '6cd4dFPto9OdLg+F4TlFhPs', 'ljwsk4_detail_child', __filename);
// script/ui/uiGame/ljwsk4/ljwsk4_detail_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(resultsList, playerAll, idx) {
		...
		if (typeof data.surrenderState == "undefined" || data.surrenderState != 3) {
			...
			var _imagePath = "texture/record/img_surrender" + data.surrenderState;
			var _that = this;
			//加载图片精灵
			cc.loader.loadRes(_imagePath, cc.SpriteFrame, function (error, spriteFrame) {
				if (error) {
					console.log("加载图片精灵失败  " + _imagePath);
					return;
				}
				_that.node.getChildByName('icon_surrender').getComponent(cc.Sprite).spriteFrame = spriteFrame;
				_that.node.getChildByName('icon_surrender').active = true;
			});
		}
	}
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ljwsk4_detail_child.js.map
