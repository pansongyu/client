(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/ljwsk4/ljwsk4ChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '4d5e0KyBeFIs73vEx37t3zJ', 'ljwsk4ChildCreateRoom', __filename);
// script/ui/uiGame/ljwsk4/ljwsk4ChildCreateRoom.js
...
var rcwskChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        var sendPack = {};
        var dangfen = this.GetIdxByKey("dangfen");
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        // }
        // else if('moshi' == key){
        //     if (toggleIndex == 1 && (this.Toggles["wanfa"][0].getChildByName("checkmark").active ||
        //         this.Toggles["wanfa"][1].getChildByName("checkmark").active)) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ljwsk4ChildCreateRoom.js.map
