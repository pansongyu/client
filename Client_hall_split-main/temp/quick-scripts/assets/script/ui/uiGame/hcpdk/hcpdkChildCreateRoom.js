(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hcpdk/hcpdkChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5914dSTrL1B94tE9iHfOmsx', 'hcpdkChildCreateRoom', __filename);
// script/ui/uiGame/hcpdk/hcpdkChildCreateRoom.js
            ...
            if (this.gameType == this.gameCreateConfig[key].GameName) {
                if (curKey == this.gameCreateConfig[key].Key) {
                    ...
                    if ("kexuanwanfa" == curKey) {
                        this.Toggles['kexuanwanfa'][0].serverIdx = 11;
                        this.Toggles['kexuanwanfa'][1].serverIdx = 22;
                        this.Toggles['kexuanwanfa'][2].serverIdx = 26;
                        this.Toggles['kexuanwanfa'][3].serverIdx = 28;
                        this.Toggles['kexuanwanfa'][4].serverIdx = 2;
                        this.Toggles['kexuanwanfa'][5].serverIdx = 31;
                    }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hcpdkChildCreateRoom.js.map
