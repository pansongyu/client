(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/tsdg/tsdg_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5bb07W2DSdHR41IKZzoroT1', 'tsdg_winlost_child', __filename);
// script/ui/uiGame/tsdg/tsdg_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        this.ShowPlayerInfo(this.node.getChildByName("user_info"), PlayerInfo);
        //显示头像，如果头像UI
        ...
        //赏数
        if (posEndList.endType == "ONE") {
            str += '头游  ';
        } else if (posEndList.endType == "TWO") {
            str += '二游  ';
        } else if (posEndList.endType == "THREE") {
            str += '三游  ';
        } else if (posEndList.endType == "FOUR") {
            str += '末游  ';
        } else if (posEndList.endType == "NOT") {
            str += '  ';
        }

        if (posEndList.ranksType == 1) {
            str += '红方  ';
        } else {
            str += '蓝方  ';
        }
        str += '拢数:';
        str += this.onPlusScore(posEndList.longNum) + '  ';
        /*str += '奖分:';
...
cc._RF.pop();
        ...
        //# sourceMappingURL=tsdg_winlost_child.js.map
