(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/xjbjmj/xjbjmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'bbe92ndoihBubjcmxw2ifBP', 'xjbjmj_winlost_child', __filename);
// script/ui/uiGame/xjbjmj/xjbjmj_winlost_child.js
...
cc.Class({
    ...
    UpdatePlayData: function UpdatePlayData(PlayerNode, HuList, PlayerInfo) {
        ...
        this.ShowPlayerHuaCard(PlayerNode.getChildByName('huacardscrollView'), HuList.outJinList, jin1, jin2);
    },
    ShowPlayerHuaCard: function ShowPlayerHuaCard(huacardscrollView, hualist, jin1, jin2) {
        ...
        for (var i = 0; i < ShowNode.children.length; i++) {
            ShowNode.children[i].children[0].active = false;
            ShowNode.children[i].children[1].active = false;
        }
        for (var _i = 0; _i < hualist.length; _i++) {
            var cardID = hualist[_i];
            if (Math.floor(cardID / 100) == Math.floor(jin1 / 100)) {
                ShowNode.children[_i].children[0].active = true;
            } else if (Math.floor(cardID / 100) == Math.floor(jin2 / 100)) {
                ShowNode.children[_i].children[1].active = true;
            }
        }
    },
...
cc._RF.pop();
        ...
        //# sourceMappingURL=xjbjmj_winlost_child.js.map
