(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hndzp/hndzpChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2bc80PccitGt4NIxaVwGGa/', 'hndzpChildCreateRoom', __filename);
// script/ui/uiGame/hndzp/hndzpChildCreateRoom.js
...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var paixingjiangli = this.GetIdxsByKey('paixingjiangli');
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 1) {
                if (!this.Toggles["dizhu"][2].getChildByName("checkmark").active) {
                    this.Toggles["dizhu"][0].getChildByName("checkmark").active = false;
                    this.Toggles["dizhu"][1].getChildByName("checkmark").active = false;
                    this.Toggles["dizhu"][2].getChildByName("checkmark").active = true;
                    this.UpdateLabelColor(this.Toggles["dizhu"][0].parent);
                }
            } else {
                if (this.Toggles["dizhu"][2].getChildByName("checkmark").active) {
                    this.Toggles["dizhu"][0].getChildByName("checkmark").active = true;
                    this.Toggles["dizhu"][1].getChildByName("checkmark").active = false;
                    this.Toggles["dizhu"][2].getChildByName("checkmark").active = false;
                    this.UpdateLabelColor(this.Toggles["dizhu"][0].parent);
                }
            }
        } else if ("dizhu" == key) {
            if (this.Toggles["wanfa"][0].getChildByName("checkmark").active) {
                if (toggleIndex == 2) {
                    app.SysNotifyManager().ShowSysMsg("有大小王玩法时，不能勾选黑桃A和黑桃K");
                    return;
                }
            } else {
                if (toggleIndex != 2) {
                    app.SysNotifyManager().ShowSysMsg("无大小王玩法时，只能勾选黑桃A和黑桃K");
                    return;
                }
            }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hndzpChildCreateRoom.js.map
