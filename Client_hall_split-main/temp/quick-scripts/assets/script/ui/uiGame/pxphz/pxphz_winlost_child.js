(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/pxphz/pxphz_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '760edOfd+REWLp1NSWVNdAx', 'pxphz_winlost_child', __filename);
// script/ui/uiGame/pxphz/pxphz_winlost_child.js
...
cc.Class({
    ...
    PlayerData: function PlayerData(PlayerNode, result, pos) {
        ...
        for (var _i = 0; _i < cardMap.length; _i++) {
            ...
            _addYou.getChildByName("layoutpai").getChildByName("lb_you").getComponent(cc.Label).string = _publicInfoValue;
    ...
    ShowOutCardImage: function ShowOutCardImage(childNode) {
        ...
        var imageName = ["shuzi_fangxiao_", Math.floor(childNode.cardID / 100)].join("");
        ...
        var huaseSprite = childNode.getChildByName("hua").getComponent(cc.Sprite);
        var huaImageName = "";
        ...
        var huaImageInfo = this.IntegrateImagePath[huaImageName];
        if (!huaImageInfo) {
            this.ErrLog("ShowOutCardImage IntegrateImage.txt not find:%s", huaImageName);
            return;
        }
        var huaImagePath = huaImageInfo["FilePath"];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=pxphz_winlost_child.js.map
