(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/rcwsk3/rcwsk3_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '7a016Q+O6FG1J/bQ1d632S9', 'rcwsk3_winlost_child', __filename);
// script/ui/uiGame/rcwsk3/rcwsk3_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
        ...
        PlayerNode.getChildByName('lb_huaipai').getComponent(cc.Label).string = posEnd.starPoint;
        PlayerNode.getChildByName('lb_winlost').getComponent(cc.Label).string = posEnd.winLosePoint;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=rcwsk3_winlost_child.js.map
