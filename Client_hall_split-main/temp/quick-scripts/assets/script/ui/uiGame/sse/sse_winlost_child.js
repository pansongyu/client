(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sse/sse_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '41444qKiY9Huqs7+SDxVU6p', 'sse_winlost_child', __filename);
// script/ui/uiGame/sse/sse_winlost_child.js
...
cc.Class({
    ...
    ShowPlayerJieSuan: function ShowPlayerJieSuan(ShowNode, huInfoAll) {
        ...
        //      }
        var huType = this.ShareDefine.HuTypeStringDict[huInfoAll.huType];

        var huInfoStr = "";
        if (huType == this.ShareDefine.HuType_ZiMo) {
            huInfoStr += "自摸";
            if (huInfoAll.ziMoHuCount != 0) {
                huInfoStr += huInfoAll.ziMoHuCount;
            }
        } else if (huType == this.ShareDefine.HuType_JiePao) {
            huInfoStr += "接炮";
        } else if (huType == this.ShareDefine.HuType_QGH) {
        ...
        huInfoStr += "碰杠" + huInfoAll.penGangHuCount;
        huInfoStr += "+刻子" + huInfoAll.keZiHuCount;
        huInfoStr += "+纹银" + huInfoAll.wenYinHuCount;
        huInfoStr += "+底胡" + huInfoAll.diHuCount;
        if (huInfoAll.yaZiHuCount != 0) {
            huInfoStr += "+丫子" + huInfoAll.yaZiHuCount;
        }
        if (huInfoAll.piaoHuCount != 0) {
            huInfoStr += " 飘胡×" + huInfoAll.piaoHuCount;
        }
        huInfoStr += "=" + huInfoAll.huPoint + "分！";

        this.ShowLabelName(ShowNode.getChildByName("label_lists"), huInfoStr);
    },
    ShowPlayerShowCard: function ShowPlayerShowCard(ShowNode, cardIDList, handCard, jin1, jin2) {
        ...
        UICard_ShowCard.ShowDownCardBySSE(cardIDList, handCard, jin1, jin2);
    },
    ShowPlayerDownCard: function ShowPlayerDownCard(ShowNode, publishcard) {
        ...
        UICard_DownCard.ShowDownCardBySSE(publishcard);
    }
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sse_winlost_child.js.map
