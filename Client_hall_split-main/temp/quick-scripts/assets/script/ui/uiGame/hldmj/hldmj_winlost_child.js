(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hldmj/hldmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '807323HSMhJU5f/7vxtZiOE', 'hldmj_winlost_child', __filename);
// script/ui/uiGame/hldmj/hldmj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		this.UpdatePlayData(this.node, posResultList[index], PlayerInfo, jin1, jin2, jinJin, setEnd.zhuaNiaoList || []);
	...
	ShowPlayerInfo: function ShowPlayerInfo(ShowNode, PlayerInfo, HuList) {
		...
		var isFengDing = HuList["isFengDing"];
	...
	ShowOtherScore: function ShowOtherScore(ShowNode, huInfo) {
		...
		ShowNode.getChildByName('lb_gangfen').getComponent("cc.Label").string = "杠分" + this.ToUiScore(gangFen);

		var huFen = huInfo["huFen"] || 0;
		ShowNode.getChildByName('lb_hufen').getComponent("cc.Label").string = "胡分" + this.ToUiScore(huFen);

		var danFen = huInfo["danFen"] || 0;
		ShowNode.getChildByName('lb_danfen').getComponent("cc.Label").string = "鸡蛋分" + this.ToUiScore(danFen);

		var hunFen = huInfo["hunFen"] || 0;
		ShowNode.getChildByName('lb_hunfen').getComponent("cc.Label").string = "混分" + this.ToUiScore(hunFen);

		var genZhuangFen = huInfo["genZhuangFen"] || 0;
		ShowNode.getChildByName('lb_genzhuang').getComponent("cc.Label").string = genZhuangFen == 0 ? "" : "跟庄分" + this.ToUiScore(genZhuangFen);
	},
  ...
  */
	...
	IsShowMulti2: function IsShowMulti2(huType) {
		var multi2 = ["MingGang", "PengGang", "AnGang"];
		var isShow = multi2.indexOf(huType) != -1;
		return isShow;
	},
	...
	ShowPlayerShowCard: function ShowPlayerShowCard(ShowNode, cardIDList, handCard, jin1, jin2, jinJin) {
		ShowNode.active = 1;
		var UICard_ShowCard = ShowNode.getComponent("UIMJCard_ShowCard");
		UICard_ShowCard.ShowDownCardByHLDMJ(cardIDList, handCard, jin1, jin2, jinJin);
	}
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hldmj_winlost_child.js.map
