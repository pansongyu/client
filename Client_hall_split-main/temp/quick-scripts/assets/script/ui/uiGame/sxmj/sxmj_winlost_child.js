(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sxmj/sxmj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f3603o2RHJP8aeyr1nkoVCb', 'sxmj_winlost_child', __filename);
// script/ui/uiGame/sxmj/sxmj_winlost_child.js
...
cc.Class({
  ...
  */
	...
	ShowPiaoMaiState: function ShowPiaoMaiState(PlayerNode) {
		...
		var piaoFenStr = "";
		if (this.posResultInfo["piaoFen"] == 0) piaoFenStr = "不漂" + this.posResultInfo["piaoFen"];else if (this.posResultInfo["piaoFen"] != -1) piaoFenStr = "漂" + this.posResultInfo["piaoFen"];
		lb_piaoFen.string = piaoFenStr;

		var maiStr = "";
		if (this.posResultInfo["piaoFen"] == 1) maiStr = "买";else if (this.posResultInfo["piaoFen"] == 0) maiStr = "不买";
	...
	LabelName: function LabelName(huType) {
		...
		huTypeDict["BaoTou"] = "暴头";
		huTypeDict["GangKai"] = "杠开";
		huTypeDict["DaDiao"] = "大吊";
		huTypeDict["QGH"] = "抢杠";
		huTypeDict["GangBao"] = "杠爆";
		huTypeDict["CaiPiao"] = "财飘";
		huTypeDict["DaDiaoBaoTou"] = "大吊爆头";
		huTypeDict["DaDiaoGangKai"] = "大吊杠开";
		huTypeDict["DaDiaoGangBao"] = "大吊杠爆";
		huTypeDict["DaDiaoCaiPiao"] = "大吊财飘";
		huTypeDict["PiaoGangBao"] = "飘杠爆";
		huTypeDict["GangCaiPiao"] = "杠财飘";
		huTypeDict["DiHua"] = "底花";
		huTypeDict["HuaShu"] = "花数";
		huTypeDict["WuHuaWuCai"] = "无花无财";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sxmj_winlost_child.js.map
