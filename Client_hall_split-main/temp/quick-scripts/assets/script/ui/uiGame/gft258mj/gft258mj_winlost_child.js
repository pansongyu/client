(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/gft258mj/gft258mj_winlost_child.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a0aa3FOHR5N0prgt6ToDl8I', 'gft258mj_winlost_child', __filename);
// script/ui/uiGame/gft258mj/gft258mj_winlost_child.js
...
cc.Class({
	...
	ShowPlayerData: function ShowPlayerData(setEnd, playerAll, index) {
		...
		var maList = setEnd["zhuaNiaoList"] || [];
		var zhongMaList = setEnd["zhongNiaoList"] || [];
	...
	ShowPlayerAllScore: function ShowPlayerAllScore(ShowNode, huInfo) {
		var huPaiFen = huInfo["huPoint"];
		var gangNum = huInfo["gangNum"];
		var gangPoint = huInfo["gangPoint"];
		var paiXingPoint = huInfo["paiXingPoint"];
		var maPoint = huInfo["maPoint"];
		if (huPaiFen >= 0) {
			huPaiFen = "+" + huPaiFen;
		}
		if (gangPoint >= 0) {
		...
		var str = "牌型分:" + huPaiFen + "  " + "杠分:" + gangPoint;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=gft258mj_winlost_child.js.map
