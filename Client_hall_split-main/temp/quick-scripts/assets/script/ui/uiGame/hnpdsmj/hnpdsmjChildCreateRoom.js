(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/hnpdsmj/hnpdsmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '4a4c9v4lppHOZQXp+oTubev', 'hnpdsmjChildCreateRoom', __filename);
// script/ui/uiGame/hnpdsmj/hnpdsmjChildCreateRoom.js
...
var wzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var xuanpaogeshu = this.GetIdxByKey("xuanpaogeshu");
    ...
    OnToggleClick: function OnToggleClick(event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
            ...
            if (toggleIndex == 2) {
                ...
                this.Toggles['xuanpaogeshu'][0].parent.active = false;
            } else {
                this.Toggles['xuanpao'][0].parent.active = true;
                this.Toggles['xuanpaogeshu'][0].parent.active = true;
            }
        } else if ("baoting" == key) {
            ...
            if (toggleIndex == 1 && needClearList[toggleIndex].getChildByName('checkmark').active) {
                if (this.Toggles['baoting'][1].getChildByName('checkmark').active) {
                    this.Toggles["baoting"][0].getChildByName("checkmark").active = false;
                    this.Toggles["baoting"][1].getChildByName("checkmark").active = false;
                    this.Toggles["baoting"][2].getChildByName("checkmark").active = true;
                    this.UpdateLabelColor(this.Toggles["baoting"][0].parent);
                }
            }
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hnpdsmjChildCreateRoom.js.map
