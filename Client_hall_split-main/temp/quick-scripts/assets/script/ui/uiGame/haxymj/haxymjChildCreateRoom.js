(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/haxymj/haxymjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1e827XBLB5FHbgcFekUcnIV', 'haxymjChildCreateRoom', __filename);
// script/ui/uiGame/haxymj/haxymjChildCreateRoom.js
...
var jsnyzmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
		...
		var daifeng = this.GetIdxByKey('daifeng');
		var couzhang = this.GetIdxByKey('couzhang');
		var weizhang = this.GetIdxByKey('weizhang');
		var weifen = this.GetIdxByKey('weifen');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=haxymjChildCreateRoom.js.map
