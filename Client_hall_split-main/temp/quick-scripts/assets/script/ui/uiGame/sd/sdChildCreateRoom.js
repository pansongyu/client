(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/sd/sdChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '969d6v4L2VBDppolpjSdFDw', 'sdChildCreateRoom', __filename);
// script/ui/uiGame/sd/sdChildCreateRoom.js
...
var aypdkChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function CreateSendPack(renshu, setCount, isSpiltRoomCard) {
        ...
        var sanren = this.GetIdxByKey('sanren');
        ...
        var zhadansuanfen = this.GetIdxByKey('zhadansuanfen');
        if (zhadan == 1) {
            zhadansuanfen = -1;
        }
        var ruanying = this.GetIdxByKey('ruanying');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sdChildCreateRoom.js.map
