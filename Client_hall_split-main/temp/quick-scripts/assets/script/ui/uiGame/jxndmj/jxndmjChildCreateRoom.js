(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiGame/jxndmj/jxndmjChildCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '7500aWefvlO8rzANNBmvvKC', 'jxndmjChildCreateRoom', __filename);
// script/ui/uiGame/jxndmj/jxndmjChildCreateRoom.js
...
var bzqzmjChildCreateRoom = cc.Class({
	...
	OnToggleClick: function OnToggleClick(event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			return;
		} else if ('kexuanwanfa' == key) {} else if ('maima' == key) {
			if (toggleIndex == 0) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=jxndmjChildCreateRoom.js.map
