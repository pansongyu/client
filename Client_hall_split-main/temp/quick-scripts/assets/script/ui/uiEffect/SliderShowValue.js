(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiEffect/SliderShowValue.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '3bddeMXJA9NvZYf0K4CVryX', 'SliderShowValue', __filename);
// script/ui/uiEffect/SliderShowValue.js
...
cc.Class({
    ...
    InitSlider: function InitSlider(minValue, maxValue) {
        ...
        //取最大值是2的几次方
        var disValue = this.maxValue - this.minValue;
        var maxCount = 0;
        if (disValue > 0) {
        ...
        for (var index = 1; index <= maxCount; index++) {
            var progress = index / maxCount;
            var addValue = Math.pow(2, index);

            var value = this.minValue + addValue;
            //已经是最后一个值了
    ...
    ChangeProgress: function ChangeProgress(isAdd) {
    ...
    ShowValue: function ShowValue() {
        ...
        if (nowProgress >= 1) {
            ...
            var progressList = Object.keys(this.progressAddValueDict);
            //从大到小
            progressList.SortList(true);
            var count = progressList.length;
            var nowValue = 0;
    ...
    //设置精灵图片贴图
    SetWndImage: function SetWndImage(wndNode, value) {
        ...
        var that = this;
        this.GetSpriteFrameByImageName(value).then(function (spriteFrame) {
            if (spriteFrame) {
    ...
    //获取图片的帧贴图对象
    GetSpriteFrameByImageName: function GetSpriteFrameByImageName(imageName) {
    ...
    GetShowValue: function GetShowValue() {
        ...
        var value = Math.floor(this.NowLabel.string);
        return value;
    },
...
cc._RF.pop();
        ...
        //# sourceMappingURL=SliderShowValue.js.map
