(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/UIBangdingshouji.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a35416rncdEZZ1ZKnf1E5kL', 'UIBangdingshouji', __filename);
// script/ui/UIBangdingshouji.js
...
cc.Class({
    ...
    click_btn_yanzhengma: function click_btn_yanzhengma() {
        var phone = this.newPhoneEditBox.string;
        if (!phone) {
    ...
    click_phone_set: function click_phone_set() {
        var phone = this.newPhoneEditBox.string;
        if (!phone) {
            this.ShowSysMsg('请填写手机号码');
            return;
    ...
    click_phone_reset: function click_phone_reset() {
        var phoneOld = this.oldPhoneEditBox.string;
        if (!phoneOld) {
    ...
    ShowYanZhengMaTime: function ShowYanZhengMaTime() {
        var lb_time = this.lb_time.getComponent(cc.Label);
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIBangdingshouji.js.map
