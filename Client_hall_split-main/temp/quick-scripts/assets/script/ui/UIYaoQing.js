(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/UIYaoQing.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c9be4oMyxtJgL8PUERgkr++', 'UIYaoQing', __filename);
// script/ui/UIYaoQing.js
...
cc.Class({
    ...
    OnShow: function OnShow(clubId) {
        var HeHuoRen = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    ...
    Click_btn_yaoqing: function Click_btn_yaoqing() {
        ...
        if (this.HeHuoRen == 0) {
            ...
            this.NetManager.SendPack("club.CClubSubordinatePidAdd", _sendPack, function (success) {
                that.ShowSysMsg("邀请已发送,等待玩家确认");
            }, function (error) {
                that.ShowSysMsg("已邀请或未找到该玩家或同赛事不同亲友圈不能重复拉人或距离退出该亲友圈不到10分钟");
            });
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIYaoQing.js.map
