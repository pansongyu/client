(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/club/msgType/msg_type_11.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2a951APJX1ORbqTXSEWyQ00', 'msg_type_11', __filename);
// script/ui/club/msgType/msg_type_11.js
...
cc.Class({
    ...
    InitData: function InitData(data) {
        ...
        var msgTypeStr = "";
        if (data.execType == 137) {
            msgTypeStr = "审核增加";
            msgTypeNode.getComponent(cc.Sprite).spriteFrame = this.msgTypeSprite[0];
        } else if (data.execType == 138) {
            msgTypeStr = "审核减少";
            msgTypeNode.getComponent(cc.Sprite).spriteFrame = this.msgTypeSprite[1];
        } else if (data.execType == 139) {
            msgTypeStr = "审核增加";
            msgTypeNode.getComponent(cc.Sprite).spriteFrame = this.msgTypeSprite[0];
        } else if (data.execType == 140) {
            msgTypeStr = "审核减少";
            msgTypeNode.getComponent(cc.Sprite).spriteFrame = this.msgTypeSprite[1];
        } else {
            console.log("请确认是否是审核比赛分消息：" + data.execType);
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=msg_type_11.js.map
