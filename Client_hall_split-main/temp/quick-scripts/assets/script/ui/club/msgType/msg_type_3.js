(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/club/msgType/msg_type_3.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ff72fUUq2JH96/mTmbuoL++', 'msg_type_3', __filename);
// script/ui/club/msgType/msg_type_3.js
...
cc.Class({
    ...
    InitData: function InitData(data) {
        ...
        if (data.execType == 1021) {
            ...
            userIdStr = "ID:" + data.pidPreValue; //跨级异常的ID跟名字服务端定的字段
        }
        ...
        //类型变化
        if (data.execType == 1021) {
            this.node.getChildByName("btn_lv").getChildByName("lb_msgType").getComponent(cc.Label).string = "跨级处罚";
        } else {
            this.node.getChildByName("btn_lv").getChildByName("lb_msgType").getComponent(cc.Label).string = "授权减少";
        }
    }
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=msg_type_3.js.map
