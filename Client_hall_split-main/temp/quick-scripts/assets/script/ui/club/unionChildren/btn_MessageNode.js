(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/club/unionChildren/btn_MessageNode.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ad0d0P9obxJ/pjQpwq10GEH', 'btn_MessageNode', __filename);
// script/ui/club/unionChildren/btn_MessageNode.js
...
cc.Class({
        ...
        for (var i = 0; i < serverPack.length; i++) {
            ...
            switch (serverPack[i].execType) {
                ...
                case this.UNION_EXEC_MATCH_RATE:
                    var dayStr = serverPack[i].value + "天";
    ...
    SendPackByType: function SendPackByType(isRefresh) {
        ...
        var pidStr = app.ComTool().GetBeiZhuID(this.pidEditBox.string);
        if (pidStr == "") {
            pidStr = "0";
        }
        var execPidStr = this.execPidEditBox.string;
        if (execPidStr == "") {
            execPidStr = "0";
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=btn_MessageNode.js.map
