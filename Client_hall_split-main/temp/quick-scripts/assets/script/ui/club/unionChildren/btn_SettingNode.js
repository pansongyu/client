(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/club/unionChildren/btn_SettingNode.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '7ee54OMT35FipEfkO3gsbhg', 'btn_SettingNode', __filename);
// script/ui/club/unionChildren/btn_SettingNode.js
...
cc.Class({
    ...
    UpdateData: function UpdateData(serverPack) {
        this.content.getChildByName("NameEditBox").getComponent(cc.EditBox).string = serverPack.name;
        var JoinToggleContainer = this.content.getChildByName("JoinToggleContainer");
        ...
        var ExitToggleContainer = this.content.getChildByName("ExitToggleContainer");
        ...
        var allowToggleContainer = this.content.getChildByName("allowToggleContainer");
        ...
        var tableToggleContainer = this.content.getChildByName("tableToggleContainer");
        ...
        var StateToggleContainer = this.content.getChildByName("StateToggleContainer");
        ...
        var MatchRateToggleContainer = this.content.getChildByName("MatchRateToggleContainer");
        ...
        var prizeToggleContainer = this.content.getChildByName("prizeToggleContainer");
    ...
    GetSetConfig: function GetSetConfig() {
        var sendPack = app.ClubManager().GetUnionSendPackHead();
        var unionNameEditBox = this.content.getChildByName("NameEditBox").getComponent(cc.EditBox);
        ...
        var sportsPointEditBox = this.content.getChildByName("SportsPointEditBox").getComponent(cc.EditBox);
        ...
        var outSportsEditBox = this.content.getChildByName("OutSportsEditBox").getComponent(cc.EditBox);
        ...
        var prizeRankEditBox = this.content.getChildByName("prizeRankEditBox").getComponent(cc.EditBox);
        ...
        var prizeValueEditBox = this.content.getChildByName("prizeValueEditBox").getComponent(cc.EditBox);
    ...
    OnClick: function OnClick(btnName, btnNode) {
        if ('btn_SaveSetting' == btnName) {
            ...
            app.FormManager().ShowForm('ui/club/UIClubDiamond', _sendPack.clubId, _sendPack.unionId);
    ...
    SaveChange: function SaveChange() {
        var sendPack = this.GetSetConfig();
        if (sendPack == null) {
            return;
        }
        var self = this;
    ...
    OnConFirm: function OnConFirm(clickType, msgID, backArgList) {
        ...
        if ('MSG_EXIT_UNION' == msgID) {
            ...
            var _self = this;
            app.NetManager().SendPack("union.CUnionDissolve", _sendPack2, function (serverPack) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=btn_SettingNode.js.map
