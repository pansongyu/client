(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/UIResultAllDetail.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '19dd6sc9MxPD5+6MrQuiKGV', 'UIResultAllDetail', __filename);
// script/ui/UIResultAllDetail.js
...
cc.Class({
    ...
    OnShow: function OnShow() {
        ...
        if (Type == 1) {
            ...
            //扑克用的麻将结算排版
            if (this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_SDH] || this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_CDP] || this.gameType == app.ShareDefine().GametTypeID2PinYin[app.ShareDefine().GameType_HNDZP]) {
                this.mj_layout_player.active = true;
                this.poker_layout_player.active = false;
                this.layout_player = this.mj_layout_player;
                this.poker_title_list.active = false;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIResultAllDetail.js.map
