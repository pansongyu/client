(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/hotupdate/ApkUpdateMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5e5e0gp57VOEbeLgUm+F4do', 'ApkUpdateMgr', __filename);
// script/hotupdate/ApkUpdateMgr.js
...
var ApkUpdateMgr = app.BaseClass.extend({
    ...
    //是否需要更新
    IsNeedUpdate: function IsNeedUpdate() {
    ...
    //比较字符串大小
    IsUpdateByVersion: function IsUpdateByVersion(localVersion, serverVersion) {
        if (serverVersion.length > localVersion.length) {
            return true;
        }
        for (var i = 0; i < localVersion.length; i++) {
            var local = parseInt(localVersion[i]);
            var server = i < serverVersion.length ? parseInt(serverVersion[i]) : 0;
    ...
    //更新apk 
    updateApk: function updateApk() {
        var storagePath = jsb.fileUtils ? jsb.fileUtils.getWritablePath() : '/';
        var argList = [{ "Name": "urls", "Value": this.getApkRUl }, { "Name": "fileName", "Value": "HZ-release.apk" }, { "Name": "savePath", "Value": storagePath }];
        var downLoadMgr = app.DownLoadMgr();
        downLoadMgr.DownFile(this.getApkRUl, storagePath, "HZ-release.apk", "LoadApkProess");
    },

    //版本检查
    CheckVersion: function CheckVersion(getApkRUl, ApkVersion) {
...
exports.GetModel = function () {
    if (!g_ApkUpdateMgr) g_ApkUpdateMgr = new ApkUpdateMgr();
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ApkUpdateMgr.js.map
