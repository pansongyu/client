(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/hotupdate/HotUpdateMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '895387lxidA1qq71Z6Rof/q', 'HotUpdateMgr', __filename);
// script/hotupdate/HotUpdateMgr.js
...
var HotUpdateMgr = app.BaseClass.extend({
     ...
     */
    isHallDownLoad: function isHallDownLoad() {

        return false;

        var file = (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : '/') + 'hall/project.manifest';
        if (jsb.fileUtils.isFileExist(file)) {
            var jsonString = jsb.fileUtils.getStringFromFile(file);
    ...
    SaveManifest: function SaveManifest() {
        ...
        var path_Manifest = this.UIRLFILE_root + "hall/remote-assets/project_item.manifest";
        var file = (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : '/') + 'hall/project.manifest';
...
exports.GetModel = function () {
    if (!g_HotUpdateMgr) g_HotUpdateMgr = new HotUpdateMgr();
