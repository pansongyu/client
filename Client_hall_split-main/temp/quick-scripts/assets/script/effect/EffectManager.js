(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/effect/EffectManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c2412H0achCGpgafCvD+4Gz', 'EffectManager', __filename);
// script/effect/EffectManager.js
...
var EffectManager = app.BaseClass.extend({
    ...
    LoadPrefab: function LoadPrefab(prefabPath) {
        ...
        return app.ControlManager().CreateLoadPromise(prefabPath).then(function (prefab) {
