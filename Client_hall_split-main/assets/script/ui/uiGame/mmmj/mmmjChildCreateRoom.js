...
var gamjChildCreateRoom = cc.Class({
    ...
    UpdateTogglesLabel: function (TogglesNode, isResetPos = true) {
        ...
        if (this.Toggles["kexuanwanfa"]) {
            ...
            // 	勾选“白板翻倍”或“翻鬼”，才能勾选“四鬼加倍”； 
            if (this.Toggles["guipai"][1].getChildByName("checkmark").active ||
                this.Toggles["guipai"][2].getChildByName("checkmark").active) {	// 勾选“白板翻倍”或“翻鬼”
                this.Toggles["kexuanwanfa"][13].active = true;	// 四鬼加倍
            } else {
                this.Toggles["kexuanwanfa"][13].active = false;
            }
            // 	勾选无奖马时，不能勾选“马跟底分”“马跟杠”；
            if (this.Toggles["jiangma"][0].getChildByName("checkmark").active) {	// 勾选无奖马时
            ...
            // 	勾选“不带风”，不能勾选“幺九8分”“十三幺”；		
            if (this.Toggles["kexuanwanfa"][11].getChildByName("checkmark").active) {	// 勾选“不带风”
    ...
    OnToggleClick: function (event) {
        ...
        if ('jushu' == key || 'renshu' == key || 'fangfei' == key || "zhuaniao" == key) {
            ...
            // 	勾选“白板翻倍”或“翻鬼”，才能勾选“四鬼加倍”； 
            if (toggleIndex == 1 || toggleIndex == 2) { // 勾选“白板翻倍”或“翻鬼”
