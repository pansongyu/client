...
cc.Class({
    ...
    UpdatePlayData: function (PlayerNode, HuList, PlayerInfo, jin1 = 0, laiZiPiList, specialLaiZiPiList, maiMaList = []) {
        this.showLabelNum = 1;
    ...
    ShowPlayerInfo: function (ShowNode, PlayerInfo, HuList) {
        ...
        let isBaoHu = HuList["isBaoHu"];
        let fengDingType = HuList["fengDingType"];
        let fanShu = HuList["fanShu"];
    ...
    ShowPlayerShowCard: function (ShowNode, cardIDList, handCard, jin1, laiZiPiList, specialLaiZiPiList) {
        ShowNode.active = 1;
    ...
    ShowPlayerDownCard: function (ShowNode, publishcard, jin1 = 0, laiZiPiList = [], specialLaiZiPiList = []) {
        ShowNode.active = 1;
    ...
    IsShowMulti2: function (huType) {
        let multi2 = ["DianPao", "Gang", "AnGang", "JieGang", "Jin", "JinGang", "Zhong", "ChiFaCai","Zhuang", "ZiMo", "YingHua", "PengDa"];
        let isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
});
