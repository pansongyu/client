...
var gzthChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		...
		let wannengpai = this.GetIdxByKey('wannengpai');
		let yingpaibeishu = this.GetIdxByKey('yingpaibeishu');
		let yingpaihuafen = this.GetIdxByKey('yingpaihuafen');
		let suanfen = this.GetIdxByKey('suanfen');
		let kexuanwanfa = this.GetIdxsByKey('kexuanwanfa');
		let fangjian = this.GetIdxsByKey('fangjian');
		let xianShi = this.GetIdxByKey('xianShi');
		let jiesan = this.GetIdxByKey('jiesan');
		let jiesanshezhi = this.GetIdxByKey('jiesanshezhi');
