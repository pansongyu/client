...
var dzpkChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		...
		let daxiaomangjibie = this.GetIdxByKey("daxiaomangjibie");
		let qianzhu = this.GetIdxByKey("qianzhu");
		let santiaoshunzi = this.GetIdxByKey("santiaoshunzi");
	...
	UpdateTogglesLabel: function (TogglesNode, isResetPos = true) {
		if (this.Toggles["wanfa"] && this.Toggles["moshi"][0].getChildByName("checkmark").active) {//0局
			...
			if (this.Toggles["daxiaomangjibie"][0].getChildByName("checkmark").active) {
				for (let i = 0; i < this.Toggles["qianzhu"].length; i++) {
					if (i == 0 || i == 1 || i == 2) {
				...
				if (!this.Toggles["qianzhu"][0].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][1].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][2].getChildByName("checkmark").active) {
					let index = this.ComTool.RandInt(0, 2);
			...
			if (this.Toggles["daxiaomangjibie"][1].getChildByName("checkmark").active) {
				...
				if (!this.Toggles["qianzhu"][0].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][1].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][2].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][4].getChildByName("checkmark").active) {
					let index = this.ComTool.RandInt(0, 2);
					this.Toggles["qianzhu"][index].getChildByName("checkmark").active = true;
				}
			}
			if (this.Toggles["daxiaomangjibie"][2].getChildByName("checkmark").active) {
				...
				if (!this.Toggles["qianzhu"][0].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][1].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][3].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][6].getChildByName("checkmark").active) {
					let index = this.ComTool.RandInt(0, 1);
					this.Toggles["qianzhu"][index].getChildByName("checkmark").active = true;
				}
			}
			if (this.Toggles["daxiaomangjibie"][3].getChildByName("checkmark").active) {
				...
				if (!this.Toggles["qianzhu"][0].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][1].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][4].getChildByName("checkmark").active &&
					!this.Toggles["qianzhu"][7].getChildByName("checkmark").active) {
					let index = this.ComTool.RandInt(0, 1);
					this.Toggles["qianzhu"][index].getChildByName("checkmark").active = true;
				}
			}
		...
		if (this.Toggles["wanfa"] && this.Toggles["moshi"][1].getChildByName("checkmark").active) {//1局
			this.Toggles["qianzhu"][0].parent.active = true;
			for (let i = 0; i < this.Toggles["qianzhu"].length; i++) {
				this.Toggles["qianzhu"][i].active = true;
			}
		...
		if (this.Toggles["wanfa"] && this.Toggles["moshi"][2].getChildByName("checkmark").active) {//2局
			this.Toggles["qianzhu"][0].parent.active = true;
			this.Toggles["daxiaomangjibie"][0].parent.active = true;
			if (this.Toggles["daxiaomangjibie"][0].getChildByName("checkmark").active) {
				for (let i = 0; i < this.Toggles["qianzhu"].length; i++) {
					if (i == 0) {
						this.Toggles["qianzhu"][i].getChildByName("checkmark").active = true;
						this.Toggles["qianzhu"][i].active = true;
					} else {
						this.Toggles["qianzhu"][i].getChildByName("checkmark").active = false;
						this.Toggles["qianzhu"][i].active = false;
			...
			} else if (this.Toggles["daxiaomangjibie"][1].getChildByName("checkmark").active ||
				this.Toggles["daxiaomangjibie"][2].getChildByName("checkmark").active ||
				this.Toggles["daxiaomangjibie"][3].getChildByName("checkmark").active) {
				for (let i = 0; i < this.Toggles["qianzhu"].length; i++) {
					if (i == 0 || i == 1) {
						this.Toggles["qianzhu"][i].active = true;
					} else {
		...
		if (this.Toggles["wanfa"] && this.Toggles["moshi"][3].getChildByName("checkmark").active) {//3局
