...
cc.Class({
	...
	ShowPlayerShowCard: function (ShowNode, cardIDList, handCard, jin1, jin2, liangPaiList) {
		ShowNode.active = 1;
	...
	ShowPlayerDownCard: function (ShowNode, publishcard, jin1 = 0, jin2 = 0, liangPaiList, baoZhangList) {
		ShowNode.active = 1;
