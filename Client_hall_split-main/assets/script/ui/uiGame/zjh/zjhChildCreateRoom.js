...
var zjhChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		...
		let dingzhu = this.GetIdxByKey("dingzhu");
		let bipai = this.GetIdxByKey("bipai");
		let lunshu = this.GetIdxByKey("lunshu");
		let kebilunshu = this.GetIdxByKey("kebilunshu");

		let bimen = this.GetIdxByKey("bimen");
