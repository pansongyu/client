...
cc.Class({
    ...
    IsNotShowScore: function (huType) {
        let multi2 = ["ChongYiBaoSan", "BaJing"];
        let isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
    IsShowMulti2: function (huType) {
        let multi2 = ["QSSL", "SSL", "GSKH", "JingDiao", "DG", "PPHu", "QD", "ZiMo", "ZhuangJia"];
        let isShow = multi2.indexOf(huType) != -1;
        return isShow;
    },
