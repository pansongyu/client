...
cc.Class({
    ...
    UpdatePlayData: function (PlayerNode, HuList, PlayerInfo, jin1 = 0, jin2 = 0, maList, zhongList) {
        this.showLabelNum = 1;
    ...
    ShowPlayerNiaoPai: function(ShowNode, maList, zhongList, huType) {
        for (let i = 1; i <= 10; i++) {
