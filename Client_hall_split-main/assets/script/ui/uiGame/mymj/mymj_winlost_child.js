...
cc.Class({
    ...
    ShowPlayerData: function (setEnd, playerAll, index) {
        ...
        //显示飘
        let piaoFen =posResultList[index]['piaoFen'] 
        if(piaoFen > -1){
        ...
        //显示定缺
        let duan =posResultList[index]['duan'];
        let dingQue = this.ShareDefine.OpTypeStringDict[duan] - 86;
        if(dingQue > -1){
