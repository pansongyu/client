...
var szmjChildCreateRoom = cc.Class({
	...
	OnUpdateTogglesLabel: function (TogglesNode, isResetPos = true) {
		...
		if (this.Toggles["kexuanwanfa"]) {
			// 	勾选“无鬼”，不可勾选“无鬼加倍”；
			if (this.Toggles["guipai"][0].getChildByName("checkmark").active) {	// 勾选“无鬼”玩法
			...
			// 	勾选“可点炮胡”，才可以勾选“点炮包胡”
			if (this.Toggles["kexuanwanfa"][1].getChildByName("checkmark").active) {	// 勾选“可点炮胡”
