...
var thgjmjChildCreateRoom = cc.Class({
	 ...
	 * @param {*} name 
	 */
	ClearRadioSelect: function (sendPack, name) {
		sendPack[name] = -1;
		return sendPack;
	},
	 ...
	 * @param {*} name 
	 */
	ClearMultiSelect: function (sendPack, name) {
		sendPack[name] = [];
		return sendPack;
	},
    ...
    UpdateTogglesLabel:function (TogglesNode, isResetPos=true) {
		...
		if (this.Toggles["jushu"] && this.Toggles["moshi"]) {
			if (this.Toggles["moshi"][0] && this.Toggles["moshi"][0].getChildByName("checkmark").active) { // 勾选 “硬自摸”
				// 	勾选“硬自摸”，才能勾选“4局,8局,16局”；
				this.Toggles["jushu"][0].active = true;
				this.Toggles["jushu"][1].active = true;
				this.Toggles["jushu"][2].active = true;

				if (!this.Toggles["jushu"][0].getChildByName("checkmark").active &&
					!this.Toggles["jushu"][1].getChildByName("checkmark").active &&
					!this.Toggles["jushu"][2].getChildByName("checkmark").active) {
			...
			if (this.Toggles["moshi"][1] && this.Toggles["moshi"][1].getChildByName("checkmark").active) { // 勾选 "抬头胡"
				// 	勾选“硬自摸”，才能勾选“4局,8局,16局”；
				...
				if (!this.Toggles["jushu"][3].getChildByName("checkmark").active &&
					...
					!this.Toggles["jushu"][5].getChildByName("checkmark").active) {
