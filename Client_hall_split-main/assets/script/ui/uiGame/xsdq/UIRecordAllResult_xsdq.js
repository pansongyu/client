...
cc.Class({
	...
	ShowScore: function (setEnd) {
		...
		if (zhuangRanksType > 0) {
			let zhuangStr = "庄队: 抓分：" + (rankInfoMap[zhuangRanksType].chiFen > 0 ? "+" : "") + rankInfoMap[zhuangRanksType].chiFen;
			...
			let xianRanksType = zhuangRanksType == 1 ? 2 : 1;
			let xianStr = "闲队: 抓分：" + (rankInfoMap[xianRanksType].chiFen > 0 ? "+" : "") + rankInfoMap[xianRanksType].chiFen;
