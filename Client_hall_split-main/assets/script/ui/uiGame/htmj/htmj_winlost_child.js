...
cc.Class({
    ...
    ShowPlayerNiaoPai:function(ShowNode, valueNode, zhuaNiaoList,endPoint){
        let niaoPaiList = endPoint["niaoPaiList"] || [];
        let niaoValueList = endPoint["niaoValueList"] || [];
        for(let i=1;i<=3;i++){
        ...
        //     return;
        // }
        for (let index = 0; index < niaoValueList.length; index++) {
            let num = niaoValueList[index];
