...
var xymjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        let sendPack = {};
		let youjin = this.GetIdxByKey("youjin");
                    ...
                    if('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey){
                        ...
                        if(this.Toggles['jushu']){
                            ...
                            for(let i=0; i<curCostData.length; i++){
                                if(curCostData[i].SetCount==310){
                                    this.Toggles['jushu'][i].getChildByName('label').getComponent(cc.Label).string = '1课:10分';
                                }else if(curCostData[i].SetCount==311){
