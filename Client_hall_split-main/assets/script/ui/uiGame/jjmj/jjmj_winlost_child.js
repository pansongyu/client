...
cc.Class({
    ...
    UpdatePlayData: function (PlayerNode, HuList, PlayerInfo, jin1 = 0, jin2 = 0, maList = []) {
        this.showLabelNum = 1;
    ...
    ShowPlayerInfo: function (ShowNode, PlayerInfo, HuList) {
        ...
        let isBaoTing = HuList["isBaoTing"];
    ...
    ShowPlayerNiaoPai: function (ShowNode, maList, huInfo, huType) {
