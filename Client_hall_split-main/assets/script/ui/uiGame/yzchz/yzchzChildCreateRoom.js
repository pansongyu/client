...
var hhhgwChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        ...
        let zishusuanfa = this.GetIdxByKey('zishusuanfa');
        let zimo = this.GetIdxByKey('zimo');
        let dianpao = this.GetIdxByKey('dianpao');
        let baodi = this.GetIdxByKey('baodi');
        let shuxing = this.GetIdxByKey('shuxing');
        let fanxingshezhi = this.GetIdxsByKey('fanxingshezhi');
        let kexuanwanfa = this.GetIdxsByKey('kexuanwanfa');
