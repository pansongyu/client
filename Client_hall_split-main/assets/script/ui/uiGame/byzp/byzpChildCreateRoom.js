...
var byzpChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        let sendPack = {};
            ...
            let yizi = this.GetIdxByKey("yizi");
            let zimo = this.GetIdxByKey("zimo");
            let lianmai = this.GetIdxByKey("lianmai");
            let dianpao = this.GetIdxByKey("dianpao");
            let gudingxing = this.GetIdxByKey("gudingxing");

            let zhengyouyoushu=this.GetIdxByKey("zhengyouyoushu");
            let shuxingsuanfen=this.GetIdxByKey("shuxingsuanfen");
