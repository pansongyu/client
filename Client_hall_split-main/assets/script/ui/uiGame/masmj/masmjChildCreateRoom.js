...
var thgjmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        let sendPack = {};
        let meidao=this.GetIdxByKey('meidao');
                    ...
                    if('renshu' == curKey || 'fangfei' == curKey || 'jushu' == curKey){
                        ...
                        if(this.Toggles['jushu']){
                            ...
                            for(let i=0; i<curCostData.length; i++){
                                if(curCostData[i].SetCount > 600){
                                    this.Toggles['jushu'][i].getChildByName('label').getComponent(cc.Label).string = curCostData[i].SetCount%100 + '倒';
                                }else{
