...
var fzmjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        let sendPack = {};
            let fenghua = this.GetIdxByKey('fenghua');
			let kexuanwanfa = this.GetIdxByKeyMulti('kexuanwanfa');
			...
			let paohu = this.GetIdxByKeyMulti('paohu');
			let paixingfanbei = this.GetIdxByKeyMulti('paixingfanbei');
