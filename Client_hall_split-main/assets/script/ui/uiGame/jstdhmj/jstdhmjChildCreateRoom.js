	...
	OnToggleClick: function (event) {
		...
		if ('jushu' == key || 'renshu' == key || 'fangfei' == key) {
			...
			if (toggleIndex == 1) {// 点击 爆头
				let is0 = this.Toggles['kexuanwanfa'][1].getChildByName('checkmark').active;
				let is6 = this.Toggles['kexuanwanfa'][0].getChildByName('checkmark').active;
				if (!is6 && !is0) {
