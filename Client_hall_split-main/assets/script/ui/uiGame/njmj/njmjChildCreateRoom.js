...
var gamjChildCreateRoom = cc.Class({
    ...
    CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
        ...
        let jinyuanzi = this.GetIdxByKey('jinyuanzi');
        let changkaitou = this.GetIdxByKey('changkaitou');
    ...
    UpdateTogglesLabel: function (TogglesNode, isResetPos = true) {
        ...
        if (this.Toggles["jinyuanzi"]) {
            if (this.Toggles["wanfa"][0].getChildByName("checkmark").active) {	// 进园子玩法
