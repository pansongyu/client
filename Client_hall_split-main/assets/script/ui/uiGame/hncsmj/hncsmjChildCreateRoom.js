...
var hncsmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		...
		let gudingpiaofen = this.GetIdxByKey("gudingpiaofen");
		let kaigang = this.GetIdxByKey("kaigang");
	...
	UpdateTogglesLabel: function (TogglesNode, isResetPos = true) {
		if (this.Toggles["gudingpiaofen"]) {
			if (this.Toggles["piaofen"][0].getChildByName("checkmark").active ||
				this.Toggles["piaofen"][2].getChildByName("checkmark").active) {
		...
		if (this.Toggles["kexuanwanfa"]) {
			if (this.Toggles["renshu"][1].getChildByName("checkmark").active ||
				this.Toggles["renshu"][2].getChildByName("checkmark").active) {
	...
	OnToggleClick: function (event) {
		...
		if ("kexuanwanfa" == key) {
			...
			if (this.Toggles["renshu"][0].getChildByName("checkmark").active &&
				!this.Toggles["kexuanwanfa"][10].getChildByName("checkmark").active) {
				this.Toggles["kexuanwanfa"][3].active = true;
				this.Toggles["kexuanwanfa"][4].active = true;
			}
		}
