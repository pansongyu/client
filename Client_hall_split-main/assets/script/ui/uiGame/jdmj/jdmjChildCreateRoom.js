...
var jdmjChildCreateRoom = cc.Class({
	...
	CreateSendPack: function (renshu, setCount, isSpiltRoomCard) {
		let sendPack = {};
		let jifenfangshi = this.GetIdxByKey('jifenfangshi');
		let difenshezhi = this.GetIdxByKey('difenshezhi');
		let qihubiaozhun = this.GetIdxByKey('qihubiaozhun');
		let huangwanfa = this.GetIdxByKey('huangwanfa');
