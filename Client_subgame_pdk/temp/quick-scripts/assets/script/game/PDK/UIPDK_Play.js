(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/game/PDK/UIPDK_Play.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'typdk7dd-440f-4f82-a44c-6536a3bc0136', 'UIPDK_Play', __filename);
// script/game/PDK/UIPDK_Play.js
...
cc.Class({
    ...
    AddHead: function AddHead() {
        ...
        for (var idx = 0; idx < posList.length; idx++) {
            ...
            if (!node.getChildByName("UIPublicHead" + uiPos)) {
                ...
                var headScript = head.getComponent(app.subGameName + "_UIPublicHead");
                headScript.Init(uiPos, posList[idx].pos, cc.v2(0, 0), this.Left[uiPos]);
            } else {
                var headNode = node.getChildByName("UIPublicHead" + uiPos);
                // headNode.getChildByName("otherNode").active = false;
                // headNode.getChildByName("otherNode").getChildByName("bsPrefab").active = false;
                var _headScript = headNode.getComponent(app.subGameName + "_UIPublicHead");
    ...
    ClearHead: function ClearHead() {
        for (var idx = 0; idx < this.Define.MaxPlayer; idx++) {
            var path = "sp_seat0" + idx + "/head" + "/UIPublicHead" + idx;
            var node = this.GetWndNode(path);
            if (node) {
                var headScript = node.getComponent(app.subGameName + "_UIPublicHead");
                headScript.OnClose();
            }
        }
    },
    ...
    HideAllZhunBeiLabel: function HideAllZhunBeiLabel() {
        ...
        for (var i = 0; i < playerAllList.length; i++) {
            ...
            var path = "sp_seat0" + uiPos + "/head" + "/UIPublicHead" + uiPos;
            var headNode = this.GetWndNode(path);
            if (!headNode || typeof headNode == "undefined") continue;
            var headScript = headNode.getComponent(app.subGameName + "_UIPublicHead");
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIPDK_Play.js.map
