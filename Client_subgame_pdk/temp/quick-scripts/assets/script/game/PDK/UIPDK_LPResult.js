(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/game/PDK/UIPDK_LPResult.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'typdk5df-391f-4001-8dee-f98dcc6f4f66', 'UIPDK_LPResult', __filename);
// script/game/PDK/UIPDK_LPResult.js
...
cc.Class({
    ...
    ShowResultNormal: function ShowResultNormal(allPlayer, setEnd, isReconnect) {
        ...
        for (var i = 0; i < playerList.length; i++) {
            ...
            //新 玩家当局分数
            var winLoseCurPoint = cc.find('newLayer/img_bjf/lb_bjf', playerNode);
            ...
            var boomNumber = cc.find('newLayer/img_zdf/lb_boom_num', playerNode).getComponent(cc.Label);
            ...
            if (isReconnect) {
                ...
                if (setEnd.posInfo[i].beShutDow && i == setEnd.firstOpPos) {} else if (setEnd.posInfo[i].beShutDow) {
                ...
                if (setEnd.beShutDowList[i] && i == setEnd.firstOpPos) {} else if (setEnd.beShutDowList[i]) {
                    icon_bgm.active = true;
                }
            }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIPDK_LPResult.js.map
