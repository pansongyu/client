(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/pdk_BaseForm.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'typdka7b-38cb-467f-b2b8-9e156008281f', 'pdk_BaseForm', __filename);
// script/ui/pdk_BaseForm.js
...
var pdk_BaseForm = cc.Class({
     ...
     */
    outCardPackageVerification: function outCardPackageVerification(sendPack) {
        var repeatCardMaxCount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
        var cardList = sendPack.cardList;
        ...
        try {
            for (var _iterator = cardList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    WanFa: function WanFa() {
        ...
        var showFlag = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=pdk_BaseForm.js.map
