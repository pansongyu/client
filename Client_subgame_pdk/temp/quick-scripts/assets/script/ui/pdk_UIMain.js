(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/pdk_UIMain.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'typdk60c-e8f7-401b-b8b8-b65d6fcdaa11', 'pdk_UIMain', __filename);
// script/ui/pdk_UIMain.js
...
cc.Class({
    ...
    OnClick: function OnClick(btnName, btnNode) {
        if ('btn_create' == btnName) {
            ...
            var editBox = this.GetWndNode("main/replay/replayEditBox").getComponent(cc.EditBox);
            var backCode = parseInt(editBox.string);
            var videoData = { action: "showVideo", backCode: backCode };
...
cc._RF.pop();
        ...
        //# sourceMappingURL=pdk_UIMain.js.map
