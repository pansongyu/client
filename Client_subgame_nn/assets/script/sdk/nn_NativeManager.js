 ...
 * 类构造
 */
var nn_NativeManager = app.BaseClass.extend({
...
var g_nn_NativeManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
	if(!g_nn_NativeManager){
		g_nn_NativeManager = new nn_NativeManager();
	}
	return g_nn_NativeManager;
};