...
var nn_WeChatAppManager = app.BaseClass.extend({
    Init:function() {
...
var g_nn_WeChatAppManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
    if(!g_nn_WeChatAppManager){
        g_nn_WeChatAppManager = new nn_WeChatAppManager();
    }
    return g_nn_WeChatAppManager;
};
