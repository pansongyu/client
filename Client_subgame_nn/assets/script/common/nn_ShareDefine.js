...
var Game = function(){
	...
	this.GametTypeID2Name[this.GameType_NN] = "双十";
...
var LZMJ = function(){
	...
	//发牌阶段每个人领取卡牌数量
	this.LZMJRoomDealPerPosCardCount = 16;
	//发出去的牌数量
	this.LZMJRoomDealCardCount = this.LZMJRoomJoinCount*this.LZMJRoomDealPerPosCardCount;
};

//-----基础---
Color.apply(nn_ShareDefine, []);
Common.apply(nn_ShareDefine, []);
GM.apply(nn_ShareDefine, []);
Order.apply(nn_ShareDefine, []);
Code.apply(nn_ShareDefine, []);
Timer.apply(nn_ShareDefine, []);
Chat.apply(nn_ShareDefine, []);
Model.apply(nn_ShareDefine, []);
Form.apply(nn_ShareDefine, []);
Hero.apply(nn_ShareDefine, []);
Effect.apply(nn_ShareDefine, []);
SDK.apply(nn_ShareDefine, []);
Mail.apply(nn_ShareDefine, []);
Game.apply(nn_ShareDefine, []);
//-----项目---
Rank.apply(nn_ShareDefine, []);
Room.apply(nn_ShareDefine, []);
// MaJiang.apply(nn_ShareDefine, []);
// LZMJ.apply(nn_ShareDefine, []);
/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
	return nn_ShareDefine;
};