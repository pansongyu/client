...
var ServerTimeManager = app.BaseClass.extend({
	...
	Init:function(){
		...
		// console.log("create ServerTimeManager.js");
	},
	...
	GetServerTimeTickByTime:function(hour, min, sec){
		...
		//console.log("GetServerTimeTickByTime {1}-{2}-{3} {4}:{5}:{6},{7}", curDate.getFullYear(), curDate.getMonth(), curDate.getDate(), curDate.getHours(),curDate.getMinutes(),curDate.getSeconds(), curDate.getDay());
	...
	GetServerStartTime:function(getType){
		...
		//console.log("{1}-{2}-{3} {4}:{5}:{6},{7}", curDate.getFullYear(), curDate.getMonth(), curDate.getDate(), curDate.getHours(),curDate.getMinutes(),curDate.getSeconds(), curDate.getDay());
