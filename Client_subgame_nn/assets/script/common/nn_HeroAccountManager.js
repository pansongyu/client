...
var nn_HeroAccountManager = app.BaseClass.extend({
    ...
    InitLocalAccount:function(){
        ...
        console.logInAccountList = accountList;

        for(var charAccount in accountDict){
            if(console.logInAccountList.InArray(charAccount, true)){
    ...
    AddNewAccountList:function(account, token){
        ...
        if (console.logInAccountList.InArray(account)){
            console.logInAccountList.Remove(account);
            console.logInAccountList.push(account);
        }
        else{
            console.logInAccountList.push(account);
        }
    ...
    SavePlayerAccount:function(){
        ...
        this.LocalDataManager.SetConfigProperty("Account", "AccountList", console.logInAccountList);
    },
    ...
    GetAccountToken:function(account){
        if (!this.localAccountDict.hasOwnProperty(account)){
            // console.log("GetAccountToken not find:%s", account);
            return ""
        }
    ...
    GetLocalAccountList:function(){
        return console.logInAccountList
    },
...
var g_nn_HeroAccountManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
    if(!g_nn_HeroAccountManager){
        g_nn_HeroAccountManager = new nn_HeroAccountManager();
    }
    return g_nn_HeroAccountManager;
}