(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/common/fjssz_ShareDefine.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fjssz972-81b4-449b-9387-7becdf8675d5', 'fjssz_ShareDefine', __filename);
// script/common/fjssz_ShareDefine.js
...
var Game = function Game() {
	//斗地主
	this.GameType_FJSSZ = 206;

	this.GametTypeNameDict = {};
	this.GametTypeNameDict["FJSSZ"] = this.GameType_FJSSZ;

	this.GametTypeID2Name = {};
	this.GametTypeID2Name[this.GameType_FJSSZ] = "福建十三水";

	this.GametTypeID2PinYin = {};
	this.GametTypeID2PinYin[this.GameType_FJSSZ] = "fjssz";
};
...
var Room = function Room() {
	...
	this.SetState_FaPai = 0; //发牌阶段
	this.SetState_Hog = 1; //抢庄状态
	this.SetState_AddDouble = 2; //加倍阶段
	this.SetState_Playing = 3; //比牌阶段
	this.SetState_End = 4; //结束阶段
	this.SetStateStringDict = {};
	this.SetStateStringDict["FJSSZ_GAME_STATUS_DEAL"] = this.SetState_FaPai;
	this.SetStateStringDict["FJSSZ_GAME_STATUS_CONFIRMBanker"] = this.SetState_Hog;
	this.SetStateStringDict["FJSSZ_GAME_STATUS_ADDDOUBLE"] = this.SetState_AddDouble;
	this.SetStateStringDict["FJSSZ_GAME_STATUS_PLAYING"] = this.SetState_Playing;
	this.SetStateStringDict["FJSSZ_GAME_STATUS_RESULT"] = this.SetState_End;
};

//-----基础---
Color.apply(fjssz_ShareDefine, []);
Common.apply(fjssz_ShareDefine, []);
GM.apply(fjssz_ShareDefine, []);
Order.apply(fjssz_ShareDefine, []);
Code.apply(fjssz_ShareDefine, []);
Timer.apply(fjssz_ShareDefine, []);
Chat.apply(fjssz_ShareDefine, []);
Model.apply(fjssz_ShareDefine, []);
Form.apply(fjssz_ShareDefine, []);
Hero.apply(fjssz_ShareDefine, []);
Effect.apply(fjssz_ShareDefine, []);
SDK.apply(fjssz_ShareDefine, []);
Mail.apply(fjssz_ShareDefine, []);
Game.apply(fjssz_ShareDefine, []);
//-----项目---
Rank.apply(fjssz_ShareDefine, []);
Room.apply(fjssz_ShareDefine, []);
/**
 * 绑定模块外部方法
 */
exports.GetModel = function () {
	return fjssz_ShareDefine;
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=fjssz_ShareDefine.js.map
