(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/common/fjssz_DownLoadMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fjsszc49-b415-40f1-9c9c-3b14229d852c', 'fjssz_DownLoadMgr', __filename);
// script/common/fjssz_DownLoadMgr.js
...
var fjssz_DownLoadMgr = app.BaseClass.extend({
	...
	//1秒回掉
	OnTimer: function OnTimer(pafqplSecond) {
	...
	DownFile: function DownFile(serverUrl, localPath, fileName, downloadType) {
		...
		//this.count = 0
		var argList = [{ "Name": "urls", "Value": serverUrl }, {
			"Name": "fileName",
			"Value": fileName
		}, { "Name": "savePath", "Value": localPath }, { "Name": "downloadType", "Value": downloadType }];
		var value = app[app.subGameName + "_NativeManager"]().CallToNative("downLoadFile", argList);
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=fjssz_DownLoadMgr.js.map
