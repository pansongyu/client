(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/game/FJSSZ/GameLogic/FJSSZLogicGame.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fjssz69c-4159-4c2e-a0a5-0220cc63164f', 'FJSSZLogicGame', __filename);
    ...
    */
	...
	GetLiuTongs: function GetLiuTongs(pokers) {
		...
		if (guipai.length >= 3) {
			var sanZhangGuis = [];
			this.PokerCombination(3, guipai, sanZhangGuis);
			for (var _i67 = 0; _i67 < sanZhangGuis.length; _i67++) {
				for (var j = 0; j < zhangs.length; j++) {
					var temp = this.copyArr(sanZhangGuis[_i67]);
		...
		if (guipai.length >= 2) {
			var liangZhangGuis = [];
			this.PokerCombination(2, guipai, liangZhangGuis);
			for (var _i68 = 0; _i68 < liangZhangGuis.length; _i68++) {
				for (var _j27 = 0; _j27 < zhangs.length; _j27++) {
					var _temp12 = this.copyArr(liangZhangGuis[_i68]);
		...
		if (guipai.length >= 1) {
			for (var _i69 = 0; _i69 < zhangs.length; _i69++) {
				var _zhang2 = zhangs[_i69];
				if (_zhang2.length == 4) {
					for (var _j28 = 0; _j28 < guipai.length; _j28++) {
						var _temp13 = this.copyArr(_zhang2);
						var gui = guipai[_j28];
						if (_temp13.indexOf(gui) != -1) {
							continue;
						}
						_temp13.push(gui);
						if (_temp13.length == 5) {
	...
	IsChongZha: function IsChongZha(pokers) {
		...
		if (!isTouDun) {
			...
			if (pokers.length == 3) {
				var _clearListDict = {};
				var guipai = this.GetGuiPai(pokers);
				for (var _i70 = 0; _i70 < pokers.length; _i70++) {
					var _poker8 = pokers[_i70];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=FJSSZLogicGame.js.map
