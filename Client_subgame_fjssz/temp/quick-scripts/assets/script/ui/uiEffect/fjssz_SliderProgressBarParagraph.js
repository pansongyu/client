(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/uiEffect/fjssz_SliderProgressBarParagraph.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fjsszffb-f4c3-4afd-9411-97f23673335f', 'fjssz_SliderProgressBarParagraph', __filename);
// script/ui/uiEffect/fjssz_SliderProgressBarParagraph.js
...
cc.Class({
	...
	InitData: function InitData(keyIDList) {
		...
		if (!keyCount) {
			console.error("InitData keyIDList empty", keyIDList);
			return;
		}
		//如果只有一个则设置开始结束一样
		else if (keyCount == 1) {
	...
	ShowBackgroundLabel: function ShowBackgroundLabel(showDataList) {
		...
		for (var index = count; index > 0; index--) {
			...
			if (!labelNode) {
				console.error("ShowBackgroundLabel not find:%s,%s", childPath, this.node.name);
				continue;
			}
	...
	SetChooseKeyID: function SetChooseKeyID(keyID) {
		...
		console.error("SetChooseKeyID(%s) not find:", keyID, this.paragraphPositionDict);
	},
	...
	GetChooseKeyID: function GetChooseKeyID() {
		...
		console.error("GetChooseKeyID not find:%s", nowProgress, this.paragraphPositionDict);
		return 0;
	}
...
cc._RF.pop();
        ...
        //# sourceMappingURL=fjssz_SliderProgressBarParagraph.js.map
