(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/fjssz_UICreatRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fjssz50b-a8bd-485c-a0d1-84ba912bffda', 'fjssz_UICreatRoom', __filename);
// script/ui/fjssz_UICreatRoom.js
...
cc.Class({
	...
	OnShow: function OnShow(serverPack) {
		var gamename = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "fjssz";
				...
				for (var _i = 1; _i <= toggleCount; _i++) {
					...
					if (curNode) {
						...
						if (1 == this.gameCreateConfig[key].ToggleType) {
							//多选的图片设置下(不放上面是因为路径)
							var imgPath = "texture/ui/fjssz_UICreateRoom/icon_checkin02";
	...
	Click_btn_create: function Click_btn_create(createType) {
		...
		if (app.subGameName == this.gameType) {
			...
			//王牌
			var _wangpai = this.GetIdxByKey("wangpai");
			//底分
			...
			_wangpai = this.Toggles["wangpai"][0].getChildByName("editbox").getComponent(cc.EditBox).string;
			sendPack = {
		...
		for (var item in sendPack) {
			...
			if (dataType == 'object') {
				var linshi2 = '0';
				for (var _i7 = 0; _i7 < configData.length; _i7++) {
					if (_i7 == 0) {
						linshi2 = configData[0] + 1;
					} else {
						linshi2 = linshi2 + ',' + (configData[_i7] + 1);
					}
				}
				configData = linshi2;
			} else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=fjssz_UICreatRoom.js.map
