...
var qzmj_FormManager = app.BaseClass.extend({
    ...
    LoadSceneDefaultForm:function(sceneName){
		...
		let NoAddScene = ['clubScene', 'fightScene', 'launchScene', 'loginScene', 'qzmjMainScene']; //四个基础场景不用添加uimore，uimark
		let BaseForm = [];
		if (this.isInArray(sceneName, NoAddScene) == false) {
			...
			if (is3DShow == 0 && GamePrefab == "game/" + app.subGameName.toUpperCase() + "/ui/UI" + app.subGameName.toUpperCase() + "Play") {
				//XY场景需要切换
				GamePrefab = "game/" + app.subGameName.toUpperCase() + "/ui/UI" + app.subGameName.toUpperCase() + "2DPlay";
				BaseForm = [];
			} else if (is3DShow == 2 && GamePrefab == "game/" + app.subGameName.toUpperCase() + "/ui/UI" + app.subGameName.toUpperCase() + "Play") {
				//XY场景需要切换
				GamePrefab = "game/" + app.subGameName.toUpperCase() + "/ui/UI" + app.subGameName.toUpperCase() + "WBPlay";
				BaseForm = [];
			}
	...
	OnSwithSceneEnd: function (sceneName) {
		...
		if (this.isInArray(sceneName, NoAddScene) == false) {
			...
			if (is3DShow == 0 && GamePrefab == "game/" + app.subGameName.toUpperCase() + "/ui/UI" + app.subGameName.toUpperCase() + "Play") {
				...
				GamePrefab = "game/" + app.subGameName.toUpperCase() + "/ui/UI" + app.subGameName.toUpperCase() + "2DPlay";
				BaseForm = [];
			} else if (is3DShow == 0 && GamePrefab == "game/" + app.subGameName.toUpperCase() + "/ui/UI" + app.subGameName.toUpperCase() + "Play") {
				//XY场景需要切换
				GamePrefab = "game/" + app.subGameName.toUpperCase() + "/ui/UI" + app.subGameName.toUpperCase() + "WBPlay";
				BaseForm = [];
			}
...
var g_qzmj_FormManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function () {
	if (!g_qzmj_FormManager) {
		g_qzmj_FormManager = new qzmj_FormManager();
	}
	return g_qzmj_FormManager;
}
