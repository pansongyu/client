	...
	OnNativeNotify:function(eventType, eventDataString){
        try {
            ...
            if (eventType == "wechat") { //微信登录
                ...
                app[app.subGameName + "_SysNotifyManager"]().ShowSysMsg('已复制:'+dataDict.msg);
            ...
            if(eventType=='wechatShare'){
                ...
                console.log(app.subGameName + "_NativeNotify OnNativeNotify error: " + error.stack);
        	}
        }
	},
}