 ...
 * 类构造
 */
var qzmj_NativeManager = app.BaseClass.extend({
...
var g_qzmj_NativeManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
	if(!g_qzmj_NativeManager){
		g_qzmj_NativeManager = new qzmj_NativeManager();
	}
	return g_qzmj_NativeManager;
};