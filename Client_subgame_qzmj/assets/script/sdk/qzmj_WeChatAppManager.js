...
var qzmj_WeChatAppManager = app.BaseClass.extend({
    Init:function() {
    ...
    OnNativeNotifyWXShare:function(dataDict){
	    ...
	    if(errCode == 0){
	    	...
	    	app[app.subGameName + "_FormManager"]().CloseForm('game/base/ui/majiang/'+app.subGameName+'_UIMJSharePaiXingMax');
	    	let isShow=app[app.subGameName + "_FormManager"]().IsFormShow('game/base/ui/majiang/'+app.subGameName+'_UIMJSharePaiXingMini');
	    	...
	    	if(isShow){
	    		...
	    		app[app.subGameName + "_FormManager"]().GetFormComponentByFormName("game/base/ui/majiang/"+app.subGameName+"_UIMJSharePaiXingMini").Event_ShareSuccess(false);
	    		return;
        	}
...
var g_qzmj_WeChatAppManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
    if(!g_qzmj_WeChatAppManager){
        g_qzmj_WeChatAppManager = new qzmj_WeChatAppManager();
    }
    return g_qzmj_WeChatAppManager;
};
