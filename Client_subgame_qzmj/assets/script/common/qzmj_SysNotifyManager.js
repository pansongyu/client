 ...
 * 类构造
 */
var qzmj_SysNotifyManager = app.BaseClass.extend({
...
var g_qzmj_SysNotifyManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
	if(!g_qzmj_SysNotifyManager)
		g_qzmj_SysNotifyManager = new qzmj_SysNotifyManager();
	return g_qzmj_SysNotifyManager;
