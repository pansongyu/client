...
var qzmj_SysDataManager = app.BaseClass.extend({
...
var g_qzmj_SysDataManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
    if(!g_qzmj_SysDataManager){
        g_qzmj_SysDataManager = new qzmj_SysDataManager();
    }
    return g_qzmj_SysDataManager;
}