...
var qzmj_EffectManager = app.BaseClass.extend({
...
var g_qzmj_EffectManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
    if(!g_qzmj_EffectManager){
        g_qzmj_EffectManager = new qzmj_EffectManager();
    }
    return g_qzmj_EffectManager;
}