 ...
 * 类构造
 */
var qzmj_ConfirmManager = app.BaseClass.extend({
...
//定义单例
var g_qzmj_ConfirmManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
	if (!g_qzmj_ConfirmManager)
		g_qzmj_ConfirmManager = new qzmj_ConfirmManager();

	return g_qzmj_ConfirmManager
