...
var qzmj_HotUpdateMgr = app.BaseClass.extend({
...
var g_qzmj_HotUpdateMgr = null;

exports.GetModel = function(){
    if(!g_qzmj_HotUpdateMgr)
        g_qzmj_HotUpdateMgr = new qzmj_HotUpdateMgr();
    return g_qzmj_HotUpdateMgr;
