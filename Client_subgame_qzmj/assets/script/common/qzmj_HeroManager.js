...
var qzmj_HeroManager = app.BaseClass.extend({
...
var g_qzmj_HeroManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
    if(!g_qzmj_HeroManager){
        g_qzmj_HeroManager = new qzmj_HeroManager();
    }
    return g_qzmj_HeroManager;
}