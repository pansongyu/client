...
var qzmj_SoundManager = app.BaseClass.extend({
...
var g_qzmj_SoundManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
	if(!g_qzmj_SoundManager){
		g_qzmj_SoundManager = new qzmj_SoundManager();
	}
	return g_qzmj_SoundManager;
}