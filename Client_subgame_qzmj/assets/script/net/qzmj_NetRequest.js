 ...
 * 类方法定义
 */
var qzmj_NetRequest = app.BaseClass.extend({
...
exports.GetModel = function(){
    if(!g_qzmj_httpRequest){
        g_qzmj_httpRequest = new qzmj_NetRequest();
    }
    return g_qzmj_httpRequest;
}