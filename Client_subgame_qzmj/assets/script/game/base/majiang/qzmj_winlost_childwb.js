...
cc.Class({
	...
	ShowPlayerShowCard: function (ShowNode, cardIDList, handCard, jin1, jin2) {
		...
		if (handCard > 0 && handCard != 5000) {
			UICard_ShowCard.node.getChildByName("img_mjdi").getComponent(cc.Sprite).spriteFrame = this.sp_img_mjdi;
		} else {
			UICard_ShowCard.node.getChildByName("img_mjdi").getComponent(cc.Sprite).spriteFrame = "";
		}
	},
