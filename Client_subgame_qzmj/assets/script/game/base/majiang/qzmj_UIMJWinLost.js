...
cc.Class({
	...
	InitNode: function () {
		...
		Player1Node = cc.instantiate(this.winlost_child16);
		this.nowChildName = app.subGameName + "_winlost_child16";
		...
		//16添加花牌
		if (this.nowChildName == app.subGameName + "_winlost_child16") {
