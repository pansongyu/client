...
cc.Class({
	...
	OnCreateInit: function () {
		this.roomID = this.node.getChildByName("roomID");
		this.jushu = this.node.getChildByName("jushu");
		this.endTime = this.node.getChildByName("endTime");
		...
		this.btn_sharelink = this.GetWndNode("btn_lists/btn_sharelink");
		this.btn_sharemore = this.GetWndNode("btn_lists/btn_sharemore");
		this.btn_exit = this.GetWndNode("btn_lists/btn_exit");
	...
	OnShow: function (basedata = false, playerlist = false, exitBtn = false) {
		...
		this.node.getChildByName("wanfa").getComponent(cc.Label).string = wanFaStr;
	...
	huTypesShow: function (jiesuan, huData) {
		...
		//其他胡次数
		let otherhu = huData["otherPoint"];

		let youCi = danYouPoint + shuangYouPoint + sanYouPoint;
		...
		jiesuan.getChildByName('zimo').getChildByName('num').getComponent(cc.Label).string = ziMoPoint;
		jiesuan.getChildByName('hu').getChildByName('num').getComponent(cc.Label).string = huCnt;
		jiesuan.getChildByName('otherhu').getChildByName('num').getComponent(cc.Label).string = otherhu;
		...
		jiesuan.getChildByName('sanyou').getChildByName('num').getComponent(cc.Label).string = youCi;
	},
	//---------设置接口---------------
