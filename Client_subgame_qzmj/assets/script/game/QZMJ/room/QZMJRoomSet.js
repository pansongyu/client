 ...
 * 类构造
 */
var QZMJRoomSet = app.BaseClass.extend({
	...
	get_jinJin: function () {
		if (this.dataInfo.hasOwnProperty('roomSetCfg')) {
			if (this.dataInfo['roomSetCfg'].hasOwnProperty('jinJin')) {
				return this.dataInfo['roomSetCfg']['jinJin'];
			}
		}
		return 0;
	},
	...
	set_jinjin: function (cardID) {
		this.dataInfo['roomSetCfg']['jinJin'] = cardID;
	},
	OnReload: function () {
...
exports.GetModel = function () {
	if (!g_QZMJRoomSet)
		g_QZMJRoomSet = new QZMJRoomSet();
	return g_QZMJRoomSet;
